...
The public repository for this code is managed with git and is hosted at Codeberg.
...
comfortable using that, drop a line to Diab Jerius <djerius@cfa.harvard.edu>.
...
at this website:
  ...
  https://rt.cpan.org/Public/Dist/Display.html?Name=MooX-Tag-TO_HASH

or via email to:

  bug-moox-tag-to_hash@rt.cpan.org
