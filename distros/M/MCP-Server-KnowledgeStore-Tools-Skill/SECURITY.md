# Security Policy for MCP-Server-KnowledgeStore-Tools-Skill distribution.

Report security issues by email to Wesley <cpan-security@opperschaap.net>

This is the Security Policy for MCP-Server-KnowledgeStore-Tools-Skill
...
Security vulnerabilities can be reported to the current MCP-Server-KnowledgeStore-Tools-Skill
...
Any security vulnerabilities in MCP-Server-KnowledgeStore-Tools-Skill are covered by this policy.

Security vulnerabilities in versions of any libraries that are included in
MCP-Server-KnowledgeStore-Tools-Skill are NOT covered by this policy.
...
MCP-Server-KnowledgeStore-Tools-Skill, or MCP-Server-KnowledgeStore-Tools-Skill can be used to exploit vulnerabilities in
them.

Security vulnerabilities in downstream software (any software that uses
MCP-Server-KnowledgeStore-Tools-Skill, or plugins to it that are not included with the
MCP-Server-KnowledgeStore-Tools-Skill distribution) are not covered by this policy.

## Supported Versions of MCP-Server-KnowledgeStore-Tools-Skill

The maintainer(s) will only commit to releasing security fixes for
the latest version of MCP-Server-KnowledgeStore-Tools-Skill

# Installation and Usage Issues

The distribution metadata specifies minimum versions of prerequisites that are
required for MCP-Server-KnowledgeStore-Tools-Skill to work. However, some of these prerequisites may
