# Security Policy for MCP-Server-KnowledgeStore-Tools-Memory distribution.

Report security issues by email to Wesley <cpan-security@opperschaap.net>

This is the Security Policy for MCP-Server-KnowledgeStore-Tools-Memory

This text is based on the CPAN Security Group's Guidelines for Adding a
Security Policy to Perl Distributions (version 1.3.0)
https://security.metacpan.org/docs/guides/security-policy-for-authors.html

# How to Report a Security Vulnerability

Security vulnerabilities can be reported to the current MCP-Server-KnowledgeStore-Tools-Memory
maintainers by email to Wesley <cpan-security@opperschaap.net>
...
Please *do not* use the public issue reporting system on RT or public issues
...
they cannot guarantee a rapid response.  If you have not received a response
from them within 2 weeks, then please send a reminder to them and copy the
...
Any security vulnerabilities in MCP-Server-KnowledgeStore-Tools-Memory are covered by this policy.

Security vulnerabilities in versions of any libraries that are included in
MCP-Server-KnowledgeStore-Tools-Memory are NOT covered by this policy.
...
Security vulnerabilities in upstream software (prerequisite modules or system
libraries, or in Perl), are not covered by this policy even if they affect
MCP-Server-KnowledgeStore-Tools-Memory, or MCP-Server-KnowledgeStore-Tools-Memory can be used to exploit vulnerabilities in
them.

Security vulnerabilities in downstream software (any software that uses
MCP-Server-KnowledgeStore-Tools-Memory, or plugins to it that are not included with the
MCP-Server-KnowledgeStore-Tools-Memory distribution) are not covered by this policy.

## Supported Versions of MCP-Server-KnowledgeStore-Tools-Memory

The maintainer(s) will only commit to releasing security fixes for
the latest version of MCP-Server-KnowledgeStore-Tools-Memory

# Installation and Usage Issues

The distribution metadata specifies minimum versions of prerequisites that are
required for MCP-Server-KnowledgeStore-Tools-Memory to work. However, some of these prerequisites may
have security vulnerabilities, and you should ensure that you are using
