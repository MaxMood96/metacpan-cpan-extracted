...
MCP::Server::Run - MCP server with a command execution tool
...
=head1 SYNOPSIS
    ...
    use Mojo::Base 'MCP::Server::Run::Bash', -signatures;
...
See L<MCP::Server::Run::Bash> for a concrete implementation using
C<bash -c>.
...
See L<MCP::Server::Run::Bash> for the reference implementation.
...
=item * L<MCP::Server::Run::Bash> - Concrete implementation using C<bash -c>
...
L<https://github.com/Getty/p5-mcp-server-run/issues>.
