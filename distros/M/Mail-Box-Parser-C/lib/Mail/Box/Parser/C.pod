...
The L<Mail::Box::Parser|Mail::Box::Parser>::C implements parsing of messages in ANSI C,
...
B<Be aware:>
This module versions 4.00 and up is not fully compatible with older releases:
...
Only returns a value when passed as instantiation parameter.  Otherwise,
the used file-handle stays in 'C-space'.  The connection between C and
Perl is via the L<boxnr()|Mail::Box::Parser::C/"Attributes">.
...
This module is part of Mail-Box-Parser-C version 4.01,
built on February 25, 2026. Website: F<http://perl.overmeer.net/CPAN/>
