# Security Policy for MCP Knowledge Store distribution.

Report security issues by email to Wesley <cpan-security@opperschaap.net>

This is the Security Policy for MCP Knowledge Store
...
Security vulnerabilities can be reported to the current MCP Knowledge Store
...
Any security vulnerabilities in MCP Knowledge Store are covered by this policy.

Security vulnerabilities in versions of any libraries that are included in
MCP Knowledge Store are NOT covered by this policy.
...
MCP Knowledge Store, or MCP Knowledge Store can be used to exploit vulnerabilities in
them.

Security vulnerabilities in downstream software (any software that uses
MCP Knowledge Store, or plugins to it that are not included with the
MCP Knowledge Store distribution) are not covered by this policy.

## Supported Versions of MCP Knowledge Store

The maintainer(s) will only commit to releasing security fixes for
the latest version of MCP Knowledge Store

# Installation and Usage Issues

The distribution metadata specifies minimum versions of prerequisites that are
required for MCP Knowledge Store to work. However, some of these prerequisites may
