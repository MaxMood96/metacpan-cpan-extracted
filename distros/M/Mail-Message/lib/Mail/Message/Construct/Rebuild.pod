...
L<https://github.com/logological/mimestrip>

=head4 » Example: using parameter with C<textAlternativeForHtml>
...
to L<Mail::Box|Mail::Box>; it may be useful for other people as well.
