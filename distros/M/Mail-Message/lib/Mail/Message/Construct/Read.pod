...
Read a message from a C<$fh>, C<$text> string, reference to a text string, or an
ARRAY of C<@lines>.  Most C<%options> are passed to the L<new()|Mail::Message/"Constructors"> of the message
...
Force a body C<$type> (any specific extension of the L<Mail::Message::Body|Mail::Message::Body> class)
...
Enforce a certain parser C<$type> to be used, which must be an extension of
the L<Mail::Box::Parser|Mail::Box::Parser> class otherwise taken.
