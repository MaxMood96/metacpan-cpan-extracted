...
Print the structure of a message to the specified C<$fh> or the
...
C<$indent> specifies the initial indentation string: it is added in front
of each line. The C<$indent> must contain at least one white-space.
