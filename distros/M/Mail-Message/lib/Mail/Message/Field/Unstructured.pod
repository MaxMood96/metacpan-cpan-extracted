...
When the C<$data> is specified as single line, the content part is considered to
...
=item Warning: attributes are not supported for unstructured fields.
...
=item Warning: no extras for unstructured fields.
