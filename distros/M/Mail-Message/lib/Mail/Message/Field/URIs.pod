...
Add an C<$uri> to the field.  The C<$uri> can be specified as URI object
or as string which will be turned into an C<$uri> object.  The added
C<$uri> is returned.
...
=item Error: no attributes for URI fields.
