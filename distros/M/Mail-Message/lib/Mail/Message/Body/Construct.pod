...
Make a multipart containing this body and the specified C<@messages>. The
...
Specify a list of text C<@components>.  Each component can be

=over 4

=item * a message (L<Mail::Message|Mail::Message>, the body of the message is used),

=item * a plain body (L<Mail::Message::Body|Mail::Message::Body>),
...
The C<CODE> refers to a subroutine which is called, where C<$_> contains
