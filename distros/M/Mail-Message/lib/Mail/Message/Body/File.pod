...
=item Fault: cannot read from file $name: $!
...
Cast by C<endsOnNewline()>

=item Fault: cannot read from file $name: $!

Cast by C<lines()>

=item Fault: cannot write body to file $name: $!

Cast by C<new()>

=item Fault: cannot write to file $name: $!

Cast by C<read()>

=item Fault: cannot write to temporary body file $name: $!
...
=item Fault: unable to read file $name for message body file: $!
