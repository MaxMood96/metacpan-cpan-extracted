# Security Policy for MCP-Server-KnowledgeStore-Tools-Spec distribution.

Report security issues by email to Wesley <cpan-security@opperschaap.net>

This is the Security Policy for MCP-Server-KnowledgeStore-Tools-Spec
...
Security vulnerabilities can be reported to the current MCP-Server-KnowledgeStore-Tools-Spec
...
Any security vulnerabilities in MCP-Server-KnowledgeStore-Tools-Spec are covered by this policy.

Security vulnerabilities in versions of any libraries that are included in
MCP-Server-KnowledgeStore-Tools-Spec are NOT covered by this policy.
...
MCP-Server-KnowledgeStore-Tools-Spec, or MCP-Server-KnowledgeStore-Tools-Spec can be used to exploit vulnerabilities in
them.

Security vulnerabilities in downstream software (any software that uses
MCP-Server-KnowledgeStore-Tools-Spec, or plugins to it that are not included with the
MCP-Server-KnowledgeStore-Tools-Spec distribution) are not covered by this policy.

## Supported Versions of MCP-Server-KnowledgeStore-Tools-Spec

The maintainer(s) will only commit to releasing security fixes for
the latest version of MCP-Server-KnowledgeStore-Tools-Spec

# Installation and Usage Issues

The distribution metadata specifies minimum versions of prerequisites that are
required for MCP-Server-KnowledgeStore-Tools-Spec to work. However, some of these prerequisites may
