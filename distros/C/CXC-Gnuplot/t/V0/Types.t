...
type_subtest CoordValue, sub ( $type ) {
    ...
    my sub check ( $value, $sub ) {
        $value => object {
            prop blessed => 'CXC::Gnuplot::V0::CoordValue';
            $sub->();
        };
    }
...
type_subtest CoordOffset2D, sub ( $type ) {
    ...
    my sub check ( $value, $x, $y ) {
        $value => check2D( 'CXC::Gnuplot::V0::CoordOffset2D', $x, $y );
    }
...
type_subtest CoordOffset3D, sub ( $type ) {
    ...
    my sub check ( $value, $x, $y, $z ) {
        $value => check3D( 'CXC::Gnuplot::V0::CoordOffset3D', $x, $y, $z );
    }
...
type_subtest CoordPosition2D, sub ( $type ) {
    ...
    my sub check ( $value, $x, $y ) {
        $value => check2D( 'CXC::Gnuplot::V0::CoordPosition2D', $x, $y );
    }
...
type_subtest CoordPosition3D, sub ( $type ) {
    ...
    my sub check ( $value, $x, $y, $z ) {
        $value => check3D( 'CXC::Gnuplot::V0::CoordPosition3D', $x, $y, $z );
    }
...
sub check_Palette( $expected ) {
    ...
    defined $expected->{cb}
      and return hash {
        field cb => object {
            prop blessed => 'CXC::Gnuplot::V0::Range';
...
type_subtest Palette, sub ( $type ) {
    ...
    should_pass_initially(
        $type, 'z',
        { frac => 0.2 },
        { cb   => CXC::Gnuplot::V0::Range->new( %range ) },
    );
