...
subtest 'assert_coerce' => sub {
    is( Key->assert_coerce( \%args ),            $expected, 'hashref' );
    is( Key->assert_coerce( Key->new( %args ) ), $expected, 'Object' );
};
