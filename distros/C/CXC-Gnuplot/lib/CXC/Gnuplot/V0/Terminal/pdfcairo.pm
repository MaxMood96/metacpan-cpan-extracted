package CXC::Gnuplot::V0::Terminal::pdfcairo;
...
class CXC::Gnuplot::V0::Terminal::pdfcairo : isa(CXC::Gnuplot::V0::Terminal::cairo);





sub terminal { 'pdfcairo' }
use constant _DEFAULT_EXT => '.pdf';
...
CXC::Gnuplot::V0::Terminal::pdfcairo
