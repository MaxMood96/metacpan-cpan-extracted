package CXC::Gnuplot::V1::AxisRange;
...
class CXC::Gnuplot::V1::AxisRange : isa(CXC::Gnuplot::V1::Base)
...
use CXC::Gnuplot::V1::Types -lexical => qw( signature_for SetFormats NonEmptyStr );
