...
uses Crypt-SysRandom-XS, or plugins to it that are not included with the
Crypt-SysRandom-XS distribution) are not covered by this policy.

## Supported Versions of Crypt-SysRandom-XS

The maintainer(s) will only commit to releasing security fixes for
the latest version of Crypt-SysRandom-XS.

# Installation and Usage Issues

The distribution metadata specifies minimum versions of
prerequisites that are required for Crypt-SysRandom-XS to work.  However, some
