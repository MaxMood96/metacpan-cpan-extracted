...
#        XDR::Gen version 1.1.2 and LibVirt version v12.7.0
#
...
package Protocol::Sys::Virt::URI v12.7.0;
...
I<Since v12.5.1>: The C<argv> parameters are returned in an array; even if there is
only a single value.
