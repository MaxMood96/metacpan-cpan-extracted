...
package Protocol::Sys::Virt::Remote v12.7.0;

use Carp qw(croak);
use Log::Any qw($log);

use Protocol::Sys::Virt::Remote::XDR v12.7.0;
use Protocol::Sys::Virt::Transport::XDR v12.7.0;
...
my @args_encoders = (
    ...
    invalid_proc(454),
    invalid_proc(455),
    sub { my $idx = 0; my $rv = ''; $remote->serialize_domain_announce_interface_args($_[0], $idx, $rv); return $rv; }
    );
...
my @args_decoders = (
    ...
    invalid_proc(454),
    invalid_proc(455),
    sub { my $idx = 0; my $rv = ''; $remote->deserialize_domain_announce_interface_args($rv, $idx, $_[0]); return $rv; }
    );
...
my @msg_encoders = (
    ...
    sub { my $idx = 0; my $rv = ''; $remote->serialize_domain_event_vcpu_removed_msg($_[0], $idx, $rv); return $rv; },
    sub { my $idx = 0; my $rv = ''; $remote->serialize_domain_event_callback_channel_lifecycle_msg($_[0], $idx, $rv); return $rv; }
    );
...
my @msg_decoders = (
    ...
    sub { my $idx = 0; my $rv = ''; $remote->deserialize_domain_event_vcpu_removed_msg($rv, $idx, $_[0]); return $rv; },
    sub { my $idx = 0; my $rv = ''; $remote->deserialize_domain_event_callback_channel_lifecycle_msg($rv, $idx, $_[0]); return $rv; }
    );
