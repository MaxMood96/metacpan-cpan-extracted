...
ok(dies {Benchmark::DKbench::_bench_run('', 1)}, "No bench passed");
...
is(Benchmark::DKbench::_compare_hash({a=>1}, {a=>1, b=>1}), 0, 'Different num keys');
is(Benchmark::DKbench::_compare_hash({a=>1, b=>2}, {a=>1, b=>1}), 0, 'Different values');
is(Benchmark::DKbench::_compare_arr([1, 2], [1]), 0, 'Different size array');
is(Benchmark::DKbench::_compare_arr([1, 2], [1, 1]), 0, 'Different vals array');
is(Benchmark::DKbench::_compare_obj([], {}), 0, 'Different types of obj');
...
ok(dies {Benchmark::DKbench::_bench_imager(1)}, "No image file found");
