...
\usepackage[width=1920,embed,autoslide=4000,loop]{beamer-reveal}
\usepackage{tikz}
\usepackage{siunitx}
...
\begin{frame}
  ...
  \begin{center}
    \animation<1|handout:1-3>[framerate=25,duration=7.5,autoplay,
      pdf progress=0.1,handout progress={1:0,2:0.2,3:0.5},expand once] {\myanimation}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \still[pdf progress=0.75,expand once] {\myanimation}
  \end{center}
