...
\begin{frame}
  ...
  \image[width=0.25,aspectratio=1,fit=contain,embed] \at (0.2,0.6) {Media/beamer-reveal-WiresTp.png}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{center}
  \animation[framerate=25,duration=7.5,pdfprogress=0.1,autoplay,loop] {%
  ...
  \audio[autoplay,width=0.1,aspectratio=16/9,fit=cover,embed] \at (0,0)
