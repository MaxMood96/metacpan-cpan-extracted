 ...
 * rather than a slot of their own - a future is already four slots wide and
 * two of them are allocated per parked request - so this fires on every
 * settlement and drops everything that is not a cancellation. */
