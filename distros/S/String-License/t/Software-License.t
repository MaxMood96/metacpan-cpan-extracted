...
use Test2::V0;
use Test2::Require::Module 'Regexp::Pattern::License' => '3.11.0';
use Test2::Require::Module 'Software::LicenseUtils'   => '0.104006';
...
my %LICENSES = (
	...
	'Artistic-1.0-Perl OR GPL-1.0-or-later' =>
		'Artistic-1.0-Perl and/or GPL-1.0 and/or Perl',
	'PostgreSQL' => undef,
	'QPL-1.0'    => undef,
	'SISSL'      => undef,
	'Zlib'       => undef,
...
foreach my $id ( sort keys %LICENSES ) {
	...
	bail_out "Software::License failed to create license $id" if $@;
