bless( {
  "rules" => [
    bless( {
      ...
      "style" => "{ margin: 0; padding: 0; font-family: \"Segoe UI\", Arial, sans-serif; color: #333; background-color: #fafafa; line-height: 1.5; }"
    }, 'Sumi::CSS::Rule' ),
    bless( {
      "selector" => [
        ".container"
    ...
    bless( {
      ...
      "style" => "{ background: #2d3748; color: #fff; padding: 1rem; }"
    }, 'Sumi::CSS::Rule' ),
    bless( {
      "selector" => [
        ".sidebar ul"
    ...
    bless( {
      ...
      "style" => "{ color: inherit; text-decoration: none; display: block; padding: 0.5rem 0.75rem; border-radius: 0.25rem; }"
    }, 'Sumi::CSS::Rule' ),
    bless( {
      "selector" => [
        ".sidebar a:hover",
    ...
    bless( {
      ...
      "style" => "{ display: inline-block; padding: 0.5rem 1rem; font-size: 0.95rem; font-weight: 500; border-radius: 0.375rem; border: 1px solid transparent; cursor: pointer; text-align: center; text-decoration: none; transition: background-color 0.2s ease, color 0.2s ease; }"
    }, 'Sumi::CSS::Rule' ),
    bless( {
      "selector" => [
        ".button.primary"
    ...
    bless( {
      ...
      "style" => "{ background-color: #e2e8f0; color: #2d3748; }"
    }, 'Sumi::CSS::Rule' ),
    bless( {
      "selector" => [
    ...
    bless( {
      ...
      "style" => "{ width: 100%; padding: 0.5rem; border: 1px solid #cbd5e0; border-radius: 0.375rem; font-size: 1rem; }"
    }, 'Sumi::CSS::Rule' ),
    bless( {
      "selector" => [
