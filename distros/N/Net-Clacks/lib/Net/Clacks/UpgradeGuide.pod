...
Dolly Parton Memorial release. Adds her name to the overhead keep-alive client broadcasts.

This version is fully backwards compatible to Version 34.

=head2 VERSION 38

This version squashes some long standing bugs server sleep and noping handling.

While this version is fully backwards compatible to Version 34, it is very much recommended to upgrade to Version 38.
