...
Alien::Xmake::Project follows semver. Only the most recent release line is actively patched for security vulnerabilities.
...
To report a vulnerability, open a private advisory via the repository's [Security Advisories](https://github.com/sanko/Alien-Xmake-Project/security/advisories/new) page.
