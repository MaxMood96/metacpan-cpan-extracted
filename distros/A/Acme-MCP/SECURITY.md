...
If you have any issue regarding security, please disclose the information responsibly by sending a report to https://github.com/sanko/Acme-MCP.pm/security/advisories/new and *not* at the public issue tracker or via email.
