...
$ffi->attach( copy_fflags_text_len => ['archive_entry', 'string', 'size_t'] => 'string' );
$ffi->attach( filetype_is_set => ['archive_entry'] => 'int' );
$ffi->attach( gid_is_set => ['archive_entry'] => 'int' );
$ffi->attach( hardlink_is_set => ['archive_entry'] => 'int' );
$ffi->attach( perm_is_set => ['archive_entry'] => 'int' );
$ffi->attach( rdev_is_set => ['archive_entry'] => 'int' );
#$ffi->attach( set_digest => ['archive_entry', 'int', undef] => 'int' );
$ffi->attach( set_link_to_hardlink => ['archive_entry'] );
$ffi->attach( set_link_to_symlink => ['archive_entry'] );
