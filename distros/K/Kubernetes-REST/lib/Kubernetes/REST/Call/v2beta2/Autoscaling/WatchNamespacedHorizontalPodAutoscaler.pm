package Kubernetes::REST::Call::v2beta2::Autoscaling::WatchNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v2beta2::Autoscaling::WatchNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
