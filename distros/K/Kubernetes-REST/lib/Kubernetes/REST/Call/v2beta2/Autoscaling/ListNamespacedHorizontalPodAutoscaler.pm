package Kubernetes::REST::Call::v2beta2::Autoscaling::ListNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta2::Autoscaling::ListNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
