package Kubernetes::REST::Call::v2beta2::Autoscaling::DeleteCollectionNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta2::Autoscaling::DeleteCollectionNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
