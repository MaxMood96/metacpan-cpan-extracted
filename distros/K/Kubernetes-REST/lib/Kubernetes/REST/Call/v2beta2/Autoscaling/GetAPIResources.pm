package Kubernetes::REST::Call::v2beta2::Autoscaling::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2beta2::Autoscaling::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
