package Kubernetes::REST::Call::v2beta2::Autoscaling::ListHorizontalPodAutoscalerForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2beta2::Autoscaling::ListHorizontalPodAutoscalerForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
