package Kubernetes::REST::Call::v2beta2::Autoscaling::CreateNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta2::Autoscaling::CreateNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
