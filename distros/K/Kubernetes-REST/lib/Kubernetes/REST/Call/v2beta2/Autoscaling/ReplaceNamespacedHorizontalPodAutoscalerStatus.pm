package Kubernetes::REST::Call::v2beta2::Autoscaling::ReplaceNamespacedHorizontalPodAutoscalerStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta2::Autoscaling::ReplaceNamespacedHorizontalPodAutoscalerStatus - Deprecated - use the new Kubernetes::REST API instead
