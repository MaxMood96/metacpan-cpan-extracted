package Kubernetes::REST::Call::v2beta2::Autoscaling::ReplaceNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2beta2::Autoscaling::ReplaceNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
