package Kubernetes::REST::Call::GetRbacAuthorizationAPIGroup;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::GetRbacAuthorizationAPIGroup - Deprecated - use the new Kubernetes::REST API instead
