package Kubernetes::REST::Call::v1beta1::Apps::WatchNamespacedDeploymentList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apps::WatchNamespacedDeploymentList - Deprecated - use the new Kubernetes::REST API instead
