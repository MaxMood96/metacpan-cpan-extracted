package Kubernetes::REST::Call::v1beta1::Policy::DeleteCollectionNamespacedPodDisruptionBudget;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::DeleteCollectionNamespacedPodDisruptionBudget - Deprecated - use the new Kubernetes::REST API instead
