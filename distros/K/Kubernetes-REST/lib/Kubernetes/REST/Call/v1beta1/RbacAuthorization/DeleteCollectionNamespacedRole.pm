package Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteCollectionNamespacedRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteCollectionNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
