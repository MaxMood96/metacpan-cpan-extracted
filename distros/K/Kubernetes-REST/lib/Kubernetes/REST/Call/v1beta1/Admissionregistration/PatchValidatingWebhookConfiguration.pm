package Kubernetes::REST::Call::v1beta1::Admissionregistration::PatchValidatingWebhookConfiguration;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::PatchValidatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
