package Kubernetes::REST::Call::v1beta1::Coordination::WatchNamespacedLeaseList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Coordination::WatchNamespacedLeaseList - Deprecated - use the new Kubernetes::REST API instead
