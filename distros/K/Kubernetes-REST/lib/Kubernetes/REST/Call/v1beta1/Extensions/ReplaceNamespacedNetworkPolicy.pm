package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedNetworkPolicy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
