package Kubernetes::REST::Call::v1beta1::RbacAuthorization::ListNamespacedRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::ListNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
