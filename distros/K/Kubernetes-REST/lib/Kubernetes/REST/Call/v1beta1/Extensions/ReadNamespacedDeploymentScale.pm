package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedDeploymentScale;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedDeploymentScale - Deprecated - use the new Kubernetes::REST API instead
