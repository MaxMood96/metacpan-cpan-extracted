package Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedDeployment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
