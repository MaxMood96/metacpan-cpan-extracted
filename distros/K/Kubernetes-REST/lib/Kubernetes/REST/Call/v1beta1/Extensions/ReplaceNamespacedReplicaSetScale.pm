package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedReplicaSetScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedReplicaSetScale - Deprecated - use the new Kubernetes::REST API instead
