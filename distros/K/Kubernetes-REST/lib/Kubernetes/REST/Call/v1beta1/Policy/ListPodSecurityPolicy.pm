package Kubernetes::REST::Call::v1beta1::Policy::ListPodSecurityPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::ListPodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
