package Kubernetes::REST::Call::v1beta1::Policy::WatchPodSecurityPolicyList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::WatchPodSecurityPolicyList - Deprecated - use the new Kubernetes::REST API instead
