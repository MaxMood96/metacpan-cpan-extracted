package Kubernetes::REST::Call::v1beta1::Extensions::ReplacePodSecurityPolicy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplacePodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
