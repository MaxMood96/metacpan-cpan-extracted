package Kubernetes::REST::Call::v1beta1::Extensions::WatchPodSecurityPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchPodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
