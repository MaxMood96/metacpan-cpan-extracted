package Kubernetes::REST::Call::v1beta1::Certificates::PatchCertificateSigningRequest;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Certificates::PatchCertificateSigningRequest - Deprecated - use the new Kubernetes::REST API instead
