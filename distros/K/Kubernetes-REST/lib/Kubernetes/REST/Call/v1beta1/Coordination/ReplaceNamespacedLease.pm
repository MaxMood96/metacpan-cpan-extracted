package Kubernetes::REST::Call::v1beta1::Coordination::ReplaceNamespacedLease;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Coordination::ReplaceNamespacedLease - Deprecated - use the new Kubernetes::REST API instead
