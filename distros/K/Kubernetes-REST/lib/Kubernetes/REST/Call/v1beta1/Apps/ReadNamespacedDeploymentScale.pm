package Kubernetes::REST::Call::v1beta1::Apps::ReadNamespacedDeploymentScale;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apps::ReadNamespacedDeploymentScale - Deprecated - use the new Kubernetes::REST API instead
