package Kubernetes::REST::Call::v1beta1::Apiextensions::ReadCustomResourceDefinitionStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::ReadCustomResourceDefinitionStatus - Deprecated - use the new Kubernetes::REST API instead
