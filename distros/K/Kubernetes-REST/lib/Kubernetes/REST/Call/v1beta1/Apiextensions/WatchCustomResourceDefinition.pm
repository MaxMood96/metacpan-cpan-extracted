package Kubernetes::REST::Call::v1beta1::Apiextensions::WatchCustomResourceDefinition;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::WatchCustomResourceDefinition - Deprecated - use the new Kubernetes::REST API instead
