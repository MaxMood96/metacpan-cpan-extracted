package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedDaemonSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
