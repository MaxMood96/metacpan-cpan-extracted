package Kubernetes::REST::Call::v1beta1::Certificates::ReplaceCertificateSigningRequestStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Certificates::ReplaceCertificateSigningRequestStatus - Deprecated - use the new Kubernetes::REST API instead
