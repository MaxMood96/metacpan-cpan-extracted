package Kubernetes::REST::Call::v1beta1::Apps::ReplaceNamespacedDeploymentStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apps::ReplaceNamespacedDeploymentStatus - Deprecated - use the new Kubernetes::REST API instead
