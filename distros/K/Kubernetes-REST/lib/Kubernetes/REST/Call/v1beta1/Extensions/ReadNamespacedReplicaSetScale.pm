package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedReplicaSetScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedReplicaSetScale - Deprecated - use the new Kubernetes::REST API instead
