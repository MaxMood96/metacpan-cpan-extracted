package Kubernetes::REST::Call::v1beta1::Admissionregistration::WatchValidatingWebhookConfigurationList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::WatchValidatingWebhookConfigurationList - Deprecated - use the new Kubernetes::REST API instead
