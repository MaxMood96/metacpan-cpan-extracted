package Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchClusterRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
