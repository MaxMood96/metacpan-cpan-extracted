package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDeploymentScale;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDeploymentScale - Deprecated - use the new Kubernetes::REST API instead
