package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDaemonSetStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDaemonSetStatus - Deprecated - use the new Kubernetes::REST API instead
