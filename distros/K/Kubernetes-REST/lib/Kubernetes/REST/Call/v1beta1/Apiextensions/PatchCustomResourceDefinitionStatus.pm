package Kubernetes::REST::Call::v1beta1::Apiextensions::PatchCustomResourceDefinitionStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::PatchCustomResourceDefinitionStatus - Deprecated - use the new Kubernetes::REST API instead
