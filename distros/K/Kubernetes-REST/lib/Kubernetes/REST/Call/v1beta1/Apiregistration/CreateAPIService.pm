package Kubernetes::REST::Call::v1beta1::Apiregistration::CreateAPIService;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apiregistration::CreateAPIService - Deprecated - use the new Kubernetes::REST API instead
