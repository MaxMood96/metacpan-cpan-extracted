package Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedIngress;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedIngress - Deprecated - use the new Kubernetes::REST API instead
