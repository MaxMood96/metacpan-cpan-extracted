package Kubernetes::REST::Call::v1beta1::Scheduling::ReplacePriorityClass;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Scheduling::ReplacePriorityClass - Deprecated - use the new Kubernetes::REST API instead
