package Kubernetes::REST::Call::v1beta1::Policy::DeleteCollectionPodSecurityPolicy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Policy::DeleteCollectionPodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
