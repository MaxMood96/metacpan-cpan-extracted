package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedReplicationControllerDummyScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedReplicationControllerDummyScale - Deprecated - use the new Kubernetes::REST API instead
