package Kubernetes::REST::Call::v1beta1::RbacAuthorization::ListNamespacedRoleBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::ListNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
