package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedNetworkPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
