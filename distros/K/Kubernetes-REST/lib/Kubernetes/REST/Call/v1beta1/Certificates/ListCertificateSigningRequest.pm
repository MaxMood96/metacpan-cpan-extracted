package Kubernetes::REST::Call::v1beta1::Certificates::ListCertificateSigningRequest;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Certificates::ListCertificateSigningRequest - Deprecated - use the new Kubernetes::REST API instead
