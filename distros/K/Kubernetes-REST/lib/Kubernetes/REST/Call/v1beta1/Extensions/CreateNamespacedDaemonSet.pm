package Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedDaemonSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
