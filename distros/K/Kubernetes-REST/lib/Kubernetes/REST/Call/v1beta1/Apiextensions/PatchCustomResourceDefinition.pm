package Kubernetes::REST::Call::v1beta1::Apiextensions::PatchCustomResourceDefinition;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::PatchCustomResourceDefinition - Deprecated - use the new Kubernetes::REST API instead
