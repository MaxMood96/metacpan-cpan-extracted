package Kubernetes::REST::Call::v1beta1::Apps::DeleteNamespacedStatefulSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apps::DeleteNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
