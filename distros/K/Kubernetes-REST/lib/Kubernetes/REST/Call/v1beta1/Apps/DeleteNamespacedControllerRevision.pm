package Kubernetes::REST::Call::v1beta1::Apps::DeleteNamespacedControllerRevision;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::DeleteNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
