package Kubernetes::REST::Call::v1beta1::RbacAuthorization::CreateClusterRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::CreateClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
