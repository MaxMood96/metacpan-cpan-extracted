package Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteClusterRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
