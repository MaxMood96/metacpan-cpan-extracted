package Kubernetes::REST::Call::v1beta1::Extensions::CreatePodSecurityPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::CreatePodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
