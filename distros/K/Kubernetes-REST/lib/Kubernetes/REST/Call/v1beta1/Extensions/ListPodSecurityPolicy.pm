package Kubernetes::REST::Call::v1beta1::Extensions::ListPodSecurityPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListPodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
