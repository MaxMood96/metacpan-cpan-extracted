package Kubernetes::REST::Call::v1beta1::Policy::ReadNamespacedPodDisruptionBudgetStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Policy::ReadNamespacedPodDisruptionBudgetStatus - Deprecated - use the new Kubernetes::REST API instead
