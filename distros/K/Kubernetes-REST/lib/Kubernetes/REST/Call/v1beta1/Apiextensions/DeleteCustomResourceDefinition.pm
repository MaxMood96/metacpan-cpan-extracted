package Kubernetes::REST::Call::v1beta1::Apiextensions::DeleteCustomResourceDefinition;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::DeleteCustomResourceDefinition - Deprecated - use the new Kubernetes::REST API instead
