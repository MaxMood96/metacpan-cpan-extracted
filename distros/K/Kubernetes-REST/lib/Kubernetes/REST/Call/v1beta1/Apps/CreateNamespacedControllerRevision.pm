package Kubernetes::REST::Call::v1beta1::Apps::CreateNamespacedControllerRevision;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apps::CreateNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
