package Kubernetes::REST::Call::v1beta1::Policy::ListNamespacedPodDisruptionBudget;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::ListNamespacedPodDisruptionBudget - Deprecated - use the new Kubernetes::REST API instead
