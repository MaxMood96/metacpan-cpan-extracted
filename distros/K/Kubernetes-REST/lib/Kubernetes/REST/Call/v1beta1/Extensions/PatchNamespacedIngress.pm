package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedIngress;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedIngress - Deprecated - use the new Kubernetes::REST API instead
