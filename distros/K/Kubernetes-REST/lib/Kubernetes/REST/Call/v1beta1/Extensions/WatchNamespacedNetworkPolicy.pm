package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedNetworkPolicy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
