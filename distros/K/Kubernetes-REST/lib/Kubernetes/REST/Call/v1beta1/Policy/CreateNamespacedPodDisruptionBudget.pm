package Kubernetes::REST::Call::v1beta1::Policy::CreateNamespacedPodDisruptionBudget;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Policy::CreateNamespacedPodDisruptionBudget - Deprecated - use the new Kubernetes::REST API instead
