package Kubernetes::REST::Call::v1beta1::Storage::GetAPIResources;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Storage::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
