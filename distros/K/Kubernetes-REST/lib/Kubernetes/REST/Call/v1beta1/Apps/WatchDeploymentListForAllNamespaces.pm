package Kubernetes::REST::Call::v1beta1::Apps::WatchDeploymentListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::WatchDeploymentListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
