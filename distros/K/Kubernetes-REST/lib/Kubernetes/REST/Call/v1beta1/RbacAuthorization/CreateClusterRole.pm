package Kubernetes::REST::Call::v1beta1::RbacAuthorization::CreateClusterRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::CreateClusterRole - Deprecated - use the new Kubernetes::REST API instead
