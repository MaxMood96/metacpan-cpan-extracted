package Kubernetes::REST::Call::v1beta1::Batch::ListNamespacedCronJob;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Batch::ListNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
