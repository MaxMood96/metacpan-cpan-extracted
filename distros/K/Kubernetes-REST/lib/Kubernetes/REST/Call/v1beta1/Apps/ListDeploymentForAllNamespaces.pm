package Kubernetes::REST::Call::v1beta1::Apps::ListDeploymentForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::ListDeploymentForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
