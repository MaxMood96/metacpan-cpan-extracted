package Kubernetes::REST::Call::v1beta1::Authorization::CreateNamespacedLocalSubjectAccessReview;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Authorization::CreateNamespacedLocalSubjectAccessReview - Deprecated - use the new Kubernetes::REST API instead
