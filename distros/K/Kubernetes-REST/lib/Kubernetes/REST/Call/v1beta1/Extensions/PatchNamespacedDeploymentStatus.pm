package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDeploymentStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDeploymentStatus - Deprecated - use the new Kubernetes::REST API instead
