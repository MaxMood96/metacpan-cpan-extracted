package Kubernetes::REST::Call::v1beta1::RbacAuthorization::ListRoleBindingForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::ListRoleBindingForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
