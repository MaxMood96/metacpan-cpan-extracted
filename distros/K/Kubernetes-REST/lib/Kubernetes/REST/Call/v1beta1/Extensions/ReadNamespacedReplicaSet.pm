package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
