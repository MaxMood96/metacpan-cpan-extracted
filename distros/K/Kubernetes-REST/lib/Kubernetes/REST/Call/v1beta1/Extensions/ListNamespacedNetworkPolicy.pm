package Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedNetworkPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
