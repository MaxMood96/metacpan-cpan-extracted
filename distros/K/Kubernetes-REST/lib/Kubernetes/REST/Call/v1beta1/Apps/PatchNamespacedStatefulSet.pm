package Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedStatefulSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
