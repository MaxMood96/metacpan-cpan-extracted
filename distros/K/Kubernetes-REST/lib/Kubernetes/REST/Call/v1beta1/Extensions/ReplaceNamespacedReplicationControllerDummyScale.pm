package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedReplicationControllerDummyScale;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedReplicationControllerDummyScale - Deprecated - use the new Kubernetes::REST API instead
