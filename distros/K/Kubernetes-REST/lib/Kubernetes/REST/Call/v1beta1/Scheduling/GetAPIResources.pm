package Kubernetes::REST::Call::v1beta1::Scheduling::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Scheduling::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
