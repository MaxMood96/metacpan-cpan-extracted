package Kubernetes::REST::Call::v1beta1::Storage::WatchVolumeAttachmentList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Storage::WatchVolumeAttachmentList - Deprecated - use the new Kubernetes::REST API instead
