package Kubernetes::REST::Call::v1beta1::Policy::DeletePodSecurityPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::DeletePodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
