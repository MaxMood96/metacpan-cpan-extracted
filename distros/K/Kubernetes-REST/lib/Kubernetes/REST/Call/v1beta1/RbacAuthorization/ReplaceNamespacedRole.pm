package Kubernetes::REST::Call::v1beta1::RbacAuthorization::ReplaceNamespacedRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::ReplaceNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
