package Kubernetes::REST::Call::v1beta1::Extensions::DeletePodSecurityPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeletePodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
