package Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteNamespacedRoleBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
