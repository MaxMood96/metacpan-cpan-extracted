package Kubernetes::REST::Call::v1beta1::Extensions::WatchReplicaSetListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchReplicaSetListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
