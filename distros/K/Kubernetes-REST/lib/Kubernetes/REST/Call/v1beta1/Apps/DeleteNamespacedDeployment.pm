package Kubernetes::REST::Call::v1beta1::Apps::DeleteNamespacedDeployment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::DeleteNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
