package Kubernetes::REST::Call::v1beta1::Apps::WatchControllerRevisionListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apps::WatchControllerRevisionListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
