package Kubernetes::REST::Call::v1beta1::Storage::DeleteCollectionVolumeAttachment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Storage::DeleteCollectionVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
