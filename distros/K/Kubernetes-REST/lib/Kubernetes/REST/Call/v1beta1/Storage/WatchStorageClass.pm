package Kubernetes::REST::Call::v1beta1::Storage::WatchStorageClass;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Storage::WatchStorageClass - Deprecated - use the new Kubernetes::REST API instead
