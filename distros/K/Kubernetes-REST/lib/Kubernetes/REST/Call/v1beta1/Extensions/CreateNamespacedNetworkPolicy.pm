package Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedNetworkPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
