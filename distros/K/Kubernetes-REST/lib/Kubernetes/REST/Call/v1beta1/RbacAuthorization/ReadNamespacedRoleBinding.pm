package Kubernetes::REST::Call::v1beta1::RbacAuthorization::ReadNamespacedRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::ReadNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
