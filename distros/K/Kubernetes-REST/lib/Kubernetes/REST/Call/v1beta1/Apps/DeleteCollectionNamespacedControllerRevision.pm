package Kubernetes::REST::Call::v1beta1::Apps::DeleteCollectionNamespacedControllerRevision;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apps::DeleteCollectionNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
