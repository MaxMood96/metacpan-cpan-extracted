package Kubernetes::REST::Call::v1beta1::RbacAuthorization::ListClusterRoleBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::ListClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
