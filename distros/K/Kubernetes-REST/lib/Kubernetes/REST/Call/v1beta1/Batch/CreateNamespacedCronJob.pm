package Kubernetes::REST::Call::v1beta1::Batch::CreateNamespacedCronJob;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Batch::CreateNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
