package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedReplicaSetStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedReplicaSetStatus - Deprecated - use the new Kubernetes::REST API instead
