package Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedDeploymentRollback;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedDeploymentRollback - Deprecated - use the new Kubernetes::REST API instead
