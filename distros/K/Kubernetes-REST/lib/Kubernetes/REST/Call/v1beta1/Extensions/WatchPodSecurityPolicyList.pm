package Kubernetes::REST::Call::v1beta1::Extensions::WatchPodSecurityPolicyList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchPodSecurityPolicyList - Deprecated - use the new Kubernetes::REST API instead
