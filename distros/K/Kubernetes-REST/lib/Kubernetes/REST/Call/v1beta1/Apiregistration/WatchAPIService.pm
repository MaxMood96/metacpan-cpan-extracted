package Kubernetes::REST::Call::v1beta1::Apiregistration::WatchAPIService;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apiregistration::WatchAPIService - Deprecated - use the new Kubernetes::REST API instead
