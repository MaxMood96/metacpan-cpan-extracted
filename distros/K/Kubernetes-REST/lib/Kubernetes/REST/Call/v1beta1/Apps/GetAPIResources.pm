package Kubernetes::REST::Call::v1beta1::Apps::GetAPIResources;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
