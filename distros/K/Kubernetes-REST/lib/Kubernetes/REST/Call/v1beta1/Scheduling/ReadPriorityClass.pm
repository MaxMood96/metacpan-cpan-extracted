package Kubernetes::REST::Call::v1beta1::Scheduling::ReadPriorityClass;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Scheduling::ReadPriorityClass - Deprecated - use the new Kubernetes::REST API instead
