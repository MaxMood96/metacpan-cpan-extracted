package Kubernetes::REST::Call::v1beta1::Storage::ListVolumeAttachment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Storage::ListVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
