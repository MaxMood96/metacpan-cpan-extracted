package Kubernetes::REST::Call::v1beta1::Events::WatchNamespacedEventList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Events::WatchNamespacedEventList - Deprecated - use the new Kubernetes::REST API instead
