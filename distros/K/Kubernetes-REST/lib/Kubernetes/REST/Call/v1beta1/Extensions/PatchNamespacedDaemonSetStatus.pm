package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDaemonSetStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDaemonSetStatus - Deprecated - use the new Kubernetes::REST API instead
