package Kubernetes::REST::Call::v1beta1::Coordination::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Coordination::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
