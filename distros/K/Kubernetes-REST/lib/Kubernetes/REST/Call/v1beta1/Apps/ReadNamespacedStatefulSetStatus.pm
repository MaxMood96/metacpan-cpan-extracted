package Kubernetes::REST::Call::v1beta1::Apps::ReadNamespacedStatefulSetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apps::ReadNamespacedStatefulSetStatus - Deprecated - use the new Kubernetes::REST API instead
