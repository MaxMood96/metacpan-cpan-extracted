package Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedDeployment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
