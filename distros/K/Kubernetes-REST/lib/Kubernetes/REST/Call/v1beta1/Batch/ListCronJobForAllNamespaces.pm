package Kubernetes::REST::Call::v1beta1::Batch::ListCronJobForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Batch::ListCronJobForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
