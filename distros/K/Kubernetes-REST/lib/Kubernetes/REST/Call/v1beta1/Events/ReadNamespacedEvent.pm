package Kubernetes::REST::Call::v1beta1::Events::ReadNamespacedEvent;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Events::ReadNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
