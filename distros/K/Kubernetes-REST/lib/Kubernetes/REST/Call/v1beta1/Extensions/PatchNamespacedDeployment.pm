package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDeployment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
