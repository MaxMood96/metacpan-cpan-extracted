package Kubernetes::REST::Call::v1beta1::Storage::DeleteCollectionStorageClass;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Storage::DeleteCollectionStorageClass - Deprecated - use the new Kubernetes::REST API instead
