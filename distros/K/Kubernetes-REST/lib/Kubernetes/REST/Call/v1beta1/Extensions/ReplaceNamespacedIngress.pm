package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedIngress;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedIngress - Deprecated - use the new Kubernetes::REST API instead
