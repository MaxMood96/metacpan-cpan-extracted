package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedDeploymentList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedDeploymentList - Deprecated - use the new Kubernetes::REST API instead
