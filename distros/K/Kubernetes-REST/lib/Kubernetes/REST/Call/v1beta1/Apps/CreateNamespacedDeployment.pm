package Kubernetes::REST::Call::v1beta1::Apps::CreateNamespacedDeployment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::CreateNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
