package Kubernetes::REST::Call::v1beta1::Apiregistration::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apiregistration::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
