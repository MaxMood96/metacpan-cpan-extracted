package Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedNetworkPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
