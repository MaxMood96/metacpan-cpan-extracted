package Kubernetes::REST::Call::v1beta1::Admissionregistration::WatchValidatingWebhookConfiguration;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::WatchValidatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
