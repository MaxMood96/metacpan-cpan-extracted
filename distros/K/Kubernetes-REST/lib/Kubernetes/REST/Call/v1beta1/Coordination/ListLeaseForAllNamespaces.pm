package Kubernetes::REST::Call::v1beta1::Coordination::ListLeaseForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Coordination::ListLeaseForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
