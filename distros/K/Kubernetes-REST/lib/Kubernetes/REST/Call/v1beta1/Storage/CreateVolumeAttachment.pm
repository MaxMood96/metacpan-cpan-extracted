package Kubernetes::REST::Call::v1beta1::Storage::CreateVolumeAttachment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Storage::CreateVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
