package Kubernetes::REST::Call::v1beta1::Apiextensions::GetAPIResources;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
