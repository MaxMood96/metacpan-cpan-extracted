package Kubernetes::REST::Call::v1beta1::Authorization::CreateSubjectAccessReview;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Authorization::CreateSubjectAccessReview - Deprecated - use the new Kubernetes::REST API instead
