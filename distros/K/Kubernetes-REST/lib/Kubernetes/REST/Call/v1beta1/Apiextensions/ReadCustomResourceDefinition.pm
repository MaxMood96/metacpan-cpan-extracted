package Kubernetes::REST::Call::v1beta1::Apiextensions::ReadCustomResourceDefinition;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::ReadCustomResourceDefinition - Deprecated - use the new Kubernetes::REST API instead
