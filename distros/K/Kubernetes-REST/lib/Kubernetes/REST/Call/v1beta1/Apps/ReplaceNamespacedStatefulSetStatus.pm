package Kubernetes::REST::Call::v1beta1::Apps::ReplaceNamespacedStatefulSetStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::ReplaceNamespacedStatefulSetStatus - Deprecated - use the new Kubernetes::REST API instead
