package Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedIngress;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedIngress - Deprecated - use the new Kubernetes::REST API instead
