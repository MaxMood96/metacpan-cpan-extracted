package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedDaemonSetList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedDaemonSetList - Deprecated - use the new Kubernetes::REST API instead
