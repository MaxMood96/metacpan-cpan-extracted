package Kubernetes::REST::Call::v1beta1::Policy::CreatePodSecurityPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::CreatePodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
