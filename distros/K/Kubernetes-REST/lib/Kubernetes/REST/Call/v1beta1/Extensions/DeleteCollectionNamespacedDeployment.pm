package Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedDeployment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
