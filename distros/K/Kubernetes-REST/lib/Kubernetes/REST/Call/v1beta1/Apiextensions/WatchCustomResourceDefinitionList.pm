package Kubernetes::REST::Call::v1beta1::Apiextensions::WatchCustomResourceDefinitionList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::WatchCustomResourceDefinitionList - Deprecated - use the new Kubernetes::REST API instead
