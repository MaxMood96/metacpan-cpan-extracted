package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedReplicaSetList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedReplicaSetList - Deprecated - use the new Kubernetes::REST API instead
