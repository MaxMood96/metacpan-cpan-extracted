package Kubernetes::REST::Call::v1beta1::Apiextensions::DeleteCollectionCustomResourceDefinition;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::DeleteCollectionCustomResourceDefinition - Deprecated - use the new Kubernetes::REST API instead
