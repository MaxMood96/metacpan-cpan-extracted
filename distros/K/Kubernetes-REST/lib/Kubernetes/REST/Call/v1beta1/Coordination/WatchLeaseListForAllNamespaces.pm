package Kubernetes::REST::Call::v1beta1::Coordination::WatchLeaseListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Coordination::WatchLeaseListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
