package Kubernetes::REST::Call::v1beta1::Coordination::WatchNamespacedLease;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Coordination::WatchNamespacedLease - Deprecated - use the new Kubernetes::REST API instead
