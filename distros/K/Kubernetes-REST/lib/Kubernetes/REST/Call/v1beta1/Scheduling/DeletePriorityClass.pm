package Kubernetes::REST::Call::v1beta1::Scheduling::DeletePriorityClass;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Scheduling::DeletePriorityClass - Deprecated - use the new Kubernetes::REST API instead
