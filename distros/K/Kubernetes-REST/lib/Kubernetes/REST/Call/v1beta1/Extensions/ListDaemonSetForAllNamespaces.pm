package Kubernetes::REST::Call::v1beta1::Extensions::ListDaemonSetForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListDaemonSetForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
