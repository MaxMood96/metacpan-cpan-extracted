package Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedStatefulSetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedStatefulSetStatus - Deprecated - use the new Kubernetes::REST API instead
