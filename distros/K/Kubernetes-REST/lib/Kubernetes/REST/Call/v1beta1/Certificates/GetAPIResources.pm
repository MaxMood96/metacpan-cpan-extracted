package Kubernetes::REST::Call::v1beta1::Certificates::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Certificates::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
