package Kubernetes::REST::Call::v1beta1::Scheduling::WatchPriorityClass;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Scheduling::WatchPriorityClass - Deprecated - use the new Kubernetes::REST API instead
