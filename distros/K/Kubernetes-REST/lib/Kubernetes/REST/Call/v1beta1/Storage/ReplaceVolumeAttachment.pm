package Kubernetes::REST::Call::v1beta1::Storage::ReplaceVolumeAttachment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Storage::ReplaceVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
