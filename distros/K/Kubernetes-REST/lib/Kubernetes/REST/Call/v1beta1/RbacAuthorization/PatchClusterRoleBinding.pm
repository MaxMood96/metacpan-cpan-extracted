package Kubernetes::REST::Call::v1beta1::RbacAuthorization::PatchClusterRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::PatchClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
