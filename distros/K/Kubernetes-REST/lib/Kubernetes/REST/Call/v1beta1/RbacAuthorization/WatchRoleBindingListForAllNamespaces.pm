package Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchRoleBindingListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchRoleBindingListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
