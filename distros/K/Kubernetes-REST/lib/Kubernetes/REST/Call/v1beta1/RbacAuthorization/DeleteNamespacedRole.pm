package Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteNamespacedRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
