package Kubernetes::REST::Call::v1beta1::Admissionregistration::WatchMutatingWebhookConfiguration;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::WatchMutatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
