package Kubernetes::REST::Call::v1beta1::Storage::CreateStorageClass;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Storage::CreateStorageClass - Deprecated - use the new Kubernetes::REST API instead
