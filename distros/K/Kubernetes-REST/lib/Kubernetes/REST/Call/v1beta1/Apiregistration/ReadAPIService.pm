package Kubernetes::REST::Call::v1beta1::Apiregistration::ReadAPIService;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apiregistration::ReadAPIService - Deprecated - use the new Kubernetes::REST API instead
