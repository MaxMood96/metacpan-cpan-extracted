package Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedDaemonSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
