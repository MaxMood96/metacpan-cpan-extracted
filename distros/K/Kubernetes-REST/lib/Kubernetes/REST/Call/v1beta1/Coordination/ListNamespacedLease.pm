package Kubernetes::REST::Call::v1beta1::Coordination::ListNamespacedLease;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Coordination::ListNamespacedLease - Deprecated - use the new Kubernetes::REST API instead
