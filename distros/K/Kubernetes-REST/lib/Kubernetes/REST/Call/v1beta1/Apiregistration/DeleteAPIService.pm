package Kubernetes::REST::Call::v1beta1::Apiregistration::DeleteAPIService;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apiregistration::DeleteAPIService - Deprecated - use the new Kubernetes::REST API instead
