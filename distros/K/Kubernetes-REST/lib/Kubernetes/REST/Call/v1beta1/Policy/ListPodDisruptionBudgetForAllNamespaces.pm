package Kubernetes::REST::Call::v1beta1::Policy::ListPodDisruptionBudgetForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::ListPodDisruptionBudgetForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
