package Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionPodSecurityPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionPodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
