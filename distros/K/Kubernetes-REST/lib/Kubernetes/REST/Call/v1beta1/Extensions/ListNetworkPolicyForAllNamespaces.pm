package Kubernetes::REST::Call::v1beta1::Extensions::ListNetworkPolicyForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListNetworkPolicyForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
