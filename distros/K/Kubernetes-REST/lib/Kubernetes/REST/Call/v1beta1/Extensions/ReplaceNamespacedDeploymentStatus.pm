package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDeploymentStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDeploymentStatus - Deprecated - use the new Kubernetes::REST API instead
