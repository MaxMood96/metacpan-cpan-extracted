package Kubernetes::REST::Call::v1beta1::Scheduling::CreatePriorityClass;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Scheduling::CreatePriorityClass - Deprecated - use the new Kubernetes::REST API instead
