package Kubernetes::REST::Call::v1beta1::Batch::WatchCronJobListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Batch::WatchCronJobListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
