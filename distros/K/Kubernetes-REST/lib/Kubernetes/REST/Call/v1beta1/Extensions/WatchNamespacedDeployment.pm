package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedDeployment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
