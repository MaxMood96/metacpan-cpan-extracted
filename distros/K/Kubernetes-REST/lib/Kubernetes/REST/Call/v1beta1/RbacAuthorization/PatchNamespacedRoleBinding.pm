package Kubernetes::REST::Call::v1beta1::RbacAuthorization::PatchNamespacedRoleBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::PatchNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
