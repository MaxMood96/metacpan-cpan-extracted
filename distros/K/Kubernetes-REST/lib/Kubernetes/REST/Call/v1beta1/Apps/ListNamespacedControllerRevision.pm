package Kubernetes::REST::Call::v1beta1::Apps::ListNamespacedControllerRevision;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::ListNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
