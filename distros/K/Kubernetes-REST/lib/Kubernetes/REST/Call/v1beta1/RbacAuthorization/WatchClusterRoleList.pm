package Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchClusterRoleList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchClusterRoleList - Deprecated - use the new Kubernetes::REST API instead
