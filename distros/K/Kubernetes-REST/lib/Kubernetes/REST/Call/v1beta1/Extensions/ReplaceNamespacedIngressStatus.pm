package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedIngressStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedIngressStatus - Deprecated - use the new Kubernetes::REST API instead
