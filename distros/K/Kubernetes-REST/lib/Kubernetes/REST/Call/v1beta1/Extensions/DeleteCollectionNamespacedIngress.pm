package Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedIngress;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedIngress - Deprecated - use the new Kubernetes::REST API instead
