package Kubernetes::REST::Call::v1beta1::Events::GetAPIResources;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Events::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
