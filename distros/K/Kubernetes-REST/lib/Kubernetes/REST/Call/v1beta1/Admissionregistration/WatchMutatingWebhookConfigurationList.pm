package Kubernetes::REST::Call::v1beta1::Admissionregistration::WatchMutatingWebhookConfigurationList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::WatchMutatingWebhookConfigurationList - Deprecated - use the new Kubernetes::REST API instead
