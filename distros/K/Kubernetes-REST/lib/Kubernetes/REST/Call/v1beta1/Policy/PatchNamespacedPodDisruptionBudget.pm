package Kubernetes::REST::Call::v1beta1::Policy::PatchNamespacedPodDisruptionBudget;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::PatchNamespacedPodDisruptionBudget - Deprecated - use the new Kubernetes::REST API instead
