package Kubernetes::REST::Call::v1beta1::Batch::PatchNamespacedCronJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Batch::PatchNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
