package Kubernetes::REST::Call::v1beta1::Apiregistration::ReplaceAPIServiceStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apiregistration::ReplaceAPIServiceStatus - Deprecated - use the new Kubernetes::REST API instead
