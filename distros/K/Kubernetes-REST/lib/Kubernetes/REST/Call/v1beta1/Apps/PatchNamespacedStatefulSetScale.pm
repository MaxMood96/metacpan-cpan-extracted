package Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedStatefulSetScale;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedStatefulSetScale - Deprecated - use the new Kubernetes::REST API instead
