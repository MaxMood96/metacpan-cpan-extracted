package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedNetworkPolicyList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedNetworkPolicyList - Deprecated - use the new Kubernetes::REST API instead
