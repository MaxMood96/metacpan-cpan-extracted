package Kubernetes::REST::Call::v1beta1::Events::WatchEventListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Events::WatchEventListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
