package Kubernetes::REST::Call::v1beta1::RbacAuthorization::PatchClusterRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::PatchClusterRole - Deprecated - use the new Kubernetes::REST API instead
