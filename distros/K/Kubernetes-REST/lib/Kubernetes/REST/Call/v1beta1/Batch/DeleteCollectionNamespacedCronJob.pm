package Kubernetes::REST::Call::v1beta1::Batch::DeleteCollectionNamespacedCronJob;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Batch::DeleteCollectionNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
