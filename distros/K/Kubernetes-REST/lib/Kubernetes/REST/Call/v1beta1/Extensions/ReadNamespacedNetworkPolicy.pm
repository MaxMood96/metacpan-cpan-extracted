package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedNetworkPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
