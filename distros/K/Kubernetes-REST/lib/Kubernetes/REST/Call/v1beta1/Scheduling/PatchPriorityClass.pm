package Kubernetes::REST::Call::v1beta1::Scheduling::PatchPriorityClass;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Scheduling::PatchPriorityClass - Deprecated - use the new Kubernetes::REST API instead
