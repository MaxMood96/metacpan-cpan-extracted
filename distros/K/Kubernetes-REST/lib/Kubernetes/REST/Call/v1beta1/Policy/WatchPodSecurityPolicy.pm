package Kubernetes::REST::Call::v1beta1::Policy::WatchPodSecurityPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::WatchPodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
