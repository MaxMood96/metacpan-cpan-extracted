package Kubernetes::REST::Call::v1beta1::Events::DeleteCollectionNamespacedEvent;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Events::DeleteCollectionNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
