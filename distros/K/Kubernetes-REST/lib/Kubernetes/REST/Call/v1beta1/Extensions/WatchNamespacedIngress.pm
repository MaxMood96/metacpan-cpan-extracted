package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedIngress;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedIngress - Deprecated - use the new Kubernetes::REST API instead
