package Kubernetes::REST::Call::v1beta1::Certificates::DeleteCertificateSigningRequest;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Certificates::DeleteCertificateSigningRequest - Deprecated - use the new Kubernetes::REST API instead
