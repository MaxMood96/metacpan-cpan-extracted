package Kubernetes::REST::Call::v1beta1::Admissionregistration::ReadMutatingWebhookConfiguration;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::ReadMutatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
