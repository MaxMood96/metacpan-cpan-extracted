package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDeployment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
