package Kubernetes::REST::Call::v1beta1::Events::ListEventForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Events::ListEventForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
