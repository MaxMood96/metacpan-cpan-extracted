package Kubernetes::REST::Call::v1beta1::Extensions::ListReplicaSetForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListReplicaSetForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
