package Kubernetes::REST::Call::v1beta1::RbacAuthorization::CreateNamespacedRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::CreateNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
