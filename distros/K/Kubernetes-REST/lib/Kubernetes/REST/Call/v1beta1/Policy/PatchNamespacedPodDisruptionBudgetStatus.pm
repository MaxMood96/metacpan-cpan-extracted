package Kubernetes::REST::Call::v1beta1::Policy::PatchNamespacedPodDisruptionBudgetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::PatchNamespacedPodDisruptionBudgetStatus - Deprecated - use the new Kubernetes::REST API instead
