package Kubernetes::REST::Call::v1beta1::Certificates::WatchCertificateSigningRequestList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Certificates::WatchCertificateSigningRequestList - Deprecated - use the new Kubernetes::REST API instead
