package Kubernetes::REST::Call::v1beta1::Apiregistration::ListAPIService;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apiregistration::ListAPIService - Deprecated - use the new Kubernetes::REST API instead
