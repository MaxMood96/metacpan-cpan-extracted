package Kubernetes::REST::Call::v1beta1::Storage::ReplaceStorageClass;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Storage::ReplaceStorageClass - Deprecated - use the new Kubernetes::REST API instead
