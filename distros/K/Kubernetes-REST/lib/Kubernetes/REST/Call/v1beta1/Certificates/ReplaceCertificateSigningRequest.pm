package Kubernetes::REST::Call::v1beta1::Certificates::ReplaceCertificateSigningRequest;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Certificates::ReplaceCertificateSigningRequest - Deprecated - use the new Kubernetes::REST API instead
