package Kubernetes::REST::Call::v1beta1::Extensions::ListIngressForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListIngressForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
