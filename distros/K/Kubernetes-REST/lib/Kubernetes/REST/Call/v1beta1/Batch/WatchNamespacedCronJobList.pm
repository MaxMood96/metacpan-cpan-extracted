package Kubernetes::REST::Call::v1beta1::Batch::WatchNamespacedCronJobList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Batch::WatchNamespacedCronJobList - Deprecated - use the new Kubernetes::REST API instead
