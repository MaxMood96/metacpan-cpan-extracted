package Kubernetes::REST::Call::v1beta1::Storage::ListStorageClass;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Storage::ListStorageClass - Deprecated - use the new Kubernetes::REST API instead
