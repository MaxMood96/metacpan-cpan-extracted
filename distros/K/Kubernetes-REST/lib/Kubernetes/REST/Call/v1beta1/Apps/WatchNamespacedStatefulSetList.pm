package Kubernetes::REST::Call::v1beta1::Apps::WatchNamespacedStatefulSetList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::WatchNamespacedStatefulSetList - Deprecated - use the new Kubernetes::REST API instead
