package Kubernetes::REST::Call::v1beta1::Storage::PatchVolumeAttachment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Storage::PatchVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
