package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
