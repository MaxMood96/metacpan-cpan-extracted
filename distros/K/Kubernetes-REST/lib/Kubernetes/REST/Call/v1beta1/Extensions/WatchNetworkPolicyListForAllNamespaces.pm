package Kubernetes::REST::Call::v1beta1::Extensions::WatchNetworkPolicyListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNetworkPolicyListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
