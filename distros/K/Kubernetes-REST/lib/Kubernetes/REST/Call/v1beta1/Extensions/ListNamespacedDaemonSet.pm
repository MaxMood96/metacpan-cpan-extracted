package Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedDaemonSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
