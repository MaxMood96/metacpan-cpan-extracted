package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedIngressList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedIngressList - Deprecated - use the new Kubernetes::REST API instead
