package Kubernetes::REST::Call::v1beta1::Admissionregistration::DeleteCollectionMutatingWebhookConfiguration;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::DeleteCollectionMutatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
