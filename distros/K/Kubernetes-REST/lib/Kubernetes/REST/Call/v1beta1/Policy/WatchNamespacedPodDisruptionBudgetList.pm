package Kubernetes::REST::Call::v1beta1::Policy::WatchNamespacedPodDisruptionBudgetList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Policy::WatchNamespacedPodDisruptionBudgetList - Deprecated - use the new Kubernetes::REST API instead
