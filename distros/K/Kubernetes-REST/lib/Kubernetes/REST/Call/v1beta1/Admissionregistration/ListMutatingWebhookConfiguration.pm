package Kubernetes::REST::Call::v1beta1::Admissionregistration::ListMutatingWebhookConfiguration;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::ListMutatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
