package Kubernetes::REST::Call::v1beta1::Apiextensions::ReplaceCustomResourceDefinition;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::ReplaceCustomResourceDefinition - Deprecated - use the new Kubernetes::REST API instead
