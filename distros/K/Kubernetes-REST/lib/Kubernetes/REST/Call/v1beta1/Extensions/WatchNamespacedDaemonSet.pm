package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedDaemonSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
