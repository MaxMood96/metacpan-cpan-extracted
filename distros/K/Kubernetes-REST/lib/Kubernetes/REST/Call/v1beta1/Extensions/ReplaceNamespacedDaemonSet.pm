package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDaemonSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
