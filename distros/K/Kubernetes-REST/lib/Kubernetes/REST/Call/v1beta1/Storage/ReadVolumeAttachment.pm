package Kubernetes::REST::Call::v1beta1::Storage::ReadVolumeAttachment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Storage::ReadVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
