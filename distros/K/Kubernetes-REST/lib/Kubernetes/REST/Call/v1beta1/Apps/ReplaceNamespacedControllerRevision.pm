package Kubernetes::REST::Call::v1beta1::Apps::ReplaceNamespacedControllerRevision;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::ReplaceNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
