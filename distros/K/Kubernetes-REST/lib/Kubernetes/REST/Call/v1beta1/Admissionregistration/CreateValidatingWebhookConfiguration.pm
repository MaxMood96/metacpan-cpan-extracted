package Kubernetes::REST::Call::v1beta1::Admissionregistration::CreateValidatingWebhookConfiguration;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::CreateValidatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
