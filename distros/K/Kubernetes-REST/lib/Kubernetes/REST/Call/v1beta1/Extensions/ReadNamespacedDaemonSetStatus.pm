package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedDaemonSetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedDaemonSetStatus - Deprecated - use the new Kubernetes::REST API instead
