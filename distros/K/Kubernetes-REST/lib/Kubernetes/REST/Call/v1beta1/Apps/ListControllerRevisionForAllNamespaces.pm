package Kubernetes::REST::Call::v1beta1::Apps::ListControllerRevisionForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apps::ListControllerRevisionForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
