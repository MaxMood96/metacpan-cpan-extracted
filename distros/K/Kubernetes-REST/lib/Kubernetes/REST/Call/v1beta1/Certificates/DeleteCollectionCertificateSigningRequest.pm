package Kubernetes::REST::Call::v1beta1::Certificates::DeleteCollectionCertificateSigningRequest;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Certificates::DeleteCollectionCertificateSigningRequest - Deprecated - use the new Kubernetes::REST API instead
