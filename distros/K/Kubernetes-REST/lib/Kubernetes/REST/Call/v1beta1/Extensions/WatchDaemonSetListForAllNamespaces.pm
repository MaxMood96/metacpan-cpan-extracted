package Kubernetes::REST::Call::v1beta1::Extensions::WatchDaemonSetListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchDaemonSetListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
