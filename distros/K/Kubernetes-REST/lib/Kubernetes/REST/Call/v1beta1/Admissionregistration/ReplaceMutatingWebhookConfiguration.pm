package Kubernetes::REST::Call::v1beta1::Admissionregistration::ReplaceMutatingWebhookConfiguration;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::ReplaceMutatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
