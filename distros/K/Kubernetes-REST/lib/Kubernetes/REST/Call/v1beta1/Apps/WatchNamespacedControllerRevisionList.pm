package Kubernetes::REST::Call::v1beta1::Apps::WatchNamespacedControllerRevisionList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::WatchNamespacedControllerRevisionList - Deprecated - use the new Kubernetes::REST API instead
