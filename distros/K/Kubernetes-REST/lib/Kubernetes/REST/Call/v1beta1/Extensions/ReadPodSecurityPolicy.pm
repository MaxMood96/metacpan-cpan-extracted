package Kubernetes::REST::Call::v1beta1::Extensions::ReadPodSecurityPolicy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadPodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
