package Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchNamespacedRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
