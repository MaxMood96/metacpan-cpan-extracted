package Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::CreateNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
