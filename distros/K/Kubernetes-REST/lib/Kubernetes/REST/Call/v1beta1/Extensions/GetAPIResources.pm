package Kubernetes::REST::Call::v1beta1::Extensions::GetAPIResources;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
