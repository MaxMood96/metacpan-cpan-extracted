package Kubernetes::REST::Call::v1beta1::Certificates::ReadCertificateSigningRequest;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Certificates::ReadCertificateSigningRequest - Deprecated - use the new Kubernetes::REST API instead
