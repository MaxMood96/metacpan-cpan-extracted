package Kubernetes::REST::Call::v1beta1::Events::ReplaceNamespacedEvent;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Events::ReplaceNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
