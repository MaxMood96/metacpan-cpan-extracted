package Kubernetes::REST::Call::v1beta1::Batch::WatchNamespacedCronJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Batch::WatchNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
