package Kubernetes::REST::Call::v1beta1::Scheduling::WatchPriorityClassList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Scheduling::WatchPriorityClassList - Deprecated - use the new Kubernetes::REST API instead
