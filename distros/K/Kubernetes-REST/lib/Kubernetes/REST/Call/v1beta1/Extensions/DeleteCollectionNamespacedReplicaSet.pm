package Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedReplicaSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
