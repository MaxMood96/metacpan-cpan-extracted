package Kubernetes::REST::Call::v1beta1::Admissionregistration::ReadValidatingWebhookConfiguration;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::ReadValidatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
