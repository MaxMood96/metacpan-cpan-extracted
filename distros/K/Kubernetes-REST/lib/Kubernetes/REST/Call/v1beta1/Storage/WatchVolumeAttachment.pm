package Kubernetes::REST::Call::v1beta1::Storage::WatchVolumeAttachment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Storage::WatchVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
