package Kubernetes::REST::Call::v1beta1::Certificates::WatchCertificateSigningRequest;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Certificates::WatchCertificateSigningRequest - Deprecated - use the new Kubernetes::REST API instead
