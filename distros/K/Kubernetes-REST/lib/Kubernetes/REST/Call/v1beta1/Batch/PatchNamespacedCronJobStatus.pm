package Kubernetes::REST::Call::v1beta1::Batch::PatchNamespacedCronJobStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Batch::PatchNamespacedCronJobStatus - Deprecated - use the new Kubernetes::REST API instead
