package Kubernetes::REST::Call::v1beta1::Extensions::WatchDeploymentListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchDeploymentListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
