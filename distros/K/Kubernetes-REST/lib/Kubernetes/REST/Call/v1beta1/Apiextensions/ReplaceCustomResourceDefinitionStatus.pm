package Kubernetes::REST::Call::v1beta1::Apiextensions::ReplaceCustomResourceDefinitionStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::ReplaceCustomResourceDefinitionStatus - Deprecated - use the new Kubernetes::REST API instead
