package Kubernetes::REST::Call::v1beta1::Authorization::GetAPIResources;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Authorization::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
