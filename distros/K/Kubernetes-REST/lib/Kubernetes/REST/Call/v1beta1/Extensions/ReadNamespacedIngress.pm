package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedIngress;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedIngress - Deprecated - use the new Kubernetes::REST API instead
