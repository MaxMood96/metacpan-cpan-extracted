package Kubernetes::REST::Call::v1beta1::Coordination::DeleteNamespacedLease;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Coordination::DeleteNamespacedLease - Deprecated - use the new Kubernetes::REST API instead
