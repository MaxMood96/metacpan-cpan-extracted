package Kubernetes::REST::Call::v1beta1::Apps::DeleteCollectionNamespacedDeployment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Apps::DeleteCollectionNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
