package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
