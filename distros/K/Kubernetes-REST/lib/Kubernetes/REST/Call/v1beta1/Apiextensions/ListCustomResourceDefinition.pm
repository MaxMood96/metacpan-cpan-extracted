package Kubernetes::REST::Call::v1beta1::Apiextensions::ListCustomResourceDefinition;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apiextensions::ListCustomResourceDefinition - Deprecated - use the new Kubernetes::REST API instead
