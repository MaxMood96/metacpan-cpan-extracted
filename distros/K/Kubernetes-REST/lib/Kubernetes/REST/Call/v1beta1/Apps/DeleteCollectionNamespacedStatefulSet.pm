package Kubernetes::REST::Call::v1beta1::Apps::DeleteCollectionNamespacedStatefulSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::DeleteCollectionNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
