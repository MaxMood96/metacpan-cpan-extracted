package Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedIngress;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedIngress - Deprecated - use the new Kubernetes::REST API instead
