package Kubernetes::REST::Call::v1beta1::Admissionregistration::DeleteMutatingWebhookConfiguration;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::DeleteMutatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
