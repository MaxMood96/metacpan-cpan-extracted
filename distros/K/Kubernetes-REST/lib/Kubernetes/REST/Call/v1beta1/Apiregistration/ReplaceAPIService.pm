package Kubernetes::REST::Call::v1beta1::Apiregistration::ReplaceAPIService;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apiregistration::ReplaceAPIService - Deprecated - use the new Kubernetes::REST API instead
