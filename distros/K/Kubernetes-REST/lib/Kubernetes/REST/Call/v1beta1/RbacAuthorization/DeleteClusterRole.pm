package Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteClusterRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteClusterRole - Deprecated - use the new Kubernetes::REST API instead
