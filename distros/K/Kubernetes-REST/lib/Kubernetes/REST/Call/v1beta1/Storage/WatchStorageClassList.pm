package Kubernetes::REST::Call::v1beta1::Storage::WatchStorageClassList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Storage::WatchStorageClassList - Deprecated - use the new Kubernetes::REST API instead
