package Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedNetworkPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
