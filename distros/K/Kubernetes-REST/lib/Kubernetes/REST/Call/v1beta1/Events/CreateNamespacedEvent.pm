package Kubernetes::REST::Call::v1beta1::Events::CreateNamespacedEvent;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Events::CreateNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
