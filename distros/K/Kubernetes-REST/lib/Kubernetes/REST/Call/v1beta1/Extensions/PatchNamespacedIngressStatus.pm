package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedIngressStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedIngressStatus - Deprecated - use the new Kubernetes::REST API instead
