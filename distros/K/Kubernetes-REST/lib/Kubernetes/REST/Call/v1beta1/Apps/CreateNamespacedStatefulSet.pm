package Kubernetes::REST::Call::v1beta1::Apps::CreateNamespacedStatefulSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::CreateNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
