package Kubernetes::REST::Call::v1beta1::Apps::WatchStatefulSetListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apps::WatchStatefulSetListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
