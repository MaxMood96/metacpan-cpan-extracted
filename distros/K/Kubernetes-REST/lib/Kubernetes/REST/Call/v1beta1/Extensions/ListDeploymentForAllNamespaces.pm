package Kubernetes::REST::Call::v1beta1::Extensions::ListDeploymentForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListDeploymentForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
