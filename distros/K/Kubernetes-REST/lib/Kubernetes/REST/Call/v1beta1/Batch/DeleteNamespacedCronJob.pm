package Kubernetes::REST::Call::v1beta1::Batch::DeleteNamespacedCronJob;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Batch::DeleteNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
