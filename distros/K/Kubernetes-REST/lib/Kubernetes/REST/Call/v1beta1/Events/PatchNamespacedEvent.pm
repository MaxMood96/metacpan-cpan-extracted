package Kubernetes::REST::Call::v1beta1::Events::PatchNamespacedEvent;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Events::PatchNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
