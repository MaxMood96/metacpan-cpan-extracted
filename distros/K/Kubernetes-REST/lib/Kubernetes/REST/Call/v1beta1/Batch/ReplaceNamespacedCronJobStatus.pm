package Kubernetes::REST::Call::v1beta1::Batch::ReplaceNamespacedCronJobStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Batch::ReplaceNamespacedCronJobStatus - Deprecated - use the new Kubernetes::REST API instead
