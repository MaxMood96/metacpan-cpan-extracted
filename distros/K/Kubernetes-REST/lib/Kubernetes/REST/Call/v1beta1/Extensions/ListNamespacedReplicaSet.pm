package Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedReplicaSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
