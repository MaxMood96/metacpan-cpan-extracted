package Kubernetes::REST::Call::v1beta1::RbacAuthorization::ReplaceNamespacedRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::ReplaceNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
