package Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedDaemonSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteCollectionNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
