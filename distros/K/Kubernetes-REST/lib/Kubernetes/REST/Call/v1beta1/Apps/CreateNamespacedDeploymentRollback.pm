package Kubernetes::REST::Call::v1beta1::Apps::CreateNamespacedDeploymentRollback;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::CreateNamespacedDeploymentRollback - Deprecated - use the new Kubernetes::REST API instead
