package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDaemonSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
