package Kubernetes::REST::Call::v1beta1::RbacAuthorization::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
