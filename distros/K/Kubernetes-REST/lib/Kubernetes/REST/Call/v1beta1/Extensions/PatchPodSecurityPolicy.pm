package Kubernetes::REST::Call::v1beta1::Extensions::PatchPodSecurityPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchPodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
