package Kubernetes::REST::Call::v1beta1::Policy::ReplaceNamespacedPodDisruptionBudget;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::ReplaceNamespacedPodDisruptionBudget - Deprecated - use the new Kubernetes::REST API instead
