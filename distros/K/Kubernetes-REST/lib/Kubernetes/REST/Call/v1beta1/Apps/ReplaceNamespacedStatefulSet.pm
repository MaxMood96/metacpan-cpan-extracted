package Kubernetes::REST::Call::v1beta1::Apps::ReplaceNamespacedStatefulSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apps::ReplaceNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
