package Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
