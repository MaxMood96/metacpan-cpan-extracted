package Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedDeployment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ListNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
