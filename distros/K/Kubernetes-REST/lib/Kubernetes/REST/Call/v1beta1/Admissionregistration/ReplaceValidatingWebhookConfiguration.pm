package Kubernetes::REST::Call::v1beta1::Admissionregistration::ReplaceValidatingWebhookConfiguration;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::ReplaceValidatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
