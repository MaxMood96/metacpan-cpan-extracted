package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedIngressStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedIngressStatus - Deprecated - use the new Kubernetes::REST API instead
