package Kubernetes::REST::Call::v1beta1::Extensions::WatchIngressListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::WatchIngressListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
