package Kubernetes::REST::Call::v1beta1::Apps::WatchNamespacedControllerRevision;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Apps::WatchNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
