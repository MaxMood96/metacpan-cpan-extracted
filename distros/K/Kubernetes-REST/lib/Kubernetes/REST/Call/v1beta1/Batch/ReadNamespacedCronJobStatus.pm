package Kubernetes::REST::Call::v1beta1::Batch::ReadNamespacedCronJobStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Batch::ReadNamespacedCronJobStatus - Deprecated - use the new Kubernetes::REST API instead
