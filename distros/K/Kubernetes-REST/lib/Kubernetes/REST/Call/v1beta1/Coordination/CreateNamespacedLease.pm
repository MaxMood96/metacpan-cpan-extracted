package Kubernetes::REST::Call::v1beta1::Coordination::CreateNamespacedLease;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Coordination::CreateNamespacedLease - Deprecated - use the new Kubernetes::REST API instead
