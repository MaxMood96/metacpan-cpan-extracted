package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedReplicaSetStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedReplicaSetStatus - Deprecated - use the new Kubernetes::REST API instead
