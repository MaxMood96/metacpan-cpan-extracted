package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedDeployment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
