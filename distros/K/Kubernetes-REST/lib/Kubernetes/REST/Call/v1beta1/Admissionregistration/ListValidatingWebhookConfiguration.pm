package Kubernetes::REST::Call::v1beta1::Admissionregistration::ListValidatingWebhookConfiguration;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::ListValidatingWebhookConfiguration - Deprecated - use the new Kubernetes::REST API instead
