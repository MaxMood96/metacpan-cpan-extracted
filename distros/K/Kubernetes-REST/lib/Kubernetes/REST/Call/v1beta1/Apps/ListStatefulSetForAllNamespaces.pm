package Kubernetes::REST::Call::v1beta1::Apps::ListStatefulSetForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::ListStatefulSetForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
