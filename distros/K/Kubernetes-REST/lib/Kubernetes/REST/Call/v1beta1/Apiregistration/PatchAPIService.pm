package Kubernetes::REST::Call::v1beta1::Apiregistration::PatchAPIService;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apiregistration::PatchAPIService - Deprecated - use the new Kubernetes::REST API instead
