package Kubernetes::REST::Call::v1beta1::Events::WatchNamespacedEvent;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Events::WatchNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
