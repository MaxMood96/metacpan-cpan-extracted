package Kubernetes::REST::Call::v1beta1::RbacAuthorization::CreateNamespacedRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::CreateNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
