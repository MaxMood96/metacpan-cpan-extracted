package Kubernetes::REST::Call::v1beta1::Events::ListNamespacedEvent;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Events::ListNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
