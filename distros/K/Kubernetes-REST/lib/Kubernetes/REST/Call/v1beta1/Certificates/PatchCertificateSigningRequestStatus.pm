package Kubernetes::REST::Call::v1beta1::Certificates::PatchCertificateSigningRequestStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Certificates::PatchCertificateSigningRequestStatus - Deprecated - use the new Kubernetes::REST API instead
