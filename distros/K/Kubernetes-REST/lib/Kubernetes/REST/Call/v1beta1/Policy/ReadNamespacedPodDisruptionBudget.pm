package Kubernetes::REST::Call::v1beta1::Policy::ReadNamespacedPodDisruptionBudget;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Policy::ReadNamespacedPodDisruptionBudget - Deprecated - use the new Kubernetes::REST API instead
