package Kubernetes::REST::Call::v1beta1::Policy::DeleteNamespacedPodDisruptionBudget;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Policy::DeleteNamespacedPodDisruptionBudget - Deprecated - use the new Kubernetes::REST API instead
