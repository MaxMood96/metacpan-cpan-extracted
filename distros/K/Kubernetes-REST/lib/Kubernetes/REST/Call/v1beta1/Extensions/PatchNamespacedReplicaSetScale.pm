package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedReplicaSetScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedReplicaSetScale - Deprecated - use the new Kubernetes::REST API instead
