package Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteCollectionNamespacedRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::DeleteCollectionNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
