package Kubernetes::REST::Call::v1beta1::Policy::WatchPodDisruptionBudgetListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Policy::WatchPodDisruptionBudgetListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
