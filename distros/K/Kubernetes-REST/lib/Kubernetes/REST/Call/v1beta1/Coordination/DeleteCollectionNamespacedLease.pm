package Kubernetes::REST::Call::v1beta1::Coordination::DeleteCollectionNamespacedLease;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Coordination::DeleteCollectionNamespacedLease - Deprecated - use the new Kubernetes::REST API instead
