package Kubernetes::REST::Call::v1beta1::Policy::ReplaceNamespacedPodDisruptionBudgetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Policy::ReplaceNamespacedPodDisruptionBudgetStatus - Deprecated - use the new Kubernetes::REST API instead
