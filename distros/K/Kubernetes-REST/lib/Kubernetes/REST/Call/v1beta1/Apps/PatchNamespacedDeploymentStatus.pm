package Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedDeploymentStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Apps::PatchNamespacedDeploymentStatus - Deprecated - use the new Kubernetes::REST API instead
