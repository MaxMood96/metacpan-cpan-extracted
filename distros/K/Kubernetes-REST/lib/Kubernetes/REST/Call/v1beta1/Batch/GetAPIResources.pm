package Kubernetes::REST::Call::v1beta1::Batch::GetAPIResources;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Batch::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
