package Kubernetes::REST::Call::v1beta1::Scheduling::ListPriorityClass;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Scheduling::ListPriorityClass - Deprecated - use the new Kubernetes::REST API instead
