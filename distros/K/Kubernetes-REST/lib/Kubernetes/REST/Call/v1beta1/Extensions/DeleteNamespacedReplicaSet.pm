package Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::DeleteNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
