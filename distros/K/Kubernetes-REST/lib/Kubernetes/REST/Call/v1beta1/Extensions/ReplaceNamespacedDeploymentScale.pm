package Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDeploymentScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReplaceNamespacedDeploymentScale - Deprecated - use the new Kubernetes::REST API instead
