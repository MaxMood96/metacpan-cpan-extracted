package Kubernetes::REST::Call::v1beta1::Policy::PatchPodSecurityPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Policy::PatchPodSecurityPolicy - Deprecated - use the new Kubernetes::REST API instead
