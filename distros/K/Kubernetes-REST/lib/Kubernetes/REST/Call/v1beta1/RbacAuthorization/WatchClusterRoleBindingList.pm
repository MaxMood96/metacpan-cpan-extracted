package Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchClusterRoleBindingList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::RbacAuthorization::WatchClusterRoleBindingList - Deprecated - use the new Kubernetes::REST API instead
