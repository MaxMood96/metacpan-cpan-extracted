package Kubernetes::REST::Call::v1beta1::Admissionregistration::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Admissionregistration::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
