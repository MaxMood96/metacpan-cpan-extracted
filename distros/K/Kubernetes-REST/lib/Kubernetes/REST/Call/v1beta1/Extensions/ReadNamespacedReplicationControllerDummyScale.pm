package Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedReplicationControllerDummyScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta1::Extensions::ReadNamespacedReplicationControllerDummyScale - Deprecated - use the new Kubernetes::REST API instead
