package Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedReplicaSetStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta1::Extensions::PatchNamespacedReplicaSetStatus - Deprecated - use the new Kubernetes::REST API instead
