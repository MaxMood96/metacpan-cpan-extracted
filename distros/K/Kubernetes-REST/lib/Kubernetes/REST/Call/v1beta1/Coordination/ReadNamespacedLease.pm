package Kubernetes::REST::Call::v1beta1::Coordination::ReadNamespacedLease;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta1::Coordination::ReadNamespacedLease - Deprecated - use the new Kubernetes::REST API instead
