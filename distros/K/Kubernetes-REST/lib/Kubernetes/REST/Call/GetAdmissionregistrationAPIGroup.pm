package Kubernetes::REST::Call::GetAdmissionregistrationAPIGroup;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::GetAdmissionregistrationAPIGroup - Deprecated - use the new Kubernetes::REST API instead
