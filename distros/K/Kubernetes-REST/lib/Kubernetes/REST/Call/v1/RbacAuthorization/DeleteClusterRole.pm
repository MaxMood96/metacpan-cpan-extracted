package Kubernetes::REST::Call::v1::RbacAuthorization::DeleteClusterRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::RbacAuthorization::DeleteClusterRole - Deprecated - use the new Kubernetes::REST API instead
