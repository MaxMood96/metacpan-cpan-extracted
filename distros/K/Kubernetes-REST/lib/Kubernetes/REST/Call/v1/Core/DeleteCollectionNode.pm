package Kubernetes::REST::Call::v1::Core::DeleteCollectionNode;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNode - Deprecated - use the new Kubernetes::REST API instead
