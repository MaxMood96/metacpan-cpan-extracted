package Kubernetes::REST::Call::v1::Apps::PatchNamespacedStatefulSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
