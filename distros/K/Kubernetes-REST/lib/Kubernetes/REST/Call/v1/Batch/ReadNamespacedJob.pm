package Kubernetes::REST::Call::v1::Batch::ReadNamespacedJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Batch::ReadNamespacedJob - Deprecated - use the new Kubernetes::REST API instead
