package Kubernetes::REST::Call::v1::Core::PatchNamespacedConfigMap;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedConfigMap - Deprecated - use the new Kubernetes::REST API instead
