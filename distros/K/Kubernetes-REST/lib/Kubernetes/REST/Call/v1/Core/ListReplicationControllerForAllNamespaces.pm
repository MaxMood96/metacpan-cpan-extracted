package Kubernetes::REST::Call::v1::Core::ListReplicationControllerForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ListReplicationControllerForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
