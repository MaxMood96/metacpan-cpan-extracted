package Kubernetes::REST::Call::v1::Core::DeleteNamespacedPod;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedPod - Deprecated - use the new Kubernetes::REST API instead
