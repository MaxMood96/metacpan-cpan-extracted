package Kubernetes::REST::Call::v1::Core::CreateNamespacedLimitRange;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedLimitRange - Deprecated - use the new Kubernetes::REST API instead
