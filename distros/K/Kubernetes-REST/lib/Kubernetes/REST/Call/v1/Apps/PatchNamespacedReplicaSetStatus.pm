package Kubernetes::REST::Call::v1::Apps::PatchNamespacedReplicaSetStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedReplicaSetStatus - Deprecated - use the new Kubernetes::REST API instead
