package Kubernetes::REST::Call::v1::Core::ConnectOptionsNodeProxy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectOptionsNodeProxy - Deprecated - use the new Kubernetes::REST API instead
