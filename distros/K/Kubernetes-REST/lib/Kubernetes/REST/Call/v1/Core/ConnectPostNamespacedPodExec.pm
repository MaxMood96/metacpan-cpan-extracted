package Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedPodExec;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedPodExec - Deprecated - use the new Kubernetes::REST API instead
