package Kubernetes::REST::Call::v1::Apps::WatchNamespacedStatefulSetList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::WatchNamespacedStatefulSetList - Deprecated - use the new Kubernetes::REST API instead
