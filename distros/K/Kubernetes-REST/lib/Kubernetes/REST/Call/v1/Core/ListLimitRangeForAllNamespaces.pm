package Kubernetes::REST::Call::v1::Core::ListLimitRangeForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ListLimitRangeForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
