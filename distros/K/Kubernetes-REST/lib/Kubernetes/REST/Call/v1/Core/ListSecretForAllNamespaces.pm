package Kubernetes::REST::Call::v1::Core::ListSecretForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ListSecretForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
