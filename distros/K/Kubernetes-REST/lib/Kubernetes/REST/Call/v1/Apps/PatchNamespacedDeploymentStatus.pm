package Kubernetes::REST::Call::v1::Apps::PatchNamespacedDeploymentStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedDeploymentStatus - Deprecated - use the new Kubernetes::REST API instead
