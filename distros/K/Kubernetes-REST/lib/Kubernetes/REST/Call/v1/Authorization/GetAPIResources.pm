package Kubernetes::REST::Call::v1::Authorization::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Authorization::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
