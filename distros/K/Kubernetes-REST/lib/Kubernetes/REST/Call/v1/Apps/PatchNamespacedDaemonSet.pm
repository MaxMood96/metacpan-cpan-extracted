package Kubernetes::REST::Call::v1::Apps::PatchNamespacedDaemonSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
