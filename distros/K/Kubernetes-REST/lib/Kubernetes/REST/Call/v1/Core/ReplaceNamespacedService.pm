package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedService;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedService - Deprecated - use the new Kubernetes::REST API instead
