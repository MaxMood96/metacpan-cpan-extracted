package Kubernetes::REST::Call::v1::Core::ReadNamespacedPodStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedPodStatus - Deprecated - use the new Kubernetes::REST API instead
