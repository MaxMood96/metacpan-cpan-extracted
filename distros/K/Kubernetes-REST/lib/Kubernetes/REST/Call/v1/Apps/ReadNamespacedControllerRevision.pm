package Kubernetes::REST::Call::v1::Apps::ReadNamespacedControllerRevision;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ReadNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
