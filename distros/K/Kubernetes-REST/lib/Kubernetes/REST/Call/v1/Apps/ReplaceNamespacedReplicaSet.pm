package Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedReplicaSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
