package Kubernetes::REST::Call::v1::Core::CreateNamespacedEndpoints;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedEndpoints - Deprecated - use the new Kubernetes::REST API instead
