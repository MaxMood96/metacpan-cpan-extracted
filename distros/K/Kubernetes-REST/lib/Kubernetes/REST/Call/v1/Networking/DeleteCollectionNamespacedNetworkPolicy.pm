package Kubernetes::REST::Call::v1::Networking::DeleteCollectionNamespacedNetworkPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Networking::DeleteCollectionNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
