package Kubernetes::REST::Call::v1::RbacAuthorization::WatchClusterRoleBindingList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::RbacAuthorization::WatchClusterRoleBindingList - Deprecated - use the new Kubernetes::REST API instead
