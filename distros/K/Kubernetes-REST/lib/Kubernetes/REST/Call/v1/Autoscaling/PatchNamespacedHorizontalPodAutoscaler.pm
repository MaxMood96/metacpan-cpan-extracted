package Kubernetes::REST::Call::v1::Autoscaling::PatchNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Autoscaling::PatchNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
