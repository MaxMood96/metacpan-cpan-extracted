package Kubernetes::REST::Call::v1::Core::WatchNamespacedPod;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedPod - Deprecated - use the new Kubernetes::REST API instead
