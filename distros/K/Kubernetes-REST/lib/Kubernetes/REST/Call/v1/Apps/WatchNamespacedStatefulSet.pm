package Kubernetes::REST::Call::v1::Apps::WatchNamespacedStatefulSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::WatchNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
