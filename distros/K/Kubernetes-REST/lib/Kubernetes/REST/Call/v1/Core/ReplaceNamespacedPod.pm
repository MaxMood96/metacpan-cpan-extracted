package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPod;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPod - Deprecated - use the new Kubernetes::REST API instead
