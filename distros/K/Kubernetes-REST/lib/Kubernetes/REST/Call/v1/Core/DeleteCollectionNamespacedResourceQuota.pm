package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedResourceQuota;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedResourceQuota - Deprecated - use the new Kubernetes::REST API instead
