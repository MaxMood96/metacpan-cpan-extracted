package Kubernetes::REST::Call::v1::Core::ConnectHeadNamespacedServiceProxyWithPath;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectHeadNamespacedServiceProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
