package Kubernetes::REST::Call::v1::Core::WatchNamespacedPodList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedPodList - Deprecated - use the new Kubernetes::REST API instead
