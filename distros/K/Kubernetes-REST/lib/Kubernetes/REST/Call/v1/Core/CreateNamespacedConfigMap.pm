package Kubernetes::REST::Call::v1::Core::CreateNamespacedConfigMap;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedConfigMap - Deprecated - use the new Kubernetes::REST API instead
