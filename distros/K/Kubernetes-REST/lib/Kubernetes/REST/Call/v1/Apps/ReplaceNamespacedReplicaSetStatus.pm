package Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedReplicaSetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedReplicaSetStatus - Deprecated - use the new Kubernetes::REST API instead
