package Kubernetes::REST::Call::v1::Core::ConnectDeleteNodeProxy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectDeleteNodeProxy - Deprecated - use the new Kubernetes::REST API instead
