package Kubernetes::REST::Call::v1::Apps::WatchNamespacedDaemonSetList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::WatchNamespacedDaemonSetList - Deprecated - use the new Kubernetes::REST API instead
