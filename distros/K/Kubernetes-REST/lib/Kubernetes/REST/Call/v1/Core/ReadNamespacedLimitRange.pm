package Kubernetes::REST::Call::v1::Core::ReadNamespacedLimitRange;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedLimitRange - Deprecated - use the new Kubernetes::REST API instead
