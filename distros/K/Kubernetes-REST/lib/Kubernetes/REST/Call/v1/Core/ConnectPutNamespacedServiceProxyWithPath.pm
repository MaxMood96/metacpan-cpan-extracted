package Kubernetes::REST::Call::v1::Core::ConnectPutNamespacedServiceProxyWithPath;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectPutNamespacedServiceProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
