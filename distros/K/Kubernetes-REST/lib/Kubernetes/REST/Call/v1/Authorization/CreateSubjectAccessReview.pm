package Kubernetes::REST::Call::v1::Authorization::CreateSubjectAccessReview;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Authorization::CreateSubjectAccessReview - Deprecated - use the new Kubernetes::REST API instead
