package Kubernetes::REST::Call::v1::RbacAuthorization::GetAPIResources;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::RbacAuthorization::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
