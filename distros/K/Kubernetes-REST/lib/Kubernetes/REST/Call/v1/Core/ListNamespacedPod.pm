package Kubernetes::REST::Call::v1::Core::ListNamespacedPod;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedPod - Deprecated - use the new Kubernetes::REST API instead
