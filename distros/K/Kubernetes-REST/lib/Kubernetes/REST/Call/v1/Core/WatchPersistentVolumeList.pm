package Kubernetes::REST::Call::v1::Core::WatchPersistentVolumeList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchPersistentVolumeList - Deprecated - use the new Kubernetes::REST API instead
