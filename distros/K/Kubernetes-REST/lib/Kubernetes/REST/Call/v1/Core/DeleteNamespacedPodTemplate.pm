package Kubernetes::REST::Call::v1::Core::DeleteNamespacedPodTemplate;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedPodTemplate - Deprecated - use the new Kubernetes::REST API instead
