package Kubernetes::REST::Call::v1::Apps::DeleteNamespacedDeployment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::DeleteNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
