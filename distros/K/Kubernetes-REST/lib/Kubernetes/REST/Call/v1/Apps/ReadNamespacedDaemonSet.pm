package Kubernetes::REST::Call::v1::Apps::ReadNamespacedDaemonSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::ReadNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
