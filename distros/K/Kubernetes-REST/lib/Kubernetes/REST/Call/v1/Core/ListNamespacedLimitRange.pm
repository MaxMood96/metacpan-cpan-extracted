package Kubernetes::REST::Call::v1::Core::ListNamespacedLimitRange;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedLimitRange - Deprecated - use the new Kubernetes::REST API instead
