package Kubernetes::REST::Call::v1::Batch::PatchNamespacedJob;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Batch::PatchNamespacedJob - Deprecated - use the new Kubernetes::REST API instead
