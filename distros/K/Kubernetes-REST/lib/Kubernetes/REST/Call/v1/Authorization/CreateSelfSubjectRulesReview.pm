package Kubernetes::REST::Call::v1::Authorization::CreateSelfSubjectRulesReview;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Authorization::CreateSelfSubjectRulesReview - Deprecated - use the new Kubernetes::REST API instead
