package Kubernetes::REST::Call::v1::Core::CreateNamespacedResourceQuota;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedResourceQuota - Deprecated - use the new Kubernetes::REST API instead
