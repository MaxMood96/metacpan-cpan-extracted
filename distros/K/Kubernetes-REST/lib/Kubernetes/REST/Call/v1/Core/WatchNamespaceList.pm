package Kubernetes::REST::Call::v1::Core::WatchNamespaceList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespaceList - Deprecated - use the new Kubernetes::REST API instead
