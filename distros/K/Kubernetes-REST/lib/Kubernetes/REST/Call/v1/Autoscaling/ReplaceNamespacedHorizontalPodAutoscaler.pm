package Kubernetes::REST::Call::v1::Autoscaling::ReplaceNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Autoscaling::ReplaceNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
