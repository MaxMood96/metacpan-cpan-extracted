package Kubernetes::REST::Call::v1::Core::DeleteNamespacedLimitRange;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedLimitRange - Deprecated - use the new Kubernetes::REST API instead
