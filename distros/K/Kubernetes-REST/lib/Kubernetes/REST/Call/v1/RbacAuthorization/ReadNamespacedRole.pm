package Kubernetes::REST::Call::v1::RbacAuthorization::ReadNamespacedRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::RbacAuthorization::ReadNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
