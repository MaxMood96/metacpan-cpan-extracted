package Kubernetes::REST::Call::v1::Core::ReadNamespacedReplicationControllerStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedReplicationControllerStatus - Deprecated - use the new Kubernetes::REST API instead
