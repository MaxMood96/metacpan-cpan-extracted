package Kubernetes::REST::Call::v1::Storage::ReplaceStorageClass;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Storage::ReplaceStorageClass - Deprecated - use the new Kubernetes::REST API instead
