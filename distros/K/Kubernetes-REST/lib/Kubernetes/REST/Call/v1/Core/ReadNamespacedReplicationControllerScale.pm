package Kubernetes::REST::Call::v1::Core::ReadNamespacedReplicationControllerScale;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedReplicationControllerScale - Deprecated - use the new Kubernetes::REST API instead
