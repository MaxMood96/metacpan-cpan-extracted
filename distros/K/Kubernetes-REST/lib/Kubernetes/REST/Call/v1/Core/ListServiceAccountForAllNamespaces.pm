package Kubernetes::REST::Call::v1::Core::ListServiceAccountForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ListServiceAccountForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
