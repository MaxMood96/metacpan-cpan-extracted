package Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedStatefulSetStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedStatefulSetStatus - Deprecated - use the new Kubernetes::REST API instead
