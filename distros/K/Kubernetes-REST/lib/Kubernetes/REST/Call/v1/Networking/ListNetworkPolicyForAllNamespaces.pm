package Kubernetes::REST::Call::v1::Networking::ListNetworkPolicyForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Networking::ListNetworkPolicyForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
