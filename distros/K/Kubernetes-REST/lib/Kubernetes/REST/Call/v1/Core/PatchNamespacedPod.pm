package Kubernetes::REST::Call::v1::Core::PatchNamespacedPod;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedPod - Deprecated - use the new Kubernetes::REST API instead
