package Kubernetes::REST::Call::v1::Core::ReadNamespacedPersistentVolumeClaim;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedPersistentVolumeClaim - Deprecated - use the new Kubernetes::REST API instead
