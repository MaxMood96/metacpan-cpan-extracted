package Kubernetes::REST::Call::v1::Core::PatchNamespacedPodTemplate;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedPodTemplate - Deprecated - use the new Kubernetes::REST API instead
