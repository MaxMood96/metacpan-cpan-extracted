package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedConfigMap;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedConfigMap - Deprecated - use the new Kubernetes::REST API instead
