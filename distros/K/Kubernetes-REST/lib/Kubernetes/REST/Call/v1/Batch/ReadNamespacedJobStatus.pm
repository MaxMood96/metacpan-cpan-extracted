package Kubernetes::REST::Call::v1::Batch::ReadNamespacedJobStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Batch::ReadNamespacedJobStatus - Deprecated - use the new Kubernetes::REST API instead
