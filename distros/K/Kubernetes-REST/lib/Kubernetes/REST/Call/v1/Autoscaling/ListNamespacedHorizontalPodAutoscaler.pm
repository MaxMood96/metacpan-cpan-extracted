package Kubernetes::REST::Call::v1::Autoscaling::ListNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Autoscaling::ListNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
