package Kubernetes::REST::Call::v1::Core::WatchNamespacedResourceQuotaList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedResourceQuotaList - Deprecated - use the new Kubernetes::REST API instead
