package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPersistentVolumeClaim;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPersistentVolumeClaim - Deprecated - use the new Kubernetes::REST API instead
