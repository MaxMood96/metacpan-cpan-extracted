package Kubernetes::REST::Call::v1::Core::ListNamespacedPersistentVolumeClaim;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedPersistentVolumeClaim - Deprecated - use the new Kubernetes::REST API instead
