package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedServiceAccount;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedServiceAccount - Deprecated - use the new Kubernetes::REST API instead
