package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedEvent;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
