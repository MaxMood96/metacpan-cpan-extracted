package Kubernetes::REST::Call::v1::Core::CreateNamespacedReplicationController;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedReplicationController - Deprecated - use the new Kubernetes::REST API instead
