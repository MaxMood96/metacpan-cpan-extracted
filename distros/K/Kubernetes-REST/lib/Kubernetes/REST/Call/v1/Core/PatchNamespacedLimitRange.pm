package Kubernetes::REST::Call::v1::Core::PatchNamespacedLimitRange;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedLimitRange - Deprecated - use the new Kubernetes::REST API instead
