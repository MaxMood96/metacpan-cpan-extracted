package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedPersistentVolumeClaim;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedPersistentVolumeClaim - Deprecated - use the new Kubernetes::REST API instead
