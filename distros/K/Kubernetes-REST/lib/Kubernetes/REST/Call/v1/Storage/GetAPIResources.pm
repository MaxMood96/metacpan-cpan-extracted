package Kubernetes::REST::Call::v1::Storage::GetAPIResources;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Storage::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
