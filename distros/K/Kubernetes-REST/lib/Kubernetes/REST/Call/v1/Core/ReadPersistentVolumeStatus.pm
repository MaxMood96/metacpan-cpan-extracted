package Kubernetes::REST::Call::v1::Core::ReadPersistentVolumeStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReadPersistentVolumeStatus - Deprecated - use the new Kubernetes::REST API instead
