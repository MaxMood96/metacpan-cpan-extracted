package Kubernetes::REST::Call::v1::Core::ListNamespacedSecret;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedSecret - Deprecated - use the new Kubernetes::REST API instead
