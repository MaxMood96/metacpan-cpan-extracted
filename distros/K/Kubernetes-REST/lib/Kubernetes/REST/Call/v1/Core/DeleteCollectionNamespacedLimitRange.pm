package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedLimitRange;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedLimitRange - Deprecated - use the new Kubernetes::REST API instead
