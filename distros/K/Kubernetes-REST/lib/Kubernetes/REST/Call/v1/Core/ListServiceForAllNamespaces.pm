package Kubernetes::REST::Call::v1::Core::ListServiceForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ListServiceForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
