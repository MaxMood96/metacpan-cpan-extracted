package Kubernetes::REST::Call::v1::Core::PatchNamespacedService;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedService - Deprecated - use the new Kubernetes::REST API instead
