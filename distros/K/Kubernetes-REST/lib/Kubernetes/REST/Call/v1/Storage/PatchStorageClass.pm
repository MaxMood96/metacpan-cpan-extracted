package Kubernetes::REST::Call::v1::Storage::PatchStorageClass;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Storage::PatchStorageClass - Deprecated - use the new Kubernetes::REST API instead
