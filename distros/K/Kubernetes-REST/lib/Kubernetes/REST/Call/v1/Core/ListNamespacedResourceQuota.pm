package Kubernetes::REST::Call::v1::Core::ListNamespacedResourceQuota;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedResourceQuota - Deprecated - use the new Kubernetes::REST API instead
