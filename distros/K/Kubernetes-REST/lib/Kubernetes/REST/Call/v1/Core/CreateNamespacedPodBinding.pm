package Kubernetes::REST::Call::v1::Core::CreateNamespacedPodBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedPodBinding - Deprecated - use the new Kubernetes::REST API instead
