package Kubernetes::REST::Call::v1::Core::CreateNamespacedServiceAccount;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedServiceAccount - Deprecated - use the new Kubernetes::REST API instead
