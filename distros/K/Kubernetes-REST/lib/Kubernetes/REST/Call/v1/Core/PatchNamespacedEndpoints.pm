package Kubernetes::REST::Call::v1::Core::PatchNamespacedEndpoints;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedEndpoints - Deprecated - use the new Kubernetes::REST API instead
