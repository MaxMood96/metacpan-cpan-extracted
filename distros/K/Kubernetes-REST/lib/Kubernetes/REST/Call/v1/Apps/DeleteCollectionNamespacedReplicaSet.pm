package Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
