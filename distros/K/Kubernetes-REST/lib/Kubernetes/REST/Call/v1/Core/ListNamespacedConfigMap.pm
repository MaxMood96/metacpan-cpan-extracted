package Kubernetes::REST::Call::v1::Core::ListNamespacedConfigMap;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedConfigMap - Deprecated - use the new Kubernetes::REST API instead
