package Kubernetes::REST::Call::v1::Apps::WatchNamespacedControllerRevisionList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::WatchNamespacedControllerRevisionList - Deprecated - use the new Kubernetes::REST API instead
