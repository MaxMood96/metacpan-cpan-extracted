package Kubernetes::REST::Call::v1::Core::ConnectPatchNamespacedPodProxyWithPath;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectPatchNamespacedPodProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
