package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedPod;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedPod - Deprecated - use the new Kubernetes::REST API instead
