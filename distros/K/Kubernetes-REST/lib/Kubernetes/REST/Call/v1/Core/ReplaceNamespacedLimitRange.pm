package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedLimitRange;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedLimitRange - Deprecated - use the new Kubernetes::REST API instead
