package Kubernetes::REST::Call::v1::Batch::ReplaceNamespacedJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Batch::ReplaceNamespacedJob - Deprecated - use the new Kubernetes::REST API instead
