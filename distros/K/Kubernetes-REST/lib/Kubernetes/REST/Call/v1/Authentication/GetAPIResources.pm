package Kubernetes::REST::Call::v1::Authentication::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Authentication::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
