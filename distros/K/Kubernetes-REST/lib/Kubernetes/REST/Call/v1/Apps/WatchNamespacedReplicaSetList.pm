package Kubernetes::REST::Call::v1::Apps::WatchNamespacedReplicaSetList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::WatchNamespacedReplicaSetList - Deprecated - use the new Kubernetes::REST API instead
