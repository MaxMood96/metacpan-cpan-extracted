package Kubernetes::REST::Call::v1::Core::ConnectGetNamespacedServiceProxy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectGetNamespacedServiceProxy - Deprecated - use the new Kubernetes::REST API instead
