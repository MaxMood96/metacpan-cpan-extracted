package Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedPodProxy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedPodProxy - Deprecated - use the new Kubernetes::REST API instead
