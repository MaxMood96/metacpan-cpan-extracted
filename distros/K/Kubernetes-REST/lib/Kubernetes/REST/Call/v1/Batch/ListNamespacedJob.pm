package Kubernetes::REST::Call::v1::Batch::ListNamespacedJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Batch::ListNamespacedJob - Deprecated - use the new Kubernetes::REST API instead
