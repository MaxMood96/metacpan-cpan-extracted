package Kubernetes::REST::Call::v1::Core::PatchNamespacedPersistentVolumeClaimStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedPersistentVolumeClaimStatus - Deprecated - use the new Kubernetes::REST API instead
