package Kubernetes::REST::Call::v1::Apps::DeleteNamespacedStatefulSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::DeleteNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
