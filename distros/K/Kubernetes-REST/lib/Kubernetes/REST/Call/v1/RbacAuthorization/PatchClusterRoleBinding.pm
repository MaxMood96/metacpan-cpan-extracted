package Kubernetes::REST::Call::v1::RbacAuthorization::PatchClusterRoleBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::RbacAuthorization::PatchClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
