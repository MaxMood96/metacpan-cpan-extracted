package Kubernetes::REST::Call::v1::Core::WatchNamespacedServiceList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedServiceList - Deprecated - use the new Kubernetes::REST API instead
