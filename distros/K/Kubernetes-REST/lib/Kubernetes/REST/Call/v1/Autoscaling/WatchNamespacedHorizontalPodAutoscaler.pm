package Kubernetes::REST::Call::v1::Autoscaling::WatchNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Autoscaling::WatchNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
