package Kubernetes::REST::Call::v1::Apiregistration::WatchAPIServiceList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apiregistration::WatchAPIServiceList - Deprecated - use the new Kubernetes::REST API instead
