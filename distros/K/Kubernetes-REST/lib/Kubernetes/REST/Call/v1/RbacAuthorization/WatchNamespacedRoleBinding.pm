package Kubernetes::REST::Call::v1::RbacAuthorization::WatchNamespacedRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::RbacAuthorization::WatchNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
