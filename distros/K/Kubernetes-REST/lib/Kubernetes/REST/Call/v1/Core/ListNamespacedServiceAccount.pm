package Kubernetes::REST::Call::v1::Core::ListNamespacedServiceAccount;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedServiceAccount - Deprecated - use the new Kubernetes::REST API instead
