package Kubernetes::REST::Call::v1::Core::ConnectOptionsNamespacedServiceProxyWithPath;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectOptionsNamespacedServiceProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
