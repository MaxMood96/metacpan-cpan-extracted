package Kubernetes::REST::Call::v1::RbacAuthorization::DeleteNamespacedRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::RbacAuthorization::DeleteNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
