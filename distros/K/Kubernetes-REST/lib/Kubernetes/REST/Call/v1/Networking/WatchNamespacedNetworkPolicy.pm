package Kubernetes::REST::Call::v1::Networking::WatchNamespacedNetworkPolicy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Networking::WatchNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
