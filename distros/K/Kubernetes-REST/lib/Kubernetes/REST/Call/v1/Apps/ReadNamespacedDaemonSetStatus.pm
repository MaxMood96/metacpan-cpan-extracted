package Kubernetes::REST::Call::v1::Apps::ReadNamespacedDaemonSetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::ReadNamespacedDaemonSetStatus - Deprecated - use the new Kubernetes::REST API instead
