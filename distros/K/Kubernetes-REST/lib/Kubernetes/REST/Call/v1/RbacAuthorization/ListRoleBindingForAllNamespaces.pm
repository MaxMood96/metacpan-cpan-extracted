package Kubernetes::REST::Call::v1::RbacAuthorization::ListRoleBindingForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::ListRoleBindingForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
