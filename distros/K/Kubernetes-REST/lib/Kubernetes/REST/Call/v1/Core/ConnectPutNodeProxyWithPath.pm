package Kubernetes::REST::Call::v1::Core::ConnectPutNodeProxyWithPath;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectPutNodeProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
