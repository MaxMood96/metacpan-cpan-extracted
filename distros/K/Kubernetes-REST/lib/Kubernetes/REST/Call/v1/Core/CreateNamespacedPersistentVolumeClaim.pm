package Kubernetes::REST::Call::v1::Core::CreateNamespacedPersistentVolumeClaim;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedPersistentVolumeClaim - Deprecated - use the new Kubernetes::REST API instead
