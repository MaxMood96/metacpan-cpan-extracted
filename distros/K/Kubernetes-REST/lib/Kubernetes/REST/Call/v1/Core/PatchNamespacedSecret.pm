package Kubernetes::REST::Call::v1::Core::PatchNamespacedSecret;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedSecret - Deprecated - use the new Kubernetes::REST API instead
