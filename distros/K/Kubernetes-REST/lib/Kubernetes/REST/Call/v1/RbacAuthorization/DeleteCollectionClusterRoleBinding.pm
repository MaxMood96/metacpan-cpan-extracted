package Kubernetes::REST::Call::v1::RbacAuthorization::DeleteCollectionClusterRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::RbacAuthorization::DeleteCollectionClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
