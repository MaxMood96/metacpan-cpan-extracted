package Kubernetes::REST::Call::v1::Apps::PatchNamespacedStatefulSetScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedStatefulSetScale - Deprecated - use the new Kubernetes::REST API instead
