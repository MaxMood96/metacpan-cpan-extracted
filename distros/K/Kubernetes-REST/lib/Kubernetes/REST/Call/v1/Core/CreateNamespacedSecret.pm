package Kubernetes::REST::Call::v1::Core::CreateNamespacedSecret;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedSecret - Deprecated - use the new Kubernetes::REST API instead
