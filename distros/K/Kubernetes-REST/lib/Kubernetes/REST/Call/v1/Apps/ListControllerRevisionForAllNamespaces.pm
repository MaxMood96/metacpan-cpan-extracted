package Kubernetes::REST::Call::v1::Apps::ListControllerRevisionForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::ListControllerRevisionForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
