package Kubernetes::REST::Call::v1::Core::WatchNamespacedPodTemplate;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedPodTemplate - Deprecated - use the new Kubernetes::REST API instead
