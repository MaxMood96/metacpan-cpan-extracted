package Kubernetes::REST::Call::v1::Core::PatchPersistentVolumeStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::PatchPersistentVolumeStatus - Deprecated - use the new Kubernetes::REST API instead
