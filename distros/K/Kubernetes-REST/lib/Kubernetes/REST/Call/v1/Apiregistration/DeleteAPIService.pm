package Kubernetes::REST::Call::v1::Apiregistration::DeleteAPIService;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apiregistration::DeleteAPIService - Deprecated - use the new Kubernetes::REST API instead
