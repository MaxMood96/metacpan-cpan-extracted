package Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedControllerRevision;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
