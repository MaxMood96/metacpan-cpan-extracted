package Kubernetes::REST::Call::v1::Apiregistration::PatchAPIServiceStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apiregistration::PatchAPIServiceStatus - Deprecated - use the new Kubernetes::REST API instead
