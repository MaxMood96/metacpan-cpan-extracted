package Kubernetes::REST::Call::v1::Apps::ListNamespacedStatefulSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ListNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
