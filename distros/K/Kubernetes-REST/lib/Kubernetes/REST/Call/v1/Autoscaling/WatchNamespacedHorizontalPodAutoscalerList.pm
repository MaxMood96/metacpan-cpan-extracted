package Kubernetes::REST::Call::v1::Autoscaling::WatchNamespacedHorizontalPodAutoscalerList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Autoscaling::WatchNamespacedHorizontalPodAutoscalerList - Deprecated - use the new Kubernetes::REST API instead
