package Kubernetes::REST::Call::v1::Core::ConnectHeadNamespacedPodProxyWithPath;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectHeadNamespacedPodProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
