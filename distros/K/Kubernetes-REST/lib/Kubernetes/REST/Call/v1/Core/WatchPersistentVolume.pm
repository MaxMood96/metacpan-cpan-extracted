package Kubernetes::REST::Call::v1::Core::WatchPersistentVolume;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchPersistentVolume - Deprecated - use the new Kubernetes::REST API instead
