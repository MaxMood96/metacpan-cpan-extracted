package Kubernetes::REST::Call::v1::Batch::DeleteNamespacedJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Batch::DeleteNamespacedJob - Deprecated - use the new Kubernetes::REST API instead
