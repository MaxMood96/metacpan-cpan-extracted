package Kubernetes::REST::Call::v1::Core::ConnectGetNamespacedPodProxyWithPath;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectGetNamespacedPodProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
