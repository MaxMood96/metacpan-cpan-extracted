package Kubernetes::REST::Call::v1::Apps::CreateNamespacedDaemonSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::CreateNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
