package Kubernetes::REST::Call::v1::Core::ListComponentStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ListComponentStatus - Deprecated - use the new Kubernetes::REST API instead
