package Kubernetes::REST::Call::v1::Core::ListNamespacedPodTemplate;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedPodTemplate - Deprecated - use the new Kubernetes::REST API instead
