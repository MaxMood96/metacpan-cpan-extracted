package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedResourceQuotaStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedResourceQuotaStatus - Deprecated - use the new Kubernetes::REST API instead
