package Kubernetes::REST::Call::v1::Core::WatchNamespacedReplicationControllerList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedReplicationControllerList - Deprecated - use the new Kubernetes::REST API instead
