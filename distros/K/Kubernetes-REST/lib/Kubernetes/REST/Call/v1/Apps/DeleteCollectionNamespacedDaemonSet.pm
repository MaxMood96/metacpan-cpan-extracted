package Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedDaemonSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
