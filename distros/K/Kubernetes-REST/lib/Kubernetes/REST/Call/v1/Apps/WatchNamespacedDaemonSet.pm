package Kubernetes::REST::Call::v1::Apps::WatchNamespacedDaemonSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::WatchNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
