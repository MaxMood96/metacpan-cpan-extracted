package Kubernetes::REST::Call::v1::Core::DeleteNamespacedServiceAccount;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedServiceAccount - Deprecated - use the new Kubernetes::REST API instead
