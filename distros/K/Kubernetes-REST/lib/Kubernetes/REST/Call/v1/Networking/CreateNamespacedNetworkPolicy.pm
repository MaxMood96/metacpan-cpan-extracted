package Kubernetes::REST::Call::v1::Networking::CreateNamespacedNetworkPolicy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Networking::CreateNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
