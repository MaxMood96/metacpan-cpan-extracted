package Kubernetes::REST::Call::v1::RbacAuthorization::ReplaceNamespacedRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::RbacAuthorization::ReplaceNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
