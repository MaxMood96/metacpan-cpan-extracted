package Kubernetes::REST::Call::v1::Apps::CreateNamespacedControllerRevision;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::CreateNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
