package Kubernetes::REST::Call::v1::Core::ReplacePersistentVolumeStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReplacePersistentVolumeStatus - Deprecated - use the new Kubernetes::REST API instead
