package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedEndpoints;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedEndpoints - Deprecated - use the new Kubernetes::REST API instead
