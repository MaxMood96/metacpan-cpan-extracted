package Kubernetes::REST::Call::v1::Core::DeleteNamespacedReplicationController;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedReplicationController - Deprecated - use the new Kubernetes::REST API instead
