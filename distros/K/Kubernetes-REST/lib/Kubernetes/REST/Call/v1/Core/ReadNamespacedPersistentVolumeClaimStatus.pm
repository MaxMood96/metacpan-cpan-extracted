package Kubernetes::REST::Call::v1::Core::ReadNamespacedPersistentVolumeClaimStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedPersistentVolumeClaimStatus - Deprecated - use the new Kubernetes::REST API instead
