package Kubernetes::REST::Call::v1::Apps::ReadNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::ReadNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
