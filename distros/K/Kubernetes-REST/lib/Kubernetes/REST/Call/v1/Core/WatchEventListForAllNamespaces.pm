package Kubernetes::REST::Call::v1::Core::WatchEventListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchEventListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
