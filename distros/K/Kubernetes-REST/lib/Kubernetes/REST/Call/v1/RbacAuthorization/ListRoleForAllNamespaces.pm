package Kubernetes::REST::Call::v1::RbacAuthorization::ListRoleForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::ListRoleForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
