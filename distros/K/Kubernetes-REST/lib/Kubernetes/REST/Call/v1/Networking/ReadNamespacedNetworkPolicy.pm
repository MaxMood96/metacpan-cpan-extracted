package Kubernetes::REST::Call::v1::Networking::ReadNamespacedNetworkPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Networking::ReadNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
