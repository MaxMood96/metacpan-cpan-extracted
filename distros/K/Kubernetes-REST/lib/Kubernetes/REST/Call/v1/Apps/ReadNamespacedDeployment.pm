package Kubernetes::REST::Call::v1::Apps::ReadNamespacedDeployment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::ReadNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
