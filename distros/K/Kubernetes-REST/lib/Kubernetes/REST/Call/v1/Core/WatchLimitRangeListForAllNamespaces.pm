package Kubernetes::REST::Call::v1::Core::WatchLimitRangeListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchLimitRangeListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
