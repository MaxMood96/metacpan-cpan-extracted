package Kubernetes::REST::Call::v1::Networking::ReplaceNamespacedNetworkPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Networking::ReplaceNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
