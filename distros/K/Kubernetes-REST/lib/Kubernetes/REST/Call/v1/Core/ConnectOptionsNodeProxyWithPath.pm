package Kubernetes::REST::Call::v1::Core::ConnectOptionsNodeProxyWithPath;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ConnectOptionsNodeProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
