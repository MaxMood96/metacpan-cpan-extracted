package Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedStatefulSetScale;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedStatefulSetScale - Deprecated - use the new Kubernetes::REST API instead
