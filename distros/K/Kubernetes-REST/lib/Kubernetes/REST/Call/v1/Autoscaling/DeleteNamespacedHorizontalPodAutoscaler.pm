package Kubernetes::REST::Call::v1::Autoscaling::DeleteNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Autoscaling::DeleteNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
