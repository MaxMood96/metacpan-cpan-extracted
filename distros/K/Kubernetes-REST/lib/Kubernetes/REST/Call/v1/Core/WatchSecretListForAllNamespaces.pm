package Kubernetes::REST::Call::v1::Core::WatchSecretListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchSecretListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
