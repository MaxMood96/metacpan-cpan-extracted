package Kubernetes::REST::Call::v1::Core::WatchNamespacedSecret;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedSecret - Deprecated - use the new Kubernetes::REST API instead
