package Kubernetes::REST::Call::v1::Apps::WatchReplicaSetListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::WatchReplicaSetListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
