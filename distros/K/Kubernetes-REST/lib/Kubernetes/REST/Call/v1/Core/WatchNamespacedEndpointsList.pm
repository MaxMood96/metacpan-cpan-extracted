package Kubernetes::REST::Call::v1::Core::WatchNamespacedEndpointsList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedEndpointsList - Deprecated - use the new Kubernetes::REST API instead
