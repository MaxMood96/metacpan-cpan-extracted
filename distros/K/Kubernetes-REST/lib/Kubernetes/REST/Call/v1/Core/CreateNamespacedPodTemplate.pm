package Kubernetes::REST::Call::v1::Core::CreateNamespacedPodTemplate;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedPodTemplate - Deprecated - use the new Kubernetes::REST API instead
