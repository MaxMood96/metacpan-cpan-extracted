package Kubernetes::REST::Call::v1::Core::WatchNamespacedLimitRange;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedLimitRange - Deprecated - use the new Kubernetes::REST API instead
