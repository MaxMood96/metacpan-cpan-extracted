package Kubernetes::REST::Call::v1::Core::DeleteNamespacedEndpoints;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedEndpoints - Deprecated - use the new Kubernetes::REST API instead
