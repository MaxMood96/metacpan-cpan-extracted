package Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedStatefulSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
