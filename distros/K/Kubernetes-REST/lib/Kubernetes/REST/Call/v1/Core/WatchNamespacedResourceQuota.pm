package Kubernetes::REST::Call::v1::Core::WatchNamespacedResourceQuota;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedResourceQuota - Deprecated - use the new Kubernetes::REST API instead
