package Kubernetes::REST::Call::v1::Autoscaling::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Autoscaling::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
