package Kubernetes::REST::Call::v1::Core::PatchNamespacedReplicationControllerStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedReplicationControllerStatus - Deprecated - use the new Kubernetes::REST API instead
