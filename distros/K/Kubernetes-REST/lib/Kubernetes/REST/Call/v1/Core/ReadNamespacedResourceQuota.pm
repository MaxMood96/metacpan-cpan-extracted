package Kubernetes::REST::Call::v1::Core::ReadNamespacedResourceQuota;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedResourceQuota - Deprecated - use the new Kubernetes::REST API instead
