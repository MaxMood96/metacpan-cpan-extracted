package Kubernetes::REST::Call::v1::Apps::WatchControllerRevisionListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::WatchControllerRevisionListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
