package Kubernetes::REST::Call::v1::Apps::ListStatefulSetForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ListStatefulSetForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
