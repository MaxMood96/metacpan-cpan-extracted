package Kubernetes::REST::Call::v1::Core::WatchNamespacedReplicationController;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedReplicationController - Deprecated - use the new Kubernetes::REST API instead
