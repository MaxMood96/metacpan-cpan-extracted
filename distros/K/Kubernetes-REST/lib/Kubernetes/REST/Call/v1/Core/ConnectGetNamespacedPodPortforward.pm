package Kubernetes::REST::Call::v1::Core::ConnectGetNamespacedPodPortforward;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ConnectGetNamespacedPodPortforward - Deprecated - use the new Kubernetes::REST API instead
