package Kubernetes::REST::Call::v1::Apps::ListNamespacedReplicaSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ListNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
