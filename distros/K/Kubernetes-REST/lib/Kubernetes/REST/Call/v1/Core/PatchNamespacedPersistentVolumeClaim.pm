package Kubernetes::REST::Call::v1::Core::PatchNamespacedPersistentVolumeClaim;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedPersistentVolumeClaim - Deprecated - use the new Kubernetes::REST API instead
