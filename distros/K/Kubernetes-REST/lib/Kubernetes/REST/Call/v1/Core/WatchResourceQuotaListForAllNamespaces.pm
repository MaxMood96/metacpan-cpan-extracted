package Kubernetes::REST::Call::v1::Core::WatchResourceQuotaListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchResourceQuotaListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
