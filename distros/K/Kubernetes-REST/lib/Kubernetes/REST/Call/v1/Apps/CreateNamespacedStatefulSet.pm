package Kubernetes::REST::Call::v1::Apps::CreateNamespacedStatefulSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::CreateNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
