package Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedControllerRevision;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
