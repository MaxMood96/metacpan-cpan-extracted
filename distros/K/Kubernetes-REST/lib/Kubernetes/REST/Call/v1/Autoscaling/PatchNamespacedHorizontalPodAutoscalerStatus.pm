package Kubernetes::REST::Call::v1::Autoscaling::PatchNamespacedHorizontalPodAutoscalerStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Autoscaling::PatchNamespacedHorizontalPodAutoscalerStatus - Deprecated - use the new Kubernetes::REST API instead
