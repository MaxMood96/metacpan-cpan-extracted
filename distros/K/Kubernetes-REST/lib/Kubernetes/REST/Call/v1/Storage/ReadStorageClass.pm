package Kubernetes::REST::Call::v1::Storage::ReadStorageClass;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Storage::ReadStorageClass - Deprecated - use the new Kubernetes::REST API instead
