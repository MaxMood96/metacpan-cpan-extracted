package Kubernetes::REST::Call::v1::Core::ConnectPostNodeProxyWithPath;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectPostNodeProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
