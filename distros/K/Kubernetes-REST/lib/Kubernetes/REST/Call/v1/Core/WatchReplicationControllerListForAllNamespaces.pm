package Kubernetes::REST::Call::v1::Core::WatchReplicationControllerListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchReplicationControllerListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
