package Kubernetes::REST::Call::v1::Apps::ListNamespacedDaemonSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ListNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
