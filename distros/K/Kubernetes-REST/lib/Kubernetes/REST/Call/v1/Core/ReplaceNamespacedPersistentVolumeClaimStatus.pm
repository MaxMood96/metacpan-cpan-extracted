package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPersistentVolumeClaimStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPersistentVolumeClaimStatus - Deprecated - use the new Kubernetes::REST API instead
