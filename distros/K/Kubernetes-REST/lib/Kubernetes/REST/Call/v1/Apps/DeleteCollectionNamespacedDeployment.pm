package Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedDeployment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::DeleteCollectionNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
