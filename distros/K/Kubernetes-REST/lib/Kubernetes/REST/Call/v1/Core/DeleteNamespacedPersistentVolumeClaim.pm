package Kubernetes::REST::Call::v1::Core::DeleteNamespacedPersistentVolumeClaim;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedPersistentVolumeClaim - Deprecated - use the new Kubernetes::REST API instead
