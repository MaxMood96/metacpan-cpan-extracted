package Kubernetes::REST::Call::v1::Apiregistration::GetAPIResources;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apiregistration::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
