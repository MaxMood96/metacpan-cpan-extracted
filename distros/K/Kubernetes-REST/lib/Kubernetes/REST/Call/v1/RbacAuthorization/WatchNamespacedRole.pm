package Kubernetes::REST::Call::v1::RbacAuthorization::WatchNamespacedRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::RbacAuthorization::WatchNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
