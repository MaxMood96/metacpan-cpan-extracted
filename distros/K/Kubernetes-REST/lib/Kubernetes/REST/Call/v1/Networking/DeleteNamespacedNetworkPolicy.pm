package Kubernetes::REST::Call::v1::Networking::DeleteNamespacedNetworkPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Networking::DeleteNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
