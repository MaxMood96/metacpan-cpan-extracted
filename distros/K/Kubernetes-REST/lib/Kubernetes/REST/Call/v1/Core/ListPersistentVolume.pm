package Kubernetes::REST::Call::v1::Core::ListPersistentVolume;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ListPersistentVolume - Deprecated - use the new Kubernetes::REST API instead
