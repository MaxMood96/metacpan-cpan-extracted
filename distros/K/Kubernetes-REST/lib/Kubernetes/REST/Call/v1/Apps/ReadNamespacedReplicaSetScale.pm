package Kubernetes::REST::Call::v1::Apps::ReadNamespacedReplicaSetScale;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ReadNamespacedReplicaSetScale - Deprecated - use the new Kubernetes::REST API instead
