package Kubernetes::REST::Call::v1::Core::PatchNamespacedResourceQuota;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedResourceQuota - Deprecated - use the new Kubernetes::REST API instead
