package Kubernetes::REST::Call::v1::Batch::PatchNamespacedJobStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Batch::PatchNamespacedJobStatus - Deprecated - use the new Kubernetes::REST API instead
