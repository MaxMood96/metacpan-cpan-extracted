package Kubernetes::REST::Call::v1::Core::PatchNamespaceStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::PatchNamespaceStatus - Deprecated - use the new Kubernetes::REST API instead
