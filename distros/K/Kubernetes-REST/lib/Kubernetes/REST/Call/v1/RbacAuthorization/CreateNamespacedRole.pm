package Kubernetes::REST::Call::v1::RbacAuthorization::CreateNamespacedRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::RbacAuthorization::CreateNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
