package Kubernetes::REST::Call::v1::RbacAuthorization::ReplaceClusterRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::ReplaceClusterRole - Deprecated - use the new Kubernetes::REST API instead
