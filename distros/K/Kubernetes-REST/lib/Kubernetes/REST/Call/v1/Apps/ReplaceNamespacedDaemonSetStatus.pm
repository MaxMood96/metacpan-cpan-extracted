package Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedDaemonSetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedDaemonSetStatus - Deprecated - use the new Kubernetes::REST API instead
