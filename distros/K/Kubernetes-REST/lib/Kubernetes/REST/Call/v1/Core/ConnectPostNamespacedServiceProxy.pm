package Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedServiceProxy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedServiceProxy - Deprecated - use the new Kubernetes::REST API instead
