package Kubernetes::REST::Call::v1::Core::ListPodTemplateForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ListPodTemplateForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
