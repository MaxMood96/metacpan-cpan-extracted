package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedReplicationController;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedReplicationController - Deprecated - use the new Kubernetes::REST API instead
