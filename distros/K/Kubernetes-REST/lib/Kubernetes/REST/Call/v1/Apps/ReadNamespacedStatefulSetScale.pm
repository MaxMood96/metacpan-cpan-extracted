package Kubernetes::REST::Call::v1::Apps::ReadNamespacedStatefulSetScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::ReadNamespacedStatefulSetScale - Deprecated - use the new Kubernetes::REST API instead
