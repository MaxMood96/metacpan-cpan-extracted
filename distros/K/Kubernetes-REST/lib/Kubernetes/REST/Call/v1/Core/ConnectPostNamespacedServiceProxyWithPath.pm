package Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedServiceProxyWithPath;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedServiceProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
