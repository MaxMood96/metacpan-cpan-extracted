package Kubernetes::REST::Call::v1::Networking::ListNamespacedNetworkPolicy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Networking::ListNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
