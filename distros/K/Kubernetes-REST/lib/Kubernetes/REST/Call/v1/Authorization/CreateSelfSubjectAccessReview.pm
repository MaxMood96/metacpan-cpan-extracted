package Kubernetes::REST::Call::v1::Authorization::CreateSelfSubjectAccessReview;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Authorization::CreateSelfSubjectAccessReview - Deprecated - use the new Kubernetes::REST API instead
