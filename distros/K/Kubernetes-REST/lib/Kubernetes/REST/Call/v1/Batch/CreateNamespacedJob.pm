package Kubernetes::REST::Call::v1::Batch::CreateNamespacedJob;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Batch::CreateNamespacedJob - Deprecated - use the new Kubernetes::REST API instead
