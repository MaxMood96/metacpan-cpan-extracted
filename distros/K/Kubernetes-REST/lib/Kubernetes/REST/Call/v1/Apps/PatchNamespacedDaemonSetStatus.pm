package Kubernetes::REST::Call::v1::Apps::PatchNamespacedDaemonSetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedDaemonSetStatus - Deprecated - use the new Kubernetes::REST API instead
