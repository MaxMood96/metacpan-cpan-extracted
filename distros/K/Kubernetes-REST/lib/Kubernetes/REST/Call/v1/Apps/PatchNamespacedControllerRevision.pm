package Kubernetes::REST::Call::v1::Apps::PatchNamespacedControllerRevision;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
