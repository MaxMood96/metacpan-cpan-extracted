package Kubernetes::REST::Call::v1::Core::DeleteNamespacedResourceQuota;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedResourceQuota - Deprecated - use the new Kubernetes::REST API instead
