package Kubernetes::REST::Call::v1::Batch::WatchJobListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Batch::WatchJobListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
