package Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedReplicaSetScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedReplicaSetScale - Deprecated - use the new Kubernetes::REST API instead
