package Kubernetes::REST::Call::v1::RbacAuthorization::WatchRoleBindingListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::RbacAuthorization::WatchRoleBindingListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
