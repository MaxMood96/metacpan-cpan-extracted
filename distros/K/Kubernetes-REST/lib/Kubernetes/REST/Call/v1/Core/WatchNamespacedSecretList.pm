package Kubernetes::REST::Call::v1::Core::WatchNamespacedSecretList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedSecretList - Deprecated - use the new Kubernetes::REST API instead
