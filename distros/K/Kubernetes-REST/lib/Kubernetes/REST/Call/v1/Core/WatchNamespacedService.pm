package Kubernetes::REST::Call::v1::Core::WatchNamespacedService;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedService - Deprecated - use the new Kubernetes::REST API instead
