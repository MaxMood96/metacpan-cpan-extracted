package Kubernetes::REST::Call::v1::Core::ConnectDeleteNamespacedPodProxy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectDeleteNamespacedPodProxy - Deprecated - use the new Kubernetes::REST API instead
