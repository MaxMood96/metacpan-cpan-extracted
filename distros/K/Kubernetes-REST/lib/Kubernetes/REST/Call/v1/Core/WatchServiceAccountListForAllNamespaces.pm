package Kubernetes::REST::Call::v1::Core::WatchServiceAccountListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchServiceAccountListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
