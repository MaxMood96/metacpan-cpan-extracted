package Kubernetes::REST::Call::v1::Core::ListNamespacedService;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedService - Deprecated - use the new Kubernetes::REST API instead
