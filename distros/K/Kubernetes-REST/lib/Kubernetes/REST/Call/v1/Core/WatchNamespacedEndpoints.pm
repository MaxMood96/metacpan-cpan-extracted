package Kubernetes::REST::Call::v1::Core::WatchNamespacedEndpoints;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedEndpoints - Deprecated - use the new Kubernetes::REST API instead
