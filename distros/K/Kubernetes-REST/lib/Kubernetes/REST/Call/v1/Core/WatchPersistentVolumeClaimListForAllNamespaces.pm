package Kubernetes::REST::Call::v1::Core::WatchPersistentVolumeClaimListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchPersistentVolumeClaimListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
