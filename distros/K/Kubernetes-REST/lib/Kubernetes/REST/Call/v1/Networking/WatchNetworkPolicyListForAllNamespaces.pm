package Kubernetes::REST::Call::v1::Networking::WatchNetworkPolicyListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Networking::WatchNetworkPolicyListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
