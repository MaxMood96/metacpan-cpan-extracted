package Kubernetes::REST::Call::v1::Apps::ReadNamespacedStatefulSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::ReadNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
