package Kubernetes::REST::Call::v1::Batch::DeleteCollectionNamespacedJob;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Batch::DeleteCollectionNamespacedJob - Deprecated - use the new Kubernetes::REST API instead
