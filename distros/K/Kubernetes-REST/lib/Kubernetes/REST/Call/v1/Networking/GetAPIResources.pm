package Kubernetes::REST::Call::v1::Networking::GetAPIResources;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Networking::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
