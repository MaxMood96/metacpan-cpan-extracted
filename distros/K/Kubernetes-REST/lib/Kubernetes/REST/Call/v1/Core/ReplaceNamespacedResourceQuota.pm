package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedResourceQuota;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedResourceQuota - Deprecated - use the new Kubernetes::REST API instead
