package Kubernetes::REST::Call::v1::Core::PatchNamespacedReplicationControllerScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedReplicationControllerScale - Deprecated - use the new Kubernetes::REST API instead
