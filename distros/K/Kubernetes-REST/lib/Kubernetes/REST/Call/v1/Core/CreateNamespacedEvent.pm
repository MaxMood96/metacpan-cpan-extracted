package Kubernetes::REST::Call::v1::Core::CreateNamespacedEvent;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
