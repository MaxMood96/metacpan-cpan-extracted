package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedReplicationControllerScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedReplicationControllerScale - Deprecated - use the new Kubernetes::REST API instead
