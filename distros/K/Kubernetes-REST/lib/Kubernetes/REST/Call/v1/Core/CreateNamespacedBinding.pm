package Kubernetes::REST::Call::v1::Core::CreateNamespacedBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedBinding - Deprecated - use the new Kubernetes::REST API instead
