package Kubernetes::REST::Call::v1::Apiregistration::DeleteCollectionAPIService;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apiregistration::DeleteCollectionAPIService - Deprecated - use the new Kubernetes::REST API instead
