package Kubernetes::REST::Call::v1::Core::ConnectOptionsNamespacedPodProxy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectOptionsNamespacedPodProxy - Deprecated - use the new Kubernetes::REST API instead
