package Kubernetes::REST::Call::v1::Core::ReadNamespacedReplicationController;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedReplicationController - Deprecated - use the new Kubernetes::REST API instead
