package Kubernetes::REST::Call::v1::Core::ReplaceNamespaceFinalize;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespaceFinalize - Deprecated - use the new Kubernetes::REST API instead
