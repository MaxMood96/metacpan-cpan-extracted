package Kubernetes::REST::Call::v1::Core::WatchServiceListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchServiceListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
