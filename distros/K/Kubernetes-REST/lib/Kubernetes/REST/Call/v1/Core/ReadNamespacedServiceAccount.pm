package Kubernetes::REST::Call::v1::Core::ReadNamespacedServiceAccount;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedServiceAccount - Deprecated - use the new Kubernetes::REST API instead
