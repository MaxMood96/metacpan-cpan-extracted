package Kubernetes::REST::Call::v1::Core::ReadNamespacedEndpoints;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedEndpoints - Deprecated - use the new Kubernetes::REST API instead
