package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedSecret;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedSecret - Deprecated - use the new Kubernetes::REST API instead
