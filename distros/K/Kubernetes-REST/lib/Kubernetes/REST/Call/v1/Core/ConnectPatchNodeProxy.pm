package Kubernetes::REST::Call::v1::Core::ConnectPatchNodeProxy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ConnectPatchNodeProxy - Deprecated - use the new Kubernetes::REST API instead
