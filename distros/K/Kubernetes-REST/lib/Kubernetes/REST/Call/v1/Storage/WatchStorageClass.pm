package Kubernetes::REST::Call::v1::Storage::WatchStorageClass;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Storage::WatchStorageClass - Deprecated - use the new Kubernetes::REST API instead
