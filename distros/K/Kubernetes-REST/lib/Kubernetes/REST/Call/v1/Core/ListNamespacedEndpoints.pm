package Kubernetes::REST::Call::v1::Core::ListNamespacedEndpoints;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedEndpoints - Deprecated - use the new Kubernetes::REST API instead
