package Kubernetes::REST::Call::v1::Core::ListResourceQuotaForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ListResourceQuotaForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
