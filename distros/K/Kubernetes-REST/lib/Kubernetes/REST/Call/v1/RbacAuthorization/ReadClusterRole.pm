package Kubernetes::REST::Call::v1::RbacAuthorization::ReadClusterRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::ReadClusterRole - Deprecated - use the new Kubernetes::REST API instead
