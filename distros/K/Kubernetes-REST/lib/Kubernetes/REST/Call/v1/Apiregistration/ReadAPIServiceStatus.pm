package Kubernetes::REST::Call::v1::Apiregistration::ReadAPIServiceStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apiregistration::ReadAPIServiceStatus - Deprecated - use the new Kubernetes::REST API instead
