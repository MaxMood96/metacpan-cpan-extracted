package Kubernetes::REST::Call::v1::Core::ListPodForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ListPodForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
