package Kubernetes::REST::Call::v1::Core::WatchNamespacedConfigMap;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedConfigMap - Deprecated - use the new Kubernetes::REST API instead
