package Kubernetes::REST::Call::v1::Core::PatchNamespacedPodStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedPodStatus - Deprecated - use the new Kubernetes::REST API instead
