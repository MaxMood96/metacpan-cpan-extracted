package Kubernetes::REST::Call::v1::Core::ConnectDeleteNamespacedServiceProxyWithPath;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectDeleteNamespacedServiceProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
