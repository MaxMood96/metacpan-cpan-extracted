package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedReplicationController;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedReplicationController - Deprecated - use the new Kubernetes::REST API instead
