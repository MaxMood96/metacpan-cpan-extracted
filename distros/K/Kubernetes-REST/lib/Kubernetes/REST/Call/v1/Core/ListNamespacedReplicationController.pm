package Kubernetes::REST::Call::v1::Core::ListNamespacedReplicationController;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedReplicationController - Deprecated - use the new Kubernetes::REST API instead
