package Kubernetes::REST::Call::v1::Batch::WatchNamespacedJob;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Batch::WatchNamespacedJob - Deprecated - use the new Kubernetes::REST API instead
