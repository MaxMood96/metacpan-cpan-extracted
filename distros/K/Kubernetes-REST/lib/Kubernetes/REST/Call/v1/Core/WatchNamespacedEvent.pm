package Kubernetes::REST::Call::v1::Core::WatchNamespacedEvent;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
