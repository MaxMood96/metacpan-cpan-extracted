package Kubernetes::REST::Call::v1::Apiregistration::ReplaceAPIService;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apiregistration::ReplaceAPIService - Deprecated - use the new Kubernetes::REST API instead
