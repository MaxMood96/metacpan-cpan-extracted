package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedSecret;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedSecret - Deprecated - use the new Kubernetes::REST API instead
