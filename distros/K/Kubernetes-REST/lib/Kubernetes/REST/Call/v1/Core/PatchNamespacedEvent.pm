package Kubernetes::REST::Call::v1::Core::PatchNamespacedEvent;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
