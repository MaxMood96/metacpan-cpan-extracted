package Kubernetes::REST::Call::v1::Core::ConnectPutNamespacedPodProxyWithPath;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectPutNamespacedPodProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
