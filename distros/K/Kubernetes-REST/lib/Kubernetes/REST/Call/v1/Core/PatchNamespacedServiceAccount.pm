package Kubernetes::REST::Call::v1::Core::PatchNamespacedServiceAccount;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedServiceAccount - Deprecated - use the new Kubernetes::REST API instead
