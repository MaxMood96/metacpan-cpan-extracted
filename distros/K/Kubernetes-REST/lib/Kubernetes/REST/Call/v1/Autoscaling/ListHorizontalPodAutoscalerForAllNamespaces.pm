package Kubernetes::REST::Call::v1::Autoscaling::ListHorizontalPodAutoscalerForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Autoscaling::ListHorizontalPodAutoscalerForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
