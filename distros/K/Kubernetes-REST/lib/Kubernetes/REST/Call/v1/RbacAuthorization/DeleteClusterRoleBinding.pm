package Kubernetes::REST::Call::v1::RbacAuthorization::DeleteClusterRoleBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::RbacAuthorization::DeleteClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
