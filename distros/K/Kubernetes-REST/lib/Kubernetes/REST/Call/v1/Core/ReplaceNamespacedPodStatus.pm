package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPodStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPodStatus - Deprecated - use the new Kubernetes::REST API instead
