package Kubernetes::REST::Call::v1::RbacAuthorization::WatchClusterRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::RbacAuthorization::WatchClusterRole - Deprecated - use the new Kubernetes::REST API instead
