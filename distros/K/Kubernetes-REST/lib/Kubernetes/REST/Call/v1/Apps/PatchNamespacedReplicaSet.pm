package Kubernetes::REST::Call::v1::Apps::PatchNamespacedReplicaSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
