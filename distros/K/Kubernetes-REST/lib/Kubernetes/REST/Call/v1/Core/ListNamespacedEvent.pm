package Kubernetes::REST::Call::v1::Core::ListNamespacedEvent;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ListNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
