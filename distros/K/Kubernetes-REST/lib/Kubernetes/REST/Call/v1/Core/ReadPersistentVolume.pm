package Kubernetes::REST::Call::v1::Core::ReadPersistentVolume;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReadPersistentVolume - Deprecated - use the new Kubernetes::REST API instead
