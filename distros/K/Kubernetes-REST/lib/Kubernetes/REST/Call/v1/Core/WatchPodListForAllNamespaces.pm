package Kubernetes::REST::Call::v1::Core::WatchPodListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchPodListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
