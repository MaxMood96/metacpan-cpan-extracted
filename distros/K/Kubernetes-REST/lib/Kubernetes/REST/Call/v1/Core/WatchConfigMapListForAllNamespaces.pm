package Kubernetes::REST::Call::v1::Core::WatchConfigMapListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchConfigMapListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
