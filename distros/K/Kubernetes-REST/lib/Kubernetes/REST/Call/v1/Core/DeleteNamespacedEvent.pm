package Kubernetes::REST::Call::v1::Core::DeleteNamespacedEvent;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
