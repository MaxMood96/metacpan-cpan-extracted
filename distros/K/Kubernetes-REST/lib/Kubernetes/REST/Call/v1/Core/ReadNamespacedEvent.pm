package Kubernetes::REST::Call::v1::Core::ReadNamespacedEvent;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
