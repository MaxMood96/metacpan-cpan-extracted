package Kubernetes::REST::Call::v1::Core::WatchNamespacedPodTemplateList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedPodTemplateList - Deprecated - use the new Kubernetes::REST API instead
