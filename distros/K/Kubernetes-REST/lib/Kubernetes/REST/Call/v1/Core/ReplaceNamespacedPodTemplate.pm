package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPodTemplate;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedPodTemplate - Deprecated - use the new Kubernetes::REST API instead
