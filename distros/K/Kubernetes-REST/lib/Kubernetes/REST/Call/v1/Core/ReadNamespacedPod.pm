package Kubernetes::REST::Call::v1::Core::ReadNamespacedPod;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedPod - Deprecated - use the new Kubernetes::REST API instead
