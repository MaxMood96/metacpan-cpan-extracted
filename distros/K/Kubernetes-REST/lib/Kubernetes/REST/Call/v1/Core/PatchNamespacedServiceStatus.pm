package Kubernetes::REST::Call::v1::Core::PatchNamespacedServiceStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedServiceStatus - Deprecated - use the new Kubernetes::REST API instead
