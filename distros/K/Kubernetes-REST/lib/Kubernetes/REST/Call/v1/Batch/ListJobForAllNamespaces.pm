package Kubernetes::REST::Call::v1::Batch::ListJobForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Batch::ListJobForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
