package Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedPodProxyWithPath;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedPodProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
