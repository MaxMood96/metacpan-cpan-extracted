package Kubernetes::REST::Call::v1::Core::CreatePersistentVolume;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::CreatePersistentVolume - Deprecated - use the new Kubernetes::REST API instead
