package Kubernetes::REST::Call::v1::Core::ConnectDeleteNamespacedServiceProxy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectDeleteNamespacedServiceProxy - Deprecated - use the new Kubernetes::REST API instead
