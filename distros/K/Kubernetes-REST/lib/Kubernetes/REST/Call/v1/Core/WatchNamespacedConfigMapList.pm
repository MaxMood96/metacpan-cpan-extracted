package Kubernetes::REST::Call::v1::Core::WatchNamespacedConfigMapList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedConfigMapList - Deprecated - use the new Kubernetes::REST API instead
