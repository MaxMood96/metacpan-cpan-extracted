package Kubernetes::REST::Call::v1::Apps::DeleteNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::DeleteNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
