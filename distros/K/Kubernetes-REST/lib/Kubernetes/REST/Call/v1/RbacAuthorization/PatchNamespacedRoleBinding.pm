package Kubernetes::REST::Call::v1::RbacAuthorization::PatchNamespacedRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::PatchNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
