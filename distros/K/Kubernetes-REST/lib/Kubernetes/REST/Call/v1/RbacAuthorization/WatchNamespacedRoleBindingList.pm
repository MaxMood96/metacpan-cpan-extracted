package Kubernetes::REST::Call::v1::RbacAuthorization::WatchNamespacedRoleBindingList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::WatchNamespacedRoleBindingList - Deprecated - use the new Kubernetes::REST API instead
