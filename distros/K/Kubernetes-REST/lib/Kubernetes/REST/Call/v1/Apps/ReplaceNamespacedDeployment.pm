package Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedDeployment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
