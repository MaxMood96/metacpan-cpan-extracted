package Kubernetes::REST::Call::v1::Apps::PatchNamespacedDeployment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
