package Kubernetes::REST::Call::v1::Core::ConnectPatchNamespacedServiceProxyWithPath;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectPatchNamespacedServiceProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
