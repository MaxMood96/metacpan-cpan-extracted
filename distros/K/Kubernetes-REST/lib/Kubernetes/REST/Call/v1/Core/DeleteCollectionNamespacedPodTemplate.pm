package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedPodTemplate;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedPodTemplate - Deprecated - use the new Kubernetes::REST API instead
