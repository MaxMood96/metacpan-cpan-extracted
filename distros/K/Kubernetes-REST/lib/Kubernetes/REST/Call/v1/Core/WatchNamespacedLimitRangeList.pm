package Kubernetes::REST::Call::v1::Core::WatchNamespacedLimitRangeList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedLimitRangeList - Deprecated - use the new Kubernetes::REST API instead
