package Kubernetes::REST::Call::v1::Batch::WatchNamespacedJobList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Batch::WatchNamespacedJobList - Deprecated - use the new Kubernetes::REST API instead
