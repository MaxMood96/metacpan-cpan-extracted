package Kubernetes::REST::Call::v1::Core::ConnectDeleteNodeProxyWithPath;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectDeleteNodeProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
