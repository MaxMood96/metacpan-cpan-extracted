package Kubernetes::REST::Call::v1::Core::WatchNamespacedServiceAccountList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedServiceAccountList - Deprecated - use the new Kubernetes::REST API instead
