package Kubernetes::REST::Call::v1::Apps::WatchDaemonSetListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::WatchDaemonSetListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
