package Kubernetes::REST::Call::v1::Core::ReadNamespacedService;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedService - Deprecated - use the new Kubernetes::REST API instead
