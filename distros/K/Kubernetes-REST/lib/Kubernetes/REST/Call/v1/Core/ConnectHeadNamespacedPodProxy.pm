package Kubernetes::REST::Call::v1::Core::ConnectHeadNamespacedPodProxy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ConnectHeadNamespacedPodProxy - Deprecated - use the new Kubernetes::REST API instead
