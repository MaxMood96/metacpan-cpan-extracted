package Kubernetes::REST::Call::v1::Apps::ListDaemonSetForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::ListDaemonSetForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
