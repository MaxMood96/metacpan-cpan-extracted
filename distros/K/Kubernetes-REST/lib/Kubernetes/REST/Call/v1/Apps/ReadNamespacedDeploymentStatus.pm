package Kubernetes::REST::Call::v1::Apps::ReadNamespacedDeploymentStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ReadNamespacedDeploymentStatus - Deprecated - use the new Kubernetes::REST API instead
