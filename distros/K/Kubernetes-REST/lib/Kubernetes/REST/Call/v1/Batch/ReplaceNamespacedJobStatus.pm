package Kubernetes::REST::Call::v1::Batch::ReplaceNamespacedJobStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Batch::ReplaceNamespacedJobStatus - Deprecated - use the new Kubernetes::REST API instead
