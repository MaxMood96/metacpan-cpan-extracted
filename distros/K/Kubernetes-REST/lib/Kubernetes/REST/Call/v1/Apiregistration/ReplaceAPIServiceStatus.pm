package Kubernetes::REST::Call::v1::Apiregistration::ReplaceAPIServiceStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apiregistration::ReplaceAPIServiceStatus - Deprecated - use the new Kubernetes::REST API instead
