package Kubernetes::REST::Call::v1::Core::CreateNamespacedService;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedService - Deprecated - use the new Kubernetes::REST API instead
