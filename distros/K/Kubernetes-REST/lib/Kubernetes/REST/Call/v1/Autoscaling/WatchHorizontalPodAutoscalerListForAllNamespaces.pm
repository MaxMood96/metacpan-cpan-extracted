package Kubernetes::REST::Call::v1::Autoscaling::WatchHorizontalPodAutoscalerListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Autoscaling::WatchHorizontalPodAutoscalerListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
