package Kubernetes::REST::Call::v1::Apps::DeleteNamespacedDaemonSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::DeleteNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
