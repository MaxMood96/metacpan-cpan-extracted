package Kubernetes::REST::Call::v1::Core::ListEventForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ListEventForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
