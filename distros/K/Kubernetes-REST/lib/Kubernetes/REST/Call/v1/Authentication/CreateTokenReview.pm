package Kubernetes::REST::Call::v1::Authentication::CreateTokenReview;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Authentication::CreateTokenReview - Deprecated - use the new Kubernetes::REST API instead
