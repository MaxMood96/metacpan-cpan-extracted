package Kubernetes::REST::Call::v1::Apps::ListNamespacedDeployment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apps::ListNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
