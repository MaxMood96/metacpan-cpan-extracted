package Kubernetes::REST::Call::v1::RbacAuthorization::DeleteCollectionNamespacedRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::RbacAuthorization::DeleteCollectionNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
