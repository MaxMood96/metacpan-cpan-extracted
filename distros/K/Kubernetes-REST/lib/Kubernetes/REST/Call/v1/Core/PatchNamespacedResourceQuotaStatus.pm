package Kubernetes::REST::Call::v1::Core::PatchNamespacedResourceQuotaStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedResourceQuotaStatus - Deprecated - use the new Kubernetes::REST API instead
