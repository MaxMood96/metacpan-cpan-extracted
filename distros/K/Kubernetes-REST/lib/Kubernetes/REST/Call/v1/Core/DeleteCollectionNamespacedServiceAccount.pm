package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedServiceAccount;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedServiceAccount - Deprecated - use the new Kubernetes::REST API instead
