package Kubernetes::REST::Call::v1::Autoscaling::CreateNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Autoscaling::CreateNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
