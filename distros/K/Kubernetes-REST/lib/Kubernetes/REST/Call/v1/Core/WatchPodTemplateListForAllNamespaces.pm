package Kubernetes::REST::Call::v1::Core::WatchPodTemplateListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchPodTemplateListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
