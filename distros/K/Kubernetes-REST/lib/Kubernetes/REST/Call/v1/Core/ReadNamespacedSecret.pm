package Kubernetes::REST::Call::v1::Core::ReadNamespacedSecret;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedSecret - Deprecated - use the new Kubernetes::REST API instead
