package Kubernetes::REST::Call::v1::RbacAuthorization::ReadClusterRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::ReadClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
