package Kubernetes::REST::Call::v1::Core::ListEndpointsForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ListEndpointsForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
