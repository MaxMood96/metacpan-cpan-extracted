package Kubernetes::REST::Call::v1::Autoscaling::ReadNamespacedHorizontalPodAutoscalerStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Autoscaling::ReadNamespacedHorizontalPodAutoscalerStatus - Deprecated - use the new Kubernetes::REST API instead
