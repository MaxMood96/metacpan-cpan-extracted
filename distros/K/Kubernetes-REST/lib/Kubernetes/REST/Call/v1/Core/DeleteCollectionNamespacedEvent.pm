package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedEvent;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedEvent - Deprecated - use the new Kubernetes::REST API instead
