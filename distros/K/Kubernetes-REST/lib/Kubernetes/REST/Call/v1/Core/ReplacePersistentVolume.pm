package Kubernetes::REST::Call::v1::Core::ReplacePersistentVolume;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReplacePersistentVolume - Deprecated - use the new Kubernetes::REST API instead
