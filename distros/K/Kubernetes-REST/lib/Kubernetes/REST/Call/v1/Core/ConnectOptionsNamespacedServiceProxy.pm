package Kubernetes::REST::Call::v1::Core::ConnectOptionsNamespacedServiceProxy;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectOptionsNamespacedServiceProxy - Deprecated - use the new Kubernetes::REST API instead
