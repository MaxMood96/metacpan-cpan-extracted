package Kubernetes::REST::Call::v1::Core::WatchNamespacedPersistentVolumeClaim;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedPersistentVolumeClaim - Deprecated - use the new Kubernetes::REST API instead
