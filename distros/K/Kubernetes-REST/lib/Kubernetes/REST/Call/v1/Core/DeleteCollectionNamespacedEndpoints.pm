package Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedEndpoints;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionNamespacedEndpoints - Deprecated - use the new Kubernetes::REST API instead
