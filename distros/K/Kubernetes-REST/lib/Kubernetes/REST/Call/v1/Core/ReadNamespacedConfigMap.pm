package Kubernetes::REST::Call::v1::Core::ReadNamespacedConfigMap;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedConfigMap - Deprecated - use the new Kubernetes::REST API instead
