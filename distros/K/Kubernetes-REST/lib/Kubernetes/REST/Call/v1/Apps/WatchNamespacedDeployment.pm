package Kubernetes::REST::Call::v1::Apps::WatchNamespacedDeployment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::WatchNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
