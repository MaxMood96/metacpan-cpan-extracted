package Kubernetes::REST::Call::v1::Core::ListConfigMapForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ListConfigMapForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
