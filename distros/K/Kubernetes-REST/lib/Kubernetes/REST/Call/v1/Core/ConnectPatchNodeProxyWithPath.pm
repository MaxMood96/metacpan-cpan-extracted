package Kubernetes::REST::Call::v1::Core::ConnectPatchNodeProxyWithPath;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectPatchNodeProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
