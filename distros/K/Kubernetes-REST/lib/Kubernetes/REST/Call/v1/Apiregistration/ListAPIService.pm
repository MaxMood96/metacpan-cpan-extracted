package Kubernetes::REST::Call::v1::Apiregistration::ListAPIService;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Apiregistration::ListAPIService - Deprecated - use the new Kubernetes::REST API instead
