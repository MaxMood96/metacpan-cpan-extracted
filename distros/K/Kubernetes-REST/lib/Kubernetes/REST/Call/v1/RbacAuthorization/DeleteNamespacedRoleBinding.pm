package Kubernetes::REST::Call::v1::RbacAuthorization::DeleteNamespacedRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::RbacAuthorization::DeleteNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
