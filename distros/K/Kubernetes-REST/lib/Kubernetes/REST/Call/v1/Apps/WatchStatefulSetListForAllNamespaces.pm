package Kubernetes::REST::Call::v1::Apps::WatchStatefulSetListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Apps::WatchStatefulSetListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
