package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedReplicationControllerStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedReplicationControllerStatus - Deprecated - use the new Kubernetes::REST API instead
