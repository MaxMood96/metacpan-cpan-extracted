package Kubernetes::REST::Call::v1::RbacAuthorization::PatchNamespacedRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::RbacAuthorization::PatchNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
