package Kubernetes::REST::Call::v1::Core::ConnectPostNodeProxy;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ConnectPostNodeProxy - Deprecated - use the new Kubernetes::REST API instead
