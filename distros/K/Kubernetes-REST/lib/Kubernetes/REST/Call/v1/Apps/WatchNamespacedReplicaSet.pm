package Kubernetes::REST::Call::v1::Apps::WatchNamespacedReplicaSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::WatchNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
