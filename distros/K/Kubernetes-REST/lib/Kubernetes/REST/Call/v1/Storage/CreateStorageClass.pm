package Kubernetes::REST::Call::v1::Storage::CreateStorageClass;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Storage::CreateStorageClass - Deprecated - use the new Kubernetes::REST API instead
