package Kubernetes::REST::Call::v1::Core::CreateNamespacedPod;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::CreateNamespacedPod - Deprecated - use the new Kubernetes::REST API instead
