package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedConfigMap;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedConfigMap - Deprecated - use the new Kubernetes::REST API instead
