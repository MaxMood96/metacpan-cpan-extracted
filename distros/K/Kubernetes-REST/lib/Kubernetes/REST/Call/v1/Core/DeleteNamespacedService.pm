package Kubernetes::REST::Call::v1::Core::DeleteNamespacedService;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedService - Deprecated - use the new Kubernetes::REST API instead
