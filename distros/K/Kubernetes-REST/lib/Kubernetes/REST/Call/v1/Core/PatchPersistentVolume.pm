package Kubernetes::REST::Call::v1::Core::PatchPersistentVolume;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::PatchPersistentVolume - Deprecated - use the new Kubernetes::REST API instead
