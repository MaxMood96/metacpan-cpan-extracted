package Kubernetes::REST::Call::v1::Core::DeletePersistentVolume;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::DeletePersistentVolume - Deprecated - use the new Kubernetes::REST API instead
