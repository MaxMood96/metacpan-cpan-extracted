package Kubernetes::REST::Call::v1::Core::ReadNamespacedPodTemplate;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ReadNamespacedPodTemplate - Deprecated - use the new Kubernetes::REST API instead
