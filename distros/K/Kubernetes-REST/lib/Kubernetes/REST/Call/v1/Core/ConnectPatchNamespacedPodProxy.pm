package Kubernetes::REST::Call::v1::Core::ConnectPatchNamespacedPodProxy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectPatchNamespacedPodProxy - Deprecated - use the new Kubernetes::REST API instead
