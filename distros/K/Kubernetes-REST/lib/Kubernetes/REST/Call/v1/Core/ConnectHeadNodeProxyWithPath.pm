package Kubernetes::REST::Call::v1::Core::ConnectHeadNodeProxyWithPath;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ConnectHeadNodeProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
