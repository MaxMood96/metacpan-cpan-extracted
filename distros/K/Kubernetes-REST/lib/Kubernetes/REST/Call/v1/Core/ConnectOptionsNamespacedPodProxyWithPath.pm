package Kubernetes::REST::Call::v1::Core::ConnectOptionsNamespacedPodProxyWithPath;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ConnectOptionsNamespacedPodProxyWithPath - Deprecated - use the new Kubernetes::REST API instead
