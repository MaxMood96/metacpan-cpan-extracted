package Kubernetes::REST::Call::v1::Core::DeleteNamespacedConfigMap;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::DeleteNamespacedConfigMap - Deprecated - use the new Kubernetes::REST API instead
