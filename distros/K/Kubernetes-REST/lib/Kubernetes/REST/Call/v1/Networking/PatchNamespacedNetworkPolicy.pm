package Kubernetes::REST::Call::v1::Networking::PatchNamespacedNetworkPolicy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Networking::PatchNamespacedNetworkPolicy - Deprecated - use the new Kubernetes::REST API instead
