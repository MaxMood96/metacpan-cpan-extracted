package Kubernetes::REST::Call::v1::Core::ReplaceNamespaceStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespaceStatus - Deprecated - use the new Kubernetes::REST API instead
