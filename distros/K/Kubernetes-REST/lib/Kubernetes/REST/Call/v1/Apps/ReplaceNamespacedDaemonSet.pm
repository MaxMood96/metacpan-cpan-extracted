package Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedDaemonSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::ReplaceNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
