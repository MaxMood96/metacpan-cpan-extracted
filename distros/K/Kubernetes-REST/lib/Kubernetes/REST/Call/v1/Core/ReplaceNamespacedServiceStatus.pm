package Kubernetes::REST::Call::v1::Core::ReplaceNamespacedServiceStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ReplaceNamespacedServiceStatus - Deprecated - use the new Kubernetes::REST API instead
