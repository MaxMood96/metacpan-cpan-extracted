package Kubernetes::REST::Call::v1::RbacAuthorization::DeleteCollectionClusterRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::DeleteCollectionClusterRole - Deprecated - use the new Kubernetes::REST API instead
