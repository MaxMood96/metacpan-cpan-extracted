package Kubernetes::REST::Call::v1::RbacAuthorization::ListClusterRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::ListClusterRole - Deprecated - use the new Kubernetes::REST API instead
