package Kubernetes::REST::Call::v1::RbacAuthorization::ReplaceClusterRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::ReplaceClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
