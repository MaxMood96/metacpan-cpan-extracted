package Kubernetes::REST::Call::v1::Autoscaling::ReplaceNamespacedHorizontalPodAutoscalerStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Autoscaling::ReplaceNamespacedHorizontalPodAutoscalerStatus - Deprecated - use the new Kubernetes::REST API instead
