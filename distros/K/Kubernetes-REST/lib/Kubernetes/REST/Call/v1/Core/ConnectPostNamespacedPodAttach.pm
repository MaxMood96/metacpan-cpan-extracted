package Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedPodAttach;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Core::ConnectPostNamespacedPodAttach - Deprecated - use the new Kubernetes::REST API instead
