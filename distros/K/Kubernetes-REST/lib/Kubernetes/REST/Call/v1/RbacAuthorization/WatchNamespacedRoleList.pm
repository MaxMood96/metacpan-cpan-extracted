package Kubernetes::REST::Call::v1::RbacAuthorization::WatchNamespacedRoleList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::RbacAuthorization::WatchNamespacedRoleList - Deprecated - use the new Kubernetes::REST API instead
