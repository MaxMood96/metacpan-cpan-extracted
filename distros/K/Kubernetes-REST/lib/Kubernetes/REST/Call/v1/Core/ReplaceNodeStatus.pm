package Kubernetes::REST::Call::v1::Core::ReplaceNodeStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::ReplaceNodeStatus - Deprecated - use the new Kubernetes::REST API instead
