package Kubernetes::REST::Call::v1::RbacAuthorization::PatchClusterRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::RbacAuthorization::PatchClusterRole - Deprecated - use the new Kubernetes::REST API instead
