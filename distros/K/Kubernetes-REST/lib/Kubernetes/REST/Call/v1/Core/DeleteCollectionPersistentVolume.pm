package Kubernetes::REST::Call::v1::Core::DeleteCollectionPersistentVolume;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::DeleteCollectionPersistentVolume - Deprecated - use the new Kubernetes::REST API instead
