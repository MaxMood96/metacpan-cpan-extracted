package Kubernetes::REST::Call::v1::Core::WatchNamespacedServiceAccount;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedServiceAccount - Deprecated - use the new Kubernetes::REST API instead
