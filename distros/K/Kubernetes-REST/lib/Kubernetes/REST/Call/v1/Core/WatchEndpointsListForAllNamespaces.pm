package Kubernetes::REST::Call::v1::Core::WatchEndpointsListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchEndpointsListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
