package Kubernetes::REST::Call::v1::Core::ConnectPatchNamespacedServiceProxy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectPatchNamespacedServiceProxy - Deprecated - use the new Kubernetes::REST API instead
