package Kubernetes::REST::Call::v1::Core::ConnectPutNamespacedPodProxy;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::ConnectPutNamespacedPodProxy - Deprecated - use the new Kubernetes::REST API instead
