package Kubernetes::REST::Call::v1::Core::PatchNamespacedReplicationController;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::PatchNamespacedReplicationController - Deprecated - use the new Kubernetes::REST API instead
