package Kubernetes::REST::Call::v1::Autoscaling::ReadNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1::Autoscaling::ReadNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
