package Kubernetes::REST::Call::v1::Storage::ListStorageClass;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Storage::ListStorageClass - Deprecated - use the new Kubernetes::REST API instead
