package Kubernetes::REST::Call::v1::Apps::PatchNamespacedDeploymentScale;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1::Apps::PatchNamespacedDeploymentScale - Deprecated - use the new Kubernetes::REST API instead
