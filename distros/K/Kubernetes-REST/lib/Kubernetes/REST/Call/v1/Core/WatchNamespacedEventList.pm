package Kubernetes::REST::Call::v1::Core::WatchNamespacedEventList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1::Core::WatchNamespacedEventList - Deprecated - use the new Kubernetes::REST API instead
