package Kubernetes::REST::Call::v1alpha1::Admissionregistration::GetAPIResources;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Admissionregistration::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
