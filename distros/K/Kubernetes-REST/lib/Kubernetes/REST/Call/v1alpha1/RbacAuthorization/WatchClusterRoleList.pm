package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchClusterRoleList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchClusterRoleList - Deprecated - use the new Kubernetes::REST API instead
