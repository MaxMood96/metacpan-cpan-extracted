package Kubernetes::REST::Call::v1alpha1::Storage::DeleteVolumeAttachment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Storage::DeleteVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
