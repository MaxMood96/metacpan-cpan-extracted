package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReplaceNamespacedRoleBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReplaceNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
