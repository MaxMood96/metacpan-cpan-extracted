package Kubernetes::REST::Call::v1alpha1::Auditregistration::WatchAuditSinkList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::WatchAuditSinkList - Deprecated - use the new Kubernetes::REST API instead
