package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::CreateClusterRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::CreateClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
