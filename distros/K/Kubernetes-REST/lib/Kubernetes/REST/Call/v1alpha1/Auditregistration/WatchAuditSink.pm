package Kubernetes::REST::Call::v1alpha1::Auditregistration::WatchAuditSink;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::WatchAuditSink - Deprecated - use the new Kubernetes::REST API instead
