package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::CreateNamespacedRoleBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::CreateNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
