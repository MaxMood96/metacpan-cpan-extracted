package Kubernetes::REST::Call::v1alpha1::Scheduling::PatchPriorityClass;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Scheduling::PatchPriorityClass - Deprecated - use the new Kubernetes::REST API instead
