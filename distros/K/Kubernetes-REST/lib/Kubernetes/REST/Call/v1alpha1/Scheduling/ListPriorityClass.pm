package Kubernetes::REST::Call::v1alpha1::Scheduling::ListPriorityClass;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Scheduling::ListPriorityClass - Deprecated - use the new Kubernetes::REST API instead
