package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::CreateNamespacedRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::CreateNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
