package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchRoleListForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchRoleListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
