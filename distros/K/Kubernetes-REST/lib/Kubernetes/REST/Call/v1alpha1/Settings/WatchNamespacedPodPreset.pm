package Kubernetes::REST::Call::v1alpha1::Settings::WatchNamespacedPodPreset;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Settings::WatchNamespacedPodPreset - Deprecated - use the new Kubernetes::REST API instead
