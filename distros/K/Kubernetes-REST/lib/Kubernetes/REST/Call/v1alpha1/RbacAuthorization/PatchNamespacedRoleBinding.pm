package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::PatchNamespacedRoleBinding;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::PatchNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
