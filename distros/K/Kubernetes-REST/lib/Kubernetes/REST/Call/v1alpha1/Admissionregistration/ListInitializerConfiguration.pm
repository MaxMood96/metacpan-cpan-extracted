package Kubernetes::REST::Call::v1alpha1::Admissionregistration::ListInitializerConfiguration;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Admissionregistration::ListInitializerConfiguration - Deprecated - use the new Kubernetes::REST API instead
