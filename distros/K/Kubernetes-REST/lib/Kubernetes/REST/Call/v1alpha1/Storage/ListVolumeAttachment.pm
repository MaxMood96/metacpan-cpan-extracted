package Kubernetes::REST::Call::v1alpha1::Storage::ListVolumeAttachment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Storage::ListVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
