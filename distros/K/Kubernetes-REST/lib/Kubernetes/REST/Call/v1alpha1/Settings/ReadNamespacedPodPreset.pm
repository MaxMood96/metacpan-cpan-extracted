package Kubernetes::REST::Call::v1alpha1::Settings::ReadNamespacedPodPreset;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Settings::ReadNamespacedPodPreset - Deprecated - use the new Kubernetes::REST API instead
