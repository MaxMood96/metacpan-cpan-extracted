package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ListClusterRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ListClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
