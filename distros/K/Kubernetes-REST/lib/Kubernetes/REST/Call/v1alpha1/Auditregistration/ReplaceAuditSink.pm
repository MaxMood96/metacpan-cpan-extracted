package Kubernetes::REST::Call::v1alpha1::Auditregistration::ReplaceAuditSink;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::ReplaceAuditSink - Deprecated - use the new Kubernetes::REST API instead
