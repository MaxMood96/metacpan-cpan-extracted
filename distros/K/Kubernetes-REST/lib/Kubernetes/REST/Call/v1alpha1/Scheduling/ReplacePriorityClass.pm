package Kubernetes::REST::Call::v1alpha1::Scheduling::ReplacePriorityClass;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Scheduling::ReplacePriorityClass - Deprecated - use the new Kubernetes::REST API instead
