package Kubernetes::REST::Call::v1alpha1::Storage::ReplaceVolumeAttachment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Storage::ReplaceVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
