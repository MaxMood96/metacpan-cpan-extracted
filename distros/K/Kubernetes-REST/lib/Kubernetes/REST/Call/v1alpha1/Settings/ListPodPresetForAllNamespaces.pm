package Kubernetes::REST::Call::v1alpha1::Settings::ListPodPresetForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Settings::ListPodPresetForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
