package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ListNamespacedRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ListNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
