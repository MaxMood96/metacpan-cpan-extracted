package Kubernetes::REST::Call::v1alpha1::Admissionregistration::WatchInitializerConfigurationList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Admissionregistration::WatchInitializerConfigurationList - Deprecated - use the new Kubernetes::REST API instead
