package Kubernetes::REST::Call::v1alpha1::Scheduling::WatchPriorityClassList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Scheduling::WatchPriorityClassList - Deprecated - use the new Kubernetes::REST API instead
