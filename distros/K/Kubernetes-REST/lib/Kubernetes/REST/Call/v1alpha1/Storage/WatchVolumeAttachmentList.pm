package Kubernetes::REST::Call::v1alpha1::Storage::WatchVolumeAttachmentList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Storage::WatchVolumeAttachmentList - Deprecated - use the new Kubernetes::REST API instead
