package Kubernetes::REST::Call::v1alpha1::Settings::ListNamespacedPodPreset;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Settings::ListNamespacedPodPreset - Deprecated - use the new Kubernetes::REST API instead
