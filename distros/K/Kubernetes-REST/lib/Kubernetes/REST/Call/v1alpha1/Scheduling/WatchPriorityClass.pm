package Kubernetes::REST::Call::v1alpha1::Scheduling::WatchPriorityClass;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Scheduling::WatchPriorityClass - Deprecated - use the new Kubernetes::REST API instead
