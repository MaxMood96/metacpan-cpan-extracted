package Kubernetes::REST::Call::v1alpha1::Admissionregistration::WatchInitializerConfiguration;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Admissionregistration::WatchInitializerConfiguration - Deprecated - use the new Kubernetes::REST API instead
