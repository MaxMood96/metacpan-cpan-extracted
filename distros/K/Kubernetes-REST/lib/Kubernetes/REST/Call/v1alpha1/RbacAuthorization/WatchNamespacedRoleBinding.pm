package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchNamespacedRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
