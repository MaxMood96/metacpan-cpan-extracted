package Kubernetes::REST::Call::v1alpha1::Admissionregistration::ReadInitializerConfiguration;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Admissionregistration::ReadInitializerConfiguration - Deprecated - use the new Kubernetes::REST API instead
