package Kubernetes::REST::Call::v1alpha1::Settings::ReplaceNamespacedPodPreset;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Settings::ReplaceNamespacedPodPreset - Deprecated - use the new Kubernetes::REST API instead
