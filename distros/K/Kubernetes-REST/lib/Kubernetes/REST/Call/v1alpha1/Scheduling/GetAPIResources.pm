package Kubernetes::REST::Call::v1alpha1::Scheduling::GetAPIResources;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Scheduling::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
