package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReadClusterRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReadClusterRole - Deprecated - use the new Kubernetes::REST API instead
