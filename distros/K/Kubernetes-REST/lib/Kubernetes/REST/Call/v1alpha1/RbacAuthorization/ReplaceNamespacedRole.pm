package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReplaceNamespacedRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReplaceNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
