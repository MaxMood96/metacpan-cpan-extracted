package Kubernetes::REST::Call::v1alpha1::Settings::DeleteNamespacedPodPreset;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Settings::DeleteNamespacedPodPreset - Deprecated - use the new Kubernetes::REST API instead
