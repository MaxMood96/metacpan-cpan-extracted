package Kubernetes::REST::Call::v1alpha1::Settings::PatchNamespacedPodPreset;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Settings::PatchNamespacedPodPreset - Deprecated - use the new Kubernetes::REST API instead
