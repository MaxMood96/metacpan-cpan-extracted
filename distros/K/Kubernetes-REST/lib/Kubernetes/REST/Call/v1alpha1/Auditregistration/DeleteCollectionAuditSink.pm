package Kubernetes::REST::Call::v1alpha1::Auditregistration::DeleteCollectionAuditSink;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::DeleteCollectionAuditSink - Deprecated - use the new Kubernetes::REST API instead
