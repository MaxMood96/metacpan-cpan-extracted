package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchRoleBindingListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchRoleBindingListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
