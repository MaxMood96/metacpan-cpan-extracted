package Kubernetes::REST::Call::v1alpha1::Auditregistration::DeleteAuditSink;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::DeleteAuditSink - Deprecated - use the new Kubernetes::REST API instead
