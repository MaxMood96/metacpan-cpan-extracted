package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::GetAPIResources;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
