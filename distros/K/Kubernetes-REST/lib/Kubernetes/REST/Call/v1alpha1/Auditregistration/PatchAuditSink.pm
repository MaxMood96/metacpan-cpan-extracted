package Kubernetes::REST::Call::v1alpha1::Auditregistration::PatchAuditSink;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::PatchAuditSink - Deprecated - use the new Kubernetes::REST API instead
