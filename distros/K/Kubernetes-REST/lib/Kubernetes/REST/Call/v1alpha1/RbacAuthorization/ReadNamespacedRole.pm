package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReadNamespacedRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReadNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
