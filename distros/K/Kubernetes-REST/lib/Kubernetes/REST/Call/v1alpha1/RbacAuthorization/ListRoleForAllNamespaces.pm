package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ListRoleForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ListRoleForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
