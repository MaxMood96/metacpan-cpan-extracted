package Kubernetes::REST::Call::v1alpha1::Admissionregistration::DeleteInitializerConfiguration;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Admissionregistration::DeleteInitializerConfiguration - Deprecated - use the new Kubernetes::REST API instead
