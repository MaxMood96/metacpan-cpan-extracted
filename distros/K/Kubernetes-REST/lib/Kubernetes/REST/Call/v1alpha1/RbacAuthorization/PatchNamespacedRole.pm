package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::PatchNamespacedRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::PatchNamespacedRole - Deprecated - use the new Kubernetes::REST API instead
