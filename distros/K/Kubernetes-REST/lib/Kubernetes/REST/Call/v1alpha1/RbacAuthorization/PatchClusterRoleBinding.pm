package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::PatchClusterRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::PatchClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
