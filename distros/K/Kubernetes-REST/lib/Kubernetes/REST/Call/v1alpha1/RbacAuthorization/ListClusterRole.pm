package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ListClusterRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ListClusterRole - Deprecated - use the new Kubernetes::REST API instead
