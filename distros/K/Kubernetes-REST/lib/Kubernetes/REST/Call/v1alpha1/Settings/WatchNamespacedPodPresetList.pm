package Kubernetes::REST::Call::v1alpha1::Settings::WatchNamespacedPodPresetList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Settings::WatchNamespacedPodPresetList - Deprecated - use the new Kubernetes::REST API instead
