package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchClusterRole;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchClusterRole - Deprecated - use the new Kubernetes::REST API instead
