package Kubernetes::REST::Call::v1alpha1::Auditregistration::ReadAuditSink;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::ReadAuditSink - Deprecated - use the new Kubernetes::REST API instead
