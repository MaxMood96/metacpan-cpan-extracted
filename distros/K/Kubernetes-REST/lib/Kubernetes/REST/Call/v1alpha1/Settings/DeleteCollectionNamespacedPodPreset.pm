package Kubernetes::REST::Call::v1alpha1::Settings::DeleteCollectionNamespacedPodPreset;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Settings::DeleteCollectionNamespacedPodPreset - Deprecated - use the new Kubernetes::REST API instead
