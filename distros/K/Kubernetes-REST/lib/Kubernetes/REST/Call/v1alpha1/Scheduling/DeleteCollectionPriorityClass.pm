package Kubernetes::REST::Call::v1alpha1::Scheduling::DeleteCollectionPriorityClass;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Scheduling::DeleteCollectionPriorityClass - Deprecated - use the new Kubernetes::REST API instead
