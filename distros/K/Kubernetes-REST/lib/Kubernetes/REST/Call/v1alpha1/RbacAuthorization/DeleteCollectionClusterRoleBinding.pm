package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::DeleteCollectionClusterRoleBinding;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::DeleteCollectionClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
