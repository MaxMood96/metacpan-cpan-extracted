package Kubernetes::REST::Call::v1alpha1::Settings::WatchPodPresetListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Settings::WatchPodPresetListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
