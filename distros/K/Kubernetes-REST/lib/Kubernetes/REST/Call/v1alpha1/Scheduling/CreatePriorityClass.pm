package Kubernetes::REST::Call::v1alpha1::Scheduling::CreatePriorityClass;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Scheduling::CreatePriorityClass - Deprecated - use the new Kubernetes::REST API instead
