package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::DeleteCollectionClusterRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::DeleteCollectionClusterRole - Deprecated - use the new Kubernetes::REST API instead
