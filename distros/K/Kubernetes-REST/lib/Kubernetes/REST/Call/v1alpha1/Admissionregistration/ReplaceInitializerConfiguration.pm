package Kubernetes::REST::Call::v1alpha1::Admissionregistration::ReplaceInitializerConfiguration;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Admissionregistration::ReplaceInitializerConfiguration - Deprecated - use the new Kubernetes::REST API instead
