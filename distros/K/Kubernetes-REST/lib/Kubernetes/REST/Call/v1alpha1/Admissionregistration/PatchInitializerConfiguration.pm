package Kubernetes::REST::Call::v1alpha1::Admissionregistration::PatchInitializerConfiguration;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Admissionregistration::PatchInitializerConfiguration - Deprecated - use the new Kubernetes::REST API instead
