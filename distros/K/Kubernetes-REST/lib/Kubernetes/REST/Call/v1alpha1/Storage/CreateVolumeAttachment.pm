package Kubernetes::REST::Call::v1alpha1::Storage::CreateVolumeAttachment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Storage::CreateVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
