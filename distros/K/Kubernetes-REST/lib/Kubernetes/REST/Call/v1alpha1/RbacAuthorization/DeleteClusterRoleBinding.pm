package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::DeleteClusterRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::DeleteClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
