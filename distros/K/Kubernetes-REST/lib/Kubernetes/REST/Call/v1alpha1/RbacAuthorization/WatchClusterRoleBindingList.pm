package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchClusterRoleBindingList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchClusterRoleBindingList - Deprecated - use the new Kubernetes::REST API instead
