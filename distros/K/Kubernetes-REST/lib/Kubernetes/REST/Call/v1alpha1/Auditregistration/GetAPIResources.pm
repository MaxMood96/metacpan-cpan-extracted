package Kubernetes::REST::Call::v1alpha1::Auditregistration::GetAPIResources;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
