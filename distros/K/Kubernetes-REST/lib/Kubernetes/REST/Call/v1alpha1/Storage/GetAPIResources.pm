package Kubernetes::REST::Call::v1alpha1::Storage::GetAPIResources;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Storage::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
