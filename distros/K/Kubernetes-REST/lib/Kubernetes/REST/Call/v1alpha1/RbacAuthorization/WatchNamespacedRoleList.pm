package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchNamespacedRoleList;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchNamespacedRoleList - Deprecated - use the new Kubernetes::REST API instead
