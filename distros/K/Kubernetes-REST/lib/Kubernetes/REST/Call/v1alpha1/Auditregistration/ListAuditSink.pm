package Kubernetes::REST::Call::v1alpha1::Auditregistration::ListAuditSink;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::ListAuditSink - Deprecated - use the new Kubernetes::REST API instead
