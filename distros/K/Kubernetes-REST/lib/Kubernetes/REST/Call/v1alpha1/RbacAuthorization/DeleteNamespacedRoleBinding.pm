package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::DeleteNamespacedRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::DeleteNamespacedRoleBinding - Deprecated - use the new Kubernetes::REST API instead
