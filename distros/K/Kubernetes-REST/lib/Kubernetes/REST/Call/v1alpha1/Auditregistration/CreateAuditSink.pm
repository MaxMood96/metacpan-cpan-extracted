package Kubernetes::REST::Call::v1alpha1::Auditregistration::CreateAuditSink;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::Auditregistration::CreateAuditSink - Deprecated - use the new Kubernetes::REST API instead
