package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReplaceClusterRole;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::ReplaceClusterRole - Deprecated - use the new Kubernetes::REST API instead
