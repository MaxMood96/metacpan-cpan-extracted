package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchNamespacedRoleBindingList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchNamespacedRoleBindingList - Deprecated - use the new Kubernetes::REST API instead
