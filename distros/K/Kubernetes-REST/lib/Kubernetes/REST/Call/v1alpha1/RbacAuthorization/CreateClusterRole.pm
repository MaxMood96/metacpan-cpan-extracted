package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::CreateClusterRole;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::CreateClusterRole - Deprecated - use the new Kubernetes::REST API instead
