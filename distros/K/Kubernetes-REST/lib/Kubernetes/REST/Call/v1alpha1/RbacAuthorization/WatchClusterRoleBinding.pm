package Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchClusterRoleBinding;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1alpha1::RbacAuthorization::WatchClusterRoleBinding - Deprecated - use the new Kubernetes::REST API instead
