package Kubernetes::REST::Call::v1alpha1::Storage::PatchVolumeAttachment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1alpha1::Storage::PatchVolumeAttachment - Deprecated - use the new Kubernetes::REST API instead
