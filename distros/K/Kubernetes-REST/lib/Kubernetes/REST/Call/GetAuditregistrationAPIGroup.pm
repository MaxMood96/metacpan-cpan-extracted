package Kubernetes::REST::Call::GetAuditregistrationAPIGroup;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::GetAuditregistrationAPIGroup - Deprecated - use the new Kubernetes::REST API instead
