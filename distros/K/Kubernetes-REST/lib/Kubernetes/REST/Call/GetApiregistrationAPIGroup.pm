package Kubernetes::REST::Call::GetApiregistrationAPIGroup;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::GetApiregistrationAPIGroup - Deprecated - use the new Kubernetes::REST API instead
