package Kubernetes::REST::Call::v2beta1::Autoscaling::ListHorizontalPodAutoscalerForAllNamespaces;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::ListHorizontalPodAutoscalerForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
