package Kubernetes::REST::Call::v2beta1::Autoscaling::WatchNamespacedHorizontalPodAutoscalerList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::WatchNamespacedHorizontalPodAutoscalerList - Deprecated - use the new Kubernetes::REST API instead
