package Kubernetes::REST::Call::v2beta1::Autoscaling::GetAPIResources;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
