package Kubernetes::REST::Call::v2beta1::Autoscaling::DeleteNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::DeleteNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
