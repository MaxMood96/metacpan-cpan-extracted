package Kubernetes::REST::Call::v2beta1::Autoscaling::PatchNamespacedHorizontalPodAutoscalerStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::PatchNamespacedHorizontalPodAutoscalerStatus - Deprecated - use the new Kubernetes::REST API instead
