package Kubernetes::REST::Call::v2beta1::Autoscaling::ReadNamespacedHorizontalPodAutoscalerStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::ReadNamespacedHorizontalPodAutoscalerStatus - Deprecated - use the new Kubernetes::REST API instead
