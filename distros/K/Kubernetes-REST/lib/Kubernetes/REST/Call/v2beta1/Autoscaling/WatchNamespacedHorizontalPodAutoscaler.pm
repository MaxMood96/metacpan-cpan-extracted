package Kubernetes::REST::Call::v2beta1::Autoscaling::WatchNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::WatchNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
