package Kubernetes::REST::Call::v2beta1::Autoscaling::ListNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::ListNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
