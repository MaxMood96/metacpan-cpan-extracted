package Kubernetes::REST::Call::v2beta1::Autoscaling::CreateNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::CreateNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
