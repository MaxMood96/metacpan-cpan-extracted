package Kubernetes::REST::Call::v2beta1::Autoscaling::ReplaceNamespacedHorizontalPodAutoscalerStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::ReplaceNamespacedHorizontalPodAutoscalerStatus - Deprecated - use the new Kubernetes::REST API instead
