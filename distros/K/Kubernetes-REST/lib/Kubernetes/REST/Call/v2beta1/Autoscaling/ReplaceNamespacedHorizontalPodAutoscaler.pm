package Kubernetes::REST::Call::v2beta1::Autoscaling::ReplaceNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::ReplaceNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
