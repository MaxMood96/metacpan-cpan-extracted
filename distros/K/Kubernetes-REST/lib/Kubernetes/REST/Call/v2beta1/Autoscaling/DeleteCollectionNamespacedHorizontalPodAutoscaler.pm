package Kubernetes::REST::Call::v2beta1::Autoscaling::DeleteCollectionNamespacedHorizontalPodAutoscaler;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2beta1::Autoscaling::DeleteCollectionNamespacedHorizontalPodAutoscaler - Deprecated - use the new Kubernetes::REST API instead
