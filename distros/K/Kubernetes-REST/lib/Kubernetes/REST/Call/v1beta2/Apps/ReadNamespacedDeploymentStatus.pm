package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedDeploymentStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedDeploymentStatus - Deprecated - use the new Kubernetes::REST API instead
