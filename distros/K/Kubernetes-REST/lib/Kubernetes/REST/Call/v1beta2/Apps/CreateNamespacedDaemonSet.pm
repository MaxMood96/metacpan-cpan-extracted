package Kubernetes::REST::Call::v1beta2::Apps::CreateNamespacedDaemonSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::CreateNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
