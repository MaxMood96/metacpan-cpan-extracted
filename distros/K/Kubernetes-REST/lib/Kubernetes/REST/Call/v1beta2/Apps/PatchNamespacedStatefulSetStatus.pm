package Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedStatefulSetStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedStatefulSetStatus - Deprecated - use the new Kubernetes::REST API instead
