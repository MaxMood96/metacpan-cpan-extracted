package Kubernetes::REST::Call::v1beta2::Apps::WatchReplicaSetListForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::WatchReplicaSetListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
