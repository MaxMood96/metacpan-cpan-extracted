package Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedReplicaSetScale;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedReplicaSetScale - Deprecated - use the new Kubernetes::REST API instead
