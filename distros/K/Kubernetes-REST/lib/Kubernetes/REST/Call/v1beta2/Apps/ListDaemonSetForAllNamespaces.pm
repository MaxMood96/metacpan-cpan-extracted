package Kubernetes::REST::Call::v1beta2::Apps::ListDaemonSetForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::ListDaemonSetForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
