package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedStatefulSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
