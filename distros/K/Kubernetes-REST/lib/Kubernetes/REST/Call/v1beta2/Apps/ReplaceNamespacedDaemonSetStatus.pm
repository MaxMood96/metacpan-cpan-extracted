package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedDaemonSetStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedDaemonSetStatus - Deprecated - use the new Kubernetes::REST API instead
