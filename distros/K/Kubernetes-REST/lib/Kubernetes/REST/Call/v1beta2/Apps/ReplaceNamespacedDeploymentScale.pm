package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedDeploymentScale;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedDeploymentScale - Deprecated - use the new Kubernetes::REST API instead
