package Kubernetes::REST::Call::v1beta2::Apps::ListNamespacedControllerRevision;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::ListNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
