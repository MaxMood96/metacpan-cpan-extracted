package Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedStatefulSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
