package Kubernetes::REST::Call::v1beta2::Apps::DeleteNamespacedReplicaSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::DeleteNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
