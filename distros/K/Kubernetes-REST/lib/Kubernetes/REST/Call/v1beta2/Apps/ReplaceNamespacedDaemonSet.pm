package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedDaemonSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
