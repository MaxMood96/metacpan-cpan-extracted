package Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedDaemonSetStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedDaemonSetStatus - Deprecated - use the new Kubernetes::REST API instead
