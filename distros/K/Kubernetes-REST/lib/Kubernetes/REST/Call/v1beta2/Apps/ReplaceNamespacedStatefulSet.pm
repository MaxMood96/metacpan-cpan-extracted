package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedStatefulSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
