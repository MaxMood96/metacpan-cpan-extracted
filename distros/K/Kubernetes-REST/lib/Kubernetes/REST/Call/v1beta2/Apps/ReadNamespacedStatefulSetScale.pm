package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedStatefulSetScale;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedStatefulSetScale - Deprecated - use the new Kubernetes::REST API instead
