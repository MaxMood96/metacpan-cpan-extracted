package Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedDeploymentList;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedDeploymentList - Deprecated - use the new Kubernetes::REST API instead
