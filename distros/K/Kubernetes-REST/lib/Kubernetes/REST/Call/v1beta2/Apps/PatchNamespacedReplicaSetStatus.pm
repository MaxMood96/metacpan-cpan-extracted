package Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedReplicaSetStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedReplicaSetStatus - Deprecated - use the new Kubernetes::REST API instead
