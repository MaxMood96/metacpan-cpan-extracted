package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedReplicaSetStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedReplicaSetStatus - Deprecated - use the new Kubernetes::REST API instead
