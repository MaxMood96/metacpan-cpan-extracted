package Kubernetes::REST::Call::v1beta2::Apps::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
