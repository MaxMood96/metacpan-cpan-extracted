package Kubernetes::REST::Call::v1beta2::Apps::CreateNamespacedReplicaSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::CreateNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
