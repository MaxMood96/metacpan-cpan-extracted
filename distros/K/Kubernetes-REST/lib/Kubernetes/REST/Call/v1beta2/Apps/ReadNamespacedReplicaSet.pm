package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedReplicaSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
