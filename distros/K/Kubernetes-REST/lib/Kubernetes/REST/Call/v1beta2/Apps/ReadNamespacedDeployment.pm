package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedDeployment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
