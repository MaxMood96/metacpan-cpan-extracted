package Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedControllerRevision;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
