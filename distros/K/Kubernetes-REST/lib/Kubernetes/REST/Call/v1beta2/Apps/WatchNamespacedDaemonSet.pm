package Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedDaemonSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
