package Kubernetes::REST::Call::v1beta2::Apps::ListNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ListNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
