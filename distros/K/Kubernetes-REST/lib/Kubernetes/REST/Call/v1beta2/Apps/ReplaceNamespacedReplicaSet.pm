package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedReplicaSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
