package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedDaemonSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
