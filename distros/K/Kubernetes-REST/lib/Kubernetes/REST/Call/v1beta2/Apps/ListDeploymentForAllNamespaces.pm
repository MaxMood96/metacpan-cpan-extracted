package Kubernetes::REST::Call::v1beta2::Apps::ListDeploymentForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::ListDeploymentForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
