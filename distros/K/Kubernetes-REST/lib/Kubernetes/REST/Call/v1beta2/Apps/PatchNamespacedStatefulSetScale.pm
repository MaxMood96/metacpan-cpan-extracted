package Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedStatefulSetScale;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedStatefulSetScale - Deprecated - use the new Kubernetes::REST API instead
