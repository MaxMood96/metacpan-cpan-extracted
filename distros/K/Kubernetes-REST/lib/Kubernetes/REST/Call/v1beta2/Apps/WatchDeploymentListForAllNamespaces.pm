package Kubernetes::REST::Call::v1beta2::Apps::WatchDeploymentListForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::WatchDeploymentListForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
