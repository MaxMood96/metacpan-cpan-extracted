package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedControllerRevision;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
