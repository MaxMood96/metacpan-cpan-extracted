package Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedDeploymentScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedDeploymentScale - Deprecated - use the new Kubernetes::REST API instead
