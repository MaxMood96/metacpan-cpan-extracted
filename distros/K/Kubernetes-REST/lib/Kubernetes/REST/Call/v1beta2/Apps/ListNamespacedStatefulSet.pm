package Kubernetes::REST::Call::v1beta2::Apps::ListNamespacedStatefulSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::ListNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
