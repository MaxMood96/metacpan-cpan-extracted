package Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedDaemonSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::PatchNamespacedDaemonSet - Deprecated - use the new Kubernetes::REST API instead
