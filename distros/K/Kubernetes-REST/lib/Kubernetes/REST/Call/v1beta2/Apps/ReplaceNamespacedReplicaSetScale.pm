package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedReplicaSetScale;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedReplicaSetScale - Deprecated - use the new Kubernetes::REST API instead
