package Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedReplicaSetList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedReplicaSetList - Deprecated - use the new Kubernetes::REST API instead
