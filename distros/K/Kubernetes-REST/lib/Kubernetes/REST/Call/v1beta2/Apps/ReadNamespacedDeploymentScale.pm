package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedDeploymentScale;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedDeploymentScale - Deprecated - use the new Kubernetes::REST API instead
