package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedStatefulSetStatus;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedStatefulSetStatus - Deprecated - use the new Kubernetes::REST API instead
