package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedDeploymentStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedDeploymentStatus - Deprecated - use the new Kubernetes::REST API instead
