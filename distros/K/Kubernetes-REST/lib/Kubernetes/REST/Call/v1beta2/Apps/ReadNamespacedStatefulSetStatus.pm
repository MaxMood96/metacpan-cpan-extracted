package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedStatefulSetStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedStatefulSetStatus - Deprecated - use the new Kubernetes::REST API instead
