package Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedDeployment;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
