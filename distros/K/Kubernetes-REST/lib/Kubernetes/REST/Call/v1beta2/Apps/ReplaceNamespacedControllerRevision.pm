package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedControllerRevision;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
