package Kubernetes::REST::Call::v1beta2::Apps::ListReplicaSetForAllNamespaces;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::ListReplicaSetForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
