package Kubernetes::REST::Call::v1beta2::Apps::DeleteNamespacedStatefulSet;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::DeleteNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
