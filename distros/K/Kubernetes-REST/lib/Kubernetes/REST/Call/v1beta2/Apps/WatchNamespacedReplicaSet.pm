package Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedReplicaSet;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
