package Kubernetes::REST::Call::v1beta2::Apps::DeleteCollectionNamespacedStatefulSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::DeleteCollectionNamespacedStatefulSet - Deprecated - use the new Kubernetes::REST API instead
