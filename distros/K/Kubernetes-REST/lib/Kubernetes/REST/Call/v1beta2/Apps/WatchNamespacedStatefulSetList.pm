package Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedStatefulSetList;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::WatchNamespacedStatefulSetList - Deprecated - use the new Kubernetes::REST API instead
