package Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedReplicaSetStatus;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::ReadNamespacedReplicaSetStatus - Deprecated - use the new Kubernetes::REST API instead
