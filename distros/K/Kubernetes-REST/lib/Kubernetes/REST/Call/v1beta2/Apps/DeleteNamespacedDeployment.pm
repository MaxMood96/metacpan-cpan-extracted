package Kubernetes::REST::Call::v1beta2::Apps::DeleteNamespacedDeployment;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::DeleteNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
