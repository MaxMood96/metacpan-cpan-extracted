package Kubernetes::REST::Call::v1beta2::Apps::CreateNamespacedDeployment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::CreateNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
