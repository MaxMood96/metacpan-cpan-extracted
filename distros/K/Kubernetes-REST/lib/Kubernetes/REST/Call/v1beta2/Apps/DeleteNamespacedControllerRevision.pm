package Kubernetes::REST::Call::v1beta2::Apps::DeleteNamespacedControllerRevision;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::DeleteNamespacedControllerRevision - Deprecated - use the new Kubernetes::REST API instead
