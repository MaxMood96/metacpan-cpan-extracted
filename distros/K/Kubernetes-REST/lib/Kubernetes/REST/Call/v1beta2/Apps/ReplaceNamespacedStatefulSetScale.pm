package Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedStatefulSetScale;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v1beta2::Apps::ReplaceNamespacedStatefulSetScale - Deprecated - use the new Kubernetes::REST API instead
