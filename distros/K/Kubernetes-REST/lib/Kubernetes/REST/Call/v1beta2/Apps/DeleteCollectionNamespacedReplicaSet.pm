package Kubernetes::REST::Call::v1beta2::Apps::DeleteCollectionNamespacedReplicaSet;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v1beta2::Apps::DeleteCollectionNamespacedReplicaSet - Deprecated - use the new Kubernetes::REST API instead
