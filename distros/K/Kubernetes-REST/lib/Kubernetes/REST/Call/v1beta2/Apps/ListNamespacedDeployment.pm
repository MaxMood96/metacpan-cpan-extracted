package Kubernetes::REST::Call::v1beta2::Apps::ListNamespacedDeployment;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v1beta2::Apps::ListNamespacedDeployment - Deprecated - use the new Kubernetes::REST API instead
