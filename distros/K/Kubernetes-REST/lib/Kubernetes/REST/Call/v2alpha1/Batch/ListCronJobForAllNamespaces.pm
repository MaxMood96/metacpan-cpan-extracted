package Kubernetes::REST::Call::v2alpha1::Batch::ListCronJobForAllNamespaces;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2alpha1::Batch::ListCronJobForAllNamespaces - Deprecated - use the new Kubernetes::REST API instead
