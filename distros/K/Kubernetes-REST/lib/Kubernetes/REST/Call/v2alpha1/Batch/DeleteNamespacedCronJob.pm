package Kubernetes::REST::Call::v2alpha1::Batch::DeleteNamespacedCronJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2alpha1::Batch::DeleteNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
