package Kubernetes::REST::Call::v2alpha1::Batch::ReadNamespacedCronJob;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2alpha1::Batch::ReadNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
