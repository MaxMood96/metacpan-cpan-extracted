package Kubernetes::REST::Call::v2alpha1::Batch::ReplaceNamespacedCronJobStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2alpha1::Batch::ReplaceNamespacedCronJobStatus - Deprecated - use the new Kubernetes::REST API instead
