package Kubernetes::REST::Call::v2alpha1::Batch::WatchNamespacedCronJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2alpha1::Batch::WatchNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
