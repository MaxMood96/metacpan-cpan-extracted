package Kubernetes::REST::Call::v2alpha1::Batch::ListNamespacedCronJob;
our $VERSION = '1.002';
...
Kubernetes::REST::Call::v2alpha1::Batch::ListNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
