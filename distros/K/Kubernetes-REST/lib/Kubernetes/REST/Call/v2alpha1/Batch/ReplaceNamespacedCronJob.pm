package Kubernetes::REST::Call::v2alpha1::Batch::ReplaceNamespacedCronJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2alpha1::Batch::ReplaceNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
