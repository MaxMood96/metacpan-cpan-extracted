package Kubernetes::REST::Call::v2alpha1::Batch::GetAPIResources;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2alpha1::Batch::GetAPIResources - Deprecated - use the new Kubernetes::REST API instead
