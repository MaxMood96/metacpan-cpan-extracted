package Kubernetes::REST::Call::v2alpha1::Batch::PatchNamespacedCronJobStatus;
our $VERSION = '1.001';
...
Kubernetes::REST::Call::v2alpha1::Batch::PatchNamespacedCronJobStatus - Deprecated - use the new Kubernetes::REST API instead
