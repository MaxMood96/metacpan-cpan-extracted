package Kubernetes::REST::Call::v2alpha1::Batch::CreateNamespacedCronJob;
our $VERSION = '1.003';
...
Kubernetes::REST::Call::v2alpha1::Batch::CreateNamespacedCronJob - Deprecated - use the new Kubernetes::REST API instead
