...
static void xs_jit_role_comparable(pTHX_ XS_JIT_Builder* b, XS_JIT_RoleOpts* opts) {
    ...
    xs_jit_line(aTHX_ b, "SV* other;");
    xs_jit_declare_hv(aTHX_ b, "other_hv", NULL);
    xs_jit_line(aTHX_ b, "SV* self_val;");
    xs_jit_line(aTHX_ b, "SV* other_val;");
    xs_jit_line(aTHX_ b, "int cmp;");
    xs_jit_check_items(aTHX_ b, 2, 2, "$self, $other");
    xs_jit_blank(aTHX_ b);
    xs_jit_comment(aTHX_ b, "Get other object's hash");
    xs_jit_assign(aTHX_ b, "other", "ST(1)");
    xs_jit_if(aTHX_ b, "!SvROK(other) || SvTYPE(SvRV(other)) != SVt_PVHV");
    xs_jit_croak(aTHX_ b, "compare() requires another object");
    xs_jit_endif(aTHX_ b);
    xs_jit_assign(aTHX_ b, "other_hv", "(HV*)SvRV(other)");
    xs_jit_blank(aTHX_ b);
    ...
    xs_jit_assign(aTHX_ b, "self_val", "(self_svp && *self_svp) ? *self_svp : &PL_sv_undef");
    xs_jit_assign(aTHX_ b, "other_val", "(other_svp && *other_svp) ? *other_svp : &PL_sv_undef");
    xs_jit_assign(aTHX_ b, "cmp", "sv_cmp(self_val, other_val)");
...
static void xs_jit_role_cloneable(pTHX_ XS_JIT_Builder* b, XS_JIT_RoleOpts* opts) {
    ...
    xs_jit_get_self_hv(aTHX_ b);
    xs_jit_comment(aTHX_ b, "Declare all variables at top for C89");
    xs_jit_declare_hv(aTHX_ b, "clone_hv", NULL);
    xs_jit_line(aTHX_ b, "HE* entry;");
    ...
    xs_jit_assign(aTHX_ b, "clone_ref", "sv_2mortal(newRV_noinc((SV*)clone_hv))");
    xs_jit_assign(aTHX_ b, "classname", "sv_reftype(SvRV(self), 1)");
...
static void xs_jit_role_observable(pTHX_ XS_JIT_Builder* b, XS_JIT_RoleOpts* opts) {
    ...
    xs_jit_blank(aTHX_ b);
    xs_jit_assign(aTHX_ b, "observers", "(AV*)SvRV(*obs_svp)");
    xs_jit_line(aTHX_ b, "len = av_len(observers);");
    xs_jit_for(aTHX_ b, "i = 0", "i <= len", "i++");
    ...
    xs_jit_assign(aTHX_ b, "args_av", "NULL");
    xs_jit_if(aTHX_ b, "items > 1");
    xs_jit_assign(aTHX_ b, "args_av", "newAV()");
