...
I welcome any contribution to JSON::Schema::Validate::Error, including, but not limited to bug reports, feature requests, general comments, and patches.

Feel free to clone it from its gitlab repository at <https://gitlab.com/deguest/JSON-Schema-Validate> and issue a pull request.
...
File [an issue on bug tracker](https://gitlab.com/deguest/JSON-Schema-Validate/issues) if you think you've found a bug. Please describe
...
Issues are currently reported using CPAN [bug tracker](https://gitlab.com/deguest/JSON-Schema-Validate/issues)

## More information

Please refer to the [README](https://metacpan.org/source/JDEGUEST/JSON-Schema-Validate-Error-v0.1.0/README.md)
