...
It returns an C<IO::Compress::Xz> object on success and C<undef> on failure.
...
C<myfile.xz> and write some data to it.
...
To read the contents of the file C<file1.txt> and write the compressed
data to the file C<file1.txt.xz> there are a few options
