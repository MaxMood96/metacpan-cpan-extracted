...
use IO::Uncompress::Adapter::UnLzip 2.224 ;
...
The optional parameters for the one-shot function C<unlzip>
...
C<myfile.xz> and write its contents to stdout.

    my $filename = "myfile.xz";
    my $z = IO::Uncompress::UnLzip->new($filename)
        or die "IO::Uncompress::UnLzip failed: $UnLzipError\n";
...
No symbolic constants are required by IO::Uncompress::UnLzip at present.
