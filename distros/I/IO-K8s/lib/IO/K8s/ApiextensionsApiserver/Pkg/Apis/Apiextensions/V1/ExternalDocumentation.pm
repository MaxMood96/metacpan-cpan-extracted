...
IO::K8s::ApiextensionsApiserver::Pkg::Apis::Apiextensions::V1::ExternalDocumentation - ExternalDocumentation allows referencing an external resource for extended documentation.
