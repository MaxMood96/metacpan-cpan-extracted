...
IO::K8s::ApiextensionsApiserver::Pkg::Apis::Apiextensions::V1::ValidationRule - ValidationRule describes a validation rule written in the CEL expression language.
