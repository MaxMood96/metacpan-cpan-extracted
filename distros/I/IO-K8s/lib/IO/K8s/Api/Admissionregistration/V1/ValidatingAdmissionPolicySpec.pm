...
IO::K8s::Api::Admissionregistration::V1::ValidatingAdmissionPolicySpec - ValidatingAdmissionPolicySpec is the specification of the desired behavior of the AdmissionPolicy.
