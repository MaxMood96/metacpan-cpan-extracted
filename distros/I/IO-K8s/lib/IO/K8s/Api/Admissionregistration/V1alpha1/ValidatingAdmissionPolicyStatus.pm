...
IO::K8s::Api::Admissionregistration::V1alpha1::ValidatingAdmissionPolicyStatus - ValidatingAdmissionPolicyStatus represents the status of a ValidatingAdmissionPolicy.
