...
IO::K8s::Api::Admissionregistration::V1::RuleWithOperations - RuleWithOperations is a tuple of Operations and Resources. It is recommended to make sure that all the tuple expansions are valid.
