...
IO::K8s::Api::Core::V1::NodeSelector - A node selector represents the union of the results of one or more label queries over a set of nodes; that is, it represents the OR of the selectors represented by the node selector terms.

=head1 VERSION

version 1.002

=head2 nodeSelectorTerms
