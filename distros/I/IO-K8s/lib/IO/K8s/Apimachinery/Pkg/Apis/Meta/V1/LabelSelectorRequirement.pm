...
IO::K8s::Apimachinery::Pkg::Apis::Meta::V1::LabelSelectorRequirement - A label selector requirement is a selector that contains values, a key, and an operator that relates the key and values.
