...
should behave. This module exports the C<print_version_info()> function on
request. It can be used as a "-V" option destination callback function. The
function implements some recommendations. It prints information about the
program name L<$0|perlvar/$0>, and its version to standard output. As a
second information line it prints the version of the perl interpreter to
